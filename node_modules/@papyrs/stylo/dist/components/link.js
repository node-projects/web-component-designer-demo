...
import { a as toHTMLElement, f as findParagraph } from './paragraph.utils.js';
import { a as getRange } from './selection.utils.js';
...
let Link = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
Link = /*@__PURE__*/ proxyCustomElement(Link, [1, "stylo-toolbar-link", {
    "containerRef": [16],
...
export { Link as L, defineCustomElement as d, removeLink as r };
