...
import { d as focusParagraph, a as toHTMLElement } from './paragraph.utils.js';
...
let Plugins = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
Plugins = /*@__PURE__*/ proxyCustomElement(Plugins, [1, "stylo-plugins", {
    "display": [32],
    "position": [32]
  }, [[5, "click", "onMouseDown"], [5, "hidePlugins", "onHidePlugins"], [5, "listPlugins", "onListPlugins"]]]);
