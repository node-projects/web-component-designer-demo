...
import { c as configStore, D as DEFAULT_PLUGINS, a as DEFAULT_TOOLBAR, b as DEFAULT_PLACEHOLDERS, d as DEFAULT_TEXT_PARAGRAPHS, e as DEFAULT_EXCLUDE_ATTRIBUTES, f as DEFAULT_PARAGRAPH_IDENTIFIER } from './config.store.js';
import { c as containerStore } from './container.store.js';
import { h as isParagraph, b as isParagraphEmpty, f as findParagraph, j as isTextNode, a as toHTMLElement, s as setParagraphAttribute, k as elementIndex, n as nodeDepths, l as findNodeAtDepths, m as f, o as isNodeList, p as isParagraphCode, q as createEmptyParagraph, u, r as addParagraph, v as prependEmptyText, g, w as createNewEmptyLine, x as addEmptyText, y as m, z as createNewParagraph, A as isStartNode, B as isPhrasingContent, C as addParagraphs, t as transformParagraph, D as insertNodeInRange, E as isMetaContent, F as nodeIndex } from './paragraph.utils.js';
import { a as getRange, g as getSelection$1, d as deleteRange } from './selection.utils.js';
import { c as createStore } from './index2.js';
import { i as isKeyboardEnter, d as defineCustomElement$h } from './add.js';
import { c as createLinkElement, d as defineCustomElement$6 } from './link.js';
...
const replaceBacktickText = () => {
  return new Promise((resolve) => {
    const changeObserver = new MutationObserver(async (mutations) => {
      ...
      if (w()) {
        u(mark ? parent.nextSibling : target.nextSibling);
        resolve();
        return;
      }
      u(mark ? target : target.nextSibling);
      resolve();
    });
...
const updateText = ({ target, transformInput, parent }) => {
  return new Promise(async (resolve) => {
    ...
    const changeObserver = new MutationObserver((mutations) => {
      var _a;
      changeObserver.disconnect();
      u((_a = mutations[1]) === null || _a === void 0 ? void 0 : _a.addedNodes[0]);
      resolve();
    });
    changeObserver.observe(containerStore.state.ref, { childList: true, subtree: true });
    if (target.nextSibling) {
...
//# sourceMappingURL=stylo-editor.js.map