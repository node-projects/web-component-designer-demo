import { g as getRenderingRef, f as forceUpdate, h, r as registerInstance, c as createEvent, H as Host, a as getElement, F as Fragment } from './index-617f3a2a.js';
import { h as h1, b as h2, d as h3, u as ul, o as ol, i as img, a as code, e as hr, D as DEFAULT_PALETTE, k as c$1, l as findParagraph, m as toHTMLElement, n as isParagraphEmpty, p as isParagraphNotEditable, q as focusParagraph, c as createEmptyElement, r as g, s as isParagraph, v as isTextNode, w as setParagraphAttribute, x as elementIndex, y as nodeDepths, z as findNodeAtDepths, A as f$1, B as isNodeList, C as isParagraphCode, E as createEmptyParagraph, F as u$1, G as addParagraph, H as prependEmptyText, I as createNewEmptyLine, J as addEmptyText, K as m, L as createNewParagraph, M as isStartNode, N as isPhrasingContent, O as addParagraphs, t as transformParagraph, P as insertNodeInRange, Q as isMetaContent, R as nodeIndex, j as ToolbarFontSize, g as ToolbarAlign, f as ToolbarList, S as a$1, T as ToolbarActions, U as i$1 } from './toolbar-562326e1.js';
...
const esI18n = async () => {
  const { es } = await import('./es-3333394d.js');
  return es;
};
const deI18n = async () => {
  const { de } = await import('./de-7e2aba0f.js');
  return de;
};
const nlI18n = async () => {
  const { nl } = await import('./nl-25bffbb5.js');
  return nl;
};
const jaI18n = async () => {
  const { ja } = await import('./ja-94595bc2.js');
  return ja;
};
const enI18n = () => en;
...
const replaceBacktickText = () => {
  return new Promise((resolve) => {
    const changeObserver = new MutationObserver(async (mutations) => {
      ...
      if (w()) {
        u$1(mark ? parent.nextSibling : target.nextSibling);
        resolve();
        return;
      }
      u$1(mark ? target : target.nextSibling);
      resolve();
    });
...
const updateText = ({ target, transformInput, parent }) => {
  return new Promise(async (resolve) => {
    ...
    const changeObserver = new MutationObserver((mutations) => {
      var _a;
      changeObserver.disconnect();
      u$1((_a = mutations[1]) === null || _a === void 0 ? void 0 : _a.addedNodes[0]);
      resolve();
    });
    changeObserver.observe(containerStore.state.ref, { childList: true, subtree: true });
    if (target.nextSibling) {
