import { g as getRenderingRef, f as forceUpdate, h, r as registerInstance, c as createEvent, H as Host, a as getElement, F as Fragment } from './index-b3b8ff13.js';
import { h as h1, d as h2, e as h3, u as ul, o as ol, b as blockquote, i as img, a as code, f as hr, D as DEFAULT_PALETTE, l as c$1, m as findParagraph, n as toHTMLElement, p as isParagraphNotEditable, q as isParagraphEmpty, r as focusParagraph, c as createEmptyElement, s as g, v as isParagraph, w as isTextNode, x as setParagraphAttribute, y as elementIndex, z as nodeDepths, A as findNodeAtDepths, B as f$1, C as isNodeList, E as isParagraphCode, F as createEmptyParagraph, G as u$1, H as addParagraph, I as prependEmptyText, J as createNewEmptyLine, K as addEmptyText, L as m, M as createNewParagraph, N as isStartNode, O as isPhrasingContent, P as addParagraphs, t as transformParagraph, Q as insertNodeInRange, R as isMetaContent, S as nodeIndex, k as ToolbarFontSize, j as ToolbarAlign, g as ToolbarList, U as a$1, T as ToolbarActions, V as i$1 } from './toolbar-d36dad9c.js';
...
const esI18n = async () => {
  const { es } = await import('./es-1278f8e2.js');
  return es;
};
const deI18n = async () => {
  const { de } = await import('./de-371af133.js');
  return de;
};
const nlI18n = async () => {
  const { nl } = await import('./nl-6322938c.js');
  return nl;
};
const jaI18n = async () => {
  const { ja } = await import('./ja-33ad89b7.js');
  return ja;
};
const zhCnI18n = async () => {
  const { zhCn } = await import('./zh-cn-e7d21de1.js');
  return zhCn;
};
const frI18n = async () => {
  const { fr } = await import('./fr-7668ca11.js');
  return fr;
};
const enI18n = () => en;
...
const inputCss = ":host{display:flex;position:relative;margin:var(--stylo-color-input-margin, 4px);border-radius:var(--stylo-color-input-container-border-radius);border:var(--stylo-color-input-container-border)}span{width:var(--stylo-color-hash-width, 28px);height:var(--stylo-color-hash-height, 28px);display:inline-flex;justify-content:center;align-items:center;background:var(--stylo-color-hash-background, rgb(240, 240, 240) none repeat scroll 0 0);color:var(--stylo-color-hash-color, rgb(152, 161, 164));border-radius:var(--stylo-color-hash-border-radius, 4px 0 0 4px)}input{color:var(--stylo-color-input-color, rgb(102, 102, 102));background:var(--stylo-color-input-background, inherit);border:none;outline:none;height:var(--stylo-color-input-height, 28px);box-shadow:var(--stylo-color-input-box-shadow, rgb(240, 240, 240) 0 0 0 1px inset);border-radius:var(--stylo-color-input-border-radius, 0 4px 4px 0);padding:var(--stylo-color-input-padding, 0 4px);max-width:var(--stylo-color-input-max-width, 136px);font-family:var(--stylo-color-input-font-family, inherit)}";
...
const IconBlockquote = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  h("path", { d: "M18.62 18h-5.24l2-4H13V6h8v7.24L18.62 18zm-2-2h.76L19 12.76V8h-4v4h3.62l-2 4zm-8 2H3.38l2-4H3V6h8v7.24L8.62 18zm-2-2h.76L9 12.76V8H5v4h3.62l-2 4z" })));

// Source: https://fonts.google.com/icons?selected=Material%20Icons%3Acode%3A
const IconCode = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
...
const IconImage = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  h("path", { d: "M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-4.86 8.86l-3 3.87L9 13.14 6 17h12l-3.86-5.14z" })));

// Source: https://fonts.google.com/icons?selected=Material%20Icons%3Amore_horiz%3A
const IconEllipsisHorizontal = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0z", fill: "none" }),
  h("path", { d: "M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })));

// Source: https://fonts.google.com/icons?selected=Material%20Icons%3Aformat_list_numbered%3A
const IconOl = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0z", fill: "none" }),
  h("path", { d: "M2 17h2v.5H3v1h1v.5H2v1h3v-4H2v1zm1-9h1V4H2v1h1v3zm-1 3h1.8L2 13.1v.9h3v-1H3.2L5 10.9V10H2v1zm5-6v2h14V5H7zm0 14h14v-2H7v2zm0-6h14v-2H7v2z" })));

// Source: https://fonts.google.com/icons?selected=Material%20Icons%20Outlined%3Aformat_list_bulleted%3A
const IconUl = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor" },
  h("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  h("path", { d: "M4 10.5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm0-6c-.83 0-1.5.67-1.5 1.5S3.17 7.5 4 7.5 5.5 6.83 5.5 6 4.83 4.5 4 4.5zm0 12c-.83 0-1.5.68-1.5 1.5s.68 1.5 1.5 1.5 1.5-.68 1.5-1.5-.67-1.5-1.5-1.5zM7 19h14v-2H7v2zm0-6h14v-2H7v2zm0-8v2h14V5H7z" })));
...
const renderIcon = (icon) => {
  switch (icon) {
    ...
    case 'img':
      return h(IconImage, null);
    case 'blockquote':
      return h(IconBlockquote, null);
    default:
      return undefined;
  }
};
...
//# sourceMappingURL=stylo-add_17.entry.js.map