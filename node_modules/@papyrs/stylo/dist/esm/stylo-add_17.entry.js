...
import { h as h1, b as h2, d as h3, u as ul, o as ol, i as img, a as code, e as hr, D as DEFAULT_PALETTE, k as c$1, l as findParagraph, m as toHTMLElement, n as isParagraphEmpty, p as isParagraphNotEditable, q as focusParagraph, c as createEmptyElement, r as g, s as isParagraph, v as isTextNode, w as setParagraphAttribute, x as elementIndex, y as nodeDepths, z as findNodeAtDepths, A as f$1, B as isParagraphList, C as isParagraphCode, E as createEmptyParagraph, F as u$1, G as addParagraph, H as prependEmptyText, I as createNewEmptyLine, J as addEmptyText, K as m, L as createNewParagraph, M as isStartNode, N as isPhrasingContent, O as addParagraphs, t as transformParagraph, P as insertNodeInRange, Q as isMetaContent, j as ToolbarFontSize, g as ToolbarAlign, f as ToolbarList, R as a$1, T as ToolbarActions, S as i$1 } from './toolbar-5a9dcc87.js';
...
const DEFAULT_PLUGINS = [h1, h2, h3, ul, ol, img, code, hr];
...
const esI18n = async () => {
  const { es } = await import('./es-2d4d5bc1.js');
  return es;
};
const deI18n = async () => {
  const { de } = await import('./de-9bb95b46.js');
  return de;
};
const nlI18n = async () => {
  const { nl } = await import('./nl-ad896781.js');
  return nl;
};
const enI18n = () => en;
  ...
  return new Promise((resolve) => {
    const changeObserver = new MutationObserver(async (mutations) => {
      ...
      if (w()) {
        ...
        const parent = toHTMLElement(target);
        u$1((parent === null || parent === void 0 ? void 0 : parent.nodeName.toLowerCase()) === 'mark' ? parent.nextSibling : target.nextSibling);
        resolve();
        return;
      }
      u$1(target);
...
const renderIcon = (icon) => {
  switch (icon) {
    ...
    case 'ul':
      return h(IconUl, null);
    case 'ol':
      return h(IconOl, null);
    case 'hr':
