import { g as getRenderingRef, f as forceUpdate, h, r as registerInstance, c as createEvent, H as Host, a as getElement, F as Fragment } from './index-ba272ea3.js';
import { h as h1, b as h2, d as h3, u as ul, i as img, a as code, e as hr, D as DEFAULT_PALETTE, k as c, l as findParagraph, m as toHTMLElement, n as isParagraphEmpty, o as isParagraphNotEditable, p as focusParagraph, c as createEmptyElement, q as g, r as isParagraph, s as isTargetContainer, v as isTextNode, w as elementIndex, x as nodeDepths, y as findNodeAtDepths, z as f$1, A as isParagraphList, B as isParagraphCode, C as createEmptyParagraph, E as u$1, F as addParagraph, G as prependEmptyText, H as createNewEmptyLine, I as addEmptyText, J as m, K as createNewParagraph, L as isStartNode, j as ToolbarFontSize, g as ToolbarAlign, f as ToolbarList, M as a$1, T as ToolbarActions, N as i$1 } from './toolbar-ef0ec1ca.js';
...
const DEFAULT_PLUGINS = [h1, h2, h3, ul, img, code, hr];
...
const esI18n = async () => {
  const { es } = await import('./es-dfcb7a8c.js');
  return es;
};
const deI18n = async () => {
  const { de } = await import('./de-58e415b7.js');
  return de;
};
const nlI18n = async () => {
  const { nl } = await import('./nl-15947eea.js');
  return nl;
};
const enI18n = () => en;
...
const createNode = ({ target, parent, transformInput }) => {
  return new Promise(async (resolve) => {
    const changeObserver = new MutationObserver((mutations) => {
      var _a;
      changeObserver.disconnect();
      u$1((_a = mutations[0]) === null || _a === void 0 ? void 0 : _a.addedNodes[0]);
      resolve();
    });
...
const IconCode = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  h("path", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "32", d: "M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320" })));

const IconEllipsisHorizontal = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  h("circle", { cx: "256", cy: "256", r: "48" }),
  h("circle", { cx: "416", cy: "256", r: "48" }),
  h("circle", { cx: "96", cy: "256", r: "48" })));

const IconImages = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "512", height: "512", viewBox: "0 0 512 512" },
  h("path", { d: "M432,112V96a48.14,48.14,0,0,0-48-48H64A48.14,48.14,0,0,0,16,96V352a48.14,48.14,0,0,0,48,48H80", style: { fill: 'none', stroke: 'currentColor', strokeLinejoin: 'round', strokeWidth: '32px' } }),
  h("rect", { x: "96", y: "128", width: "400", height: "336", rx: "45.99", ry: "45.99", style: { fill: 'none', stroke: 'currentColor', strokeLinejoin: 'round', strokeWidth: '32px' } }),
  h("ellipse", { cx: "372.92", cy: "219.64", rx: "30.77", ry: "30.55", style: { fill: 'none', stroke: 'currentColor', strokeMiterlimit: '10', strokeWidth: '32px' } }),
  h("path", { d: "M342.15,372.17,255,285.78a30.93,30.93,0,0,0-42.18-1.21L96,387.64", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
  ...
  h("path", { d: "M265.23,464,383.82,346.27a31,31,0,0,1,41.46-1.87L496,402.91", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
...
const IconList = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "512", height: "512", viewBox: "0 0 512 512" },
  h("line", { x1: "160", y1: "144", x2: "448", y2: "144", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  h("line", { x1: "160", y1: "256", x2: "448", y2: "256", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  h("line", { x1: "160", y1: "368", x2: "448", y2: "368", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  h("circle", { cx: "80", cy: "144", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  h("circle", { cx: "80", cy: "256", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  h("circle", { cx: "80", cy: "368", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
...
const renderIcon = (icon) => {
  switch (icon) {
    case 'code':
      return h(IconCode, null);
    case 'ul':
      return h(IconList, null);
    case 'hr':
      return h(IconEllipsisHorizontal, null);
    case 'img':
      return h(IconImages, null);
    default:
      return undefined;
  }
};
...
let Plugins = class {
  ...
  renderList() {
    return (h("stylo-list", { onApplyPlugin: async ({ detail }) => await this.onApplyPlugin(detail), onCancelPlugins: () => this.onCancelPlugins() }));
  }
  get el() { return getElement(this); }
};
...
const IconPalette = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  ...
  h("circle", { cx: "144", cy: "208", r: "32", fill: "currentColor" }),
  h("circle", { cx: "152", cy: "311", r: "32", fill: "currentColor" }),
  h("circle", { cx: "224", cy: "144", r: "32", fill: "currentColor" }),
  h("circle", { cx: "256", cy: "367", r: "48", fill: "currentColor" }),
  h("circle", { cx: "328", cy: "144", r: "32", fill: "currentColor" })));

const IconUl = () => (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  h("circle", { cx: "92", cy: "256", r: "28", style: { fill: 'currentColor' } }),
  h("circle", { cx: "92", cy: "132", r: "28", style: { fill: 'currentColor' } }),
  h("circle", { cx: "92", cy: "380", r: "28", style: { fill: 'currentColor' } }),
  h("path", { style: { fill: 'currentColor' }, d: "M432 240H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16H432c8.8 0 16-7.2 16-16s-7.2-16-16-16zM432 364H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16H432c8.8 0 16-7.2 16-16s-7.2-16-16-16zM191.5 148H432c8.8 0 16-7.2 16-16s-7.2-16-16-16H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16z" })));
...
let Toolbar = class {
  ...
  onAttributesChangesInitStyle() {
    const anchorNode = a$1(this.selection);
    if (!anchorNode) {
      return;
    }
  ...
  render() {
    ...
    const style = this.toolsPosition
      ...
      : undefined;
    return (h("div", { class: classNames, ref: (el) => (this.tools = el), style: style }, h("stylo-toolbar-triangle", { class: position === 'above' ? 'bottom' : 'top', style: {
  ...
  renderActions() {
    if (this.toolbarActions === ToolbarActions.LINK) {
      return (h("stylo-toolbar-link", { containerRef: this.containerRef, toolbarActions: this.toolbarActions, anchorLink: this.anchorLink, linkCreated: this.linkCreated, onLinkModified: ($event) => this.reset($event.detail) }));
    }
    if (this.toolbarActions === ToolbarActions.COLOR ||
      this.toolbarActions === ToolbarActions.BACKGROUND_COLOR) {
      return (h("stylo-toolbar-color", { containerRef: this.containerRef, action: this.toolbarActions === ToolbarActions.BACKGROUND_COLOR ? 'background-color' : 'color', onExecCommand: this.onExecCommand }));
    }
...
let Button = class {
  ...
  render() {
    return (h("button", { onMouseDown: ($event) => $event.stopPropagation(), onTouchStart: ($event) => $event.stopPropagation(), onClick: ($event) => this.action.emit($event), disabled: this.disableAction, class: this.cssClass, "aria-label": this.label }, h("slot", null)));
  }
};
...
let Color = class {
  ...
  selectColor($event) {
    ...
    const anchorNode = a$1(selection);
    if (!anchorNode) {
      return;
    }
...
let FontSize = class {
  ...
  renderAction(size) {
    return (h("stylo-toolbar-button", { label: `${i18n.state.toolbar.align_center} ${size}`, onAction: ($event) => this.modifyFontSize($event.detail, size), class: this.fontSize === size ? 'active' : undefined }, h("span", null, size.toString())));
  }
};
...
export { Add as stylo_add, Color$1 as stylo_color, Input as stylo_color_input, Editor as stylo_editor, List as stylo_list, Menus as stylo_menus, Plugins as stylo_plugins, Toolbar as stylo_toolbar, Align as stylo_toolbar_align, Button as stylo_toolbar_button, Color as stylo_toolbar_color, FontSize as stylo_toolbar_font_size, Link as stylo_toolbar_link, AlignActions as stylo_toolbar_list, Separator$1 as stylo_toolbar_separator, Text as stylo_toolbar_text, Separator as stylo_toolbar_triangle };
