...
import { createEmptyElement } from './create-element.utils.js';
import { isTextNode, nodeIndex, toHTMLElement } from './node.utils.js';
...
export const isTargetContainer = ({ target, container }) => target.isEqualNode(container);
...
export const isParagraphList = ({ paragraph }) => ['ul', 'ol', 'dl'].includes(paragraph.nodeName.toLowerCase());
