import { debounce, isMobile } from '/web-component-designer-demo/node_modules/@deckdeckgo/utils/lib/esm/index.js';
import { Component, Element, Fragment, h, Prop, State, Watch } from '@stencil/core';
import { DataEvents } from '../../events/data.events.js';
import { EnterEvents } from '../../events/enter.events.js';
import { InputEvents } from '../../events/input.events.js';
import { TabEvents } from '../../events/tab.events.js';
import { UndoRedoEvents } from '../../events/undo-redo.events.js';
import configStore, { DEFAULT_EXCLUDE_ATTRIBUTES, DEFAULT_PLACEHOLDERS, DEFAULT_PLUGINS, DEFAULT_TEXT_PARAGRAPHS, DEFAULT_TOOLBAR } from '../../stores/config.store';
...
export class Editor {
  ...
  render() {
    ...
    return (h(Fragment, null,
      h("stylo-add", null),
      h("stylo-plugins", null),
      this.renderToolbar(),
      ((_a = configStore.state.menus) === null || _a === void 0 ? void 0 : _a.length) && h("stylo-menus", null)));
  }
  renderToolbar() {
    if (this.mobile) {
      return undefined;
