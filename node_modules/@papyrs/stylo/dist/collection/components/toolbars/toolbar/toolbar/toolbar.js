...
export class Toolbar {
  ...
  render() {
    ...
    const style = this.toolsPosition
      ...
      : undefined;
    return (h("div", { class: classNames, ref: (el) => (this.tools = el), style: style, onClick: ($event) => $event.stopPropagation(), onMouseDown: ($event) => this.onContainerClick($event), onTouchStart: ($event) => this.onContainerClick($event) },
