import { clearTheSelection, debounce, getAnchorElement, isIOS, isMobile, isRTL, unifyEvent } from '/web-component-designer-demo/node_modules/@deckdeckgo/utils/lib/esm/index.js';
...
import { execCommand } from '../../../../utils/execcommand.utils.js';
...
export class Toolbar {
  ...
  render() {
    ...
    const style = this.toolsPosition
      ...
      : undefined;
    return (h("div", { class: classNames, ref: (el) => (this.tools = el), style: style },
      h("stylo-toolbar-triangle", { class: position === 'above' ? 'bottom' : 'top', style: {
  ...
  static get properties() { return {
    "config": {
      ...
      "complexType": {
        ...
        "resolved": "{ palette?: StyloPalette[]; command?: \"native\" | \"custom\"; style?: { list: boolean; align: boolean; fontSize: boolean; backgroundColor: boolean; }; }",
        "references": {
          "Partial": {
            "location": "global"
          },
