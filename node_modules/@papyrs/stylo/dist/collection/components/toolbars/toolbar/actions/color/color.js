import { getAnchorElement, hexToRgb } from '/web-component-designer-demo/node_modules/@deckdeckgo/utils/lib/esm/index.js';
...
import { findStyleNode } from '../../../../../utils/toolbar.utils.js';
export class Color {
  constructor() {
    this.closeToolbar = () => {
      this.close.emit();
