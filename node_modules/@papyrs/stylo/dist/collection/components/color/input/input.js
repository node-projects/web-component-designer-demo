import { debounce, hexToRgb, rgbToHex } from '/web-component-designer-demo/node_modules/@deckdeckgo/utils/lib/esm/index.js';
...
export class Input {
  ...
  render() {
    ...
    return (h(Host, null,
      h("span", null, "#"),
      h("input", { type: "text", name: "color-picker", "aria-label": this.inputAlt, onInput: ($event) => this.debounceSelectColor($event.target.value), value: (_a = this.color) === null || _a === void 0 ? void 0 : _a.replace('#', '') })));
  }
