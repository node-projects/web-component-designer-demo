import { isMobile } from '/web-component-designer-demo/node_modules/@deckdeckgo/utils/lib/esm/index.js';
...
export class Plugins {
  ...
  render() {
    ...
    return (h(Host, { style: style, class: `${this.display ? 'display' : 'hidden'}` },
      this.renderList(),
      this.renderInputs()));
  }
  renderInputs() {
