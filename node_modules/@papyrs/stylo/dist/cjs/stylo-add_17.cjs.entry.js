...
const index = require('./index-19353f86.js');
const toolbar = require('./toolbar-c59cfb1a.js');
...
const DEFAULT_PLUGINS = [toolbar.h1, toolbar.h2, toolbar.h3, toolbar.ul, toolbar.img, toolbar.code, toolbar.hr];
...
const DEFAULT_TEXT_PARAGRAPHS = ['h1', 'h2', 'h3', 'div', 'p'];
...
const esI18n = async () => {
  const { es } = await Promise.resolve().then(function () { return require('./es-7f4eb5cd.js'); });
  return es;
};
const deI18n = async () => {
  const { de } = await Promise.resolve().then(function () { return require('./de-a39e3679.js'); });
  return de;
};
const nlI18n = async () => {
  const { nl } = await Promise.resolve().then(function () { return require('./nl-28daea2e.js'); });
  return nl;
};
const enI18n = () => en;
...
const IconAdd = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("path", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "32", d: "M256 112v288M400 256H112" })));
...
const findRemovedNodesParagraphs = ({ mutations, container }) => {
  return mutations
    ...
    .filter(({ target }) => !toolbar.isTargetContainer({ target, container }));
};
...
const undoRedo = async ({ popFrom, pushTo, undoChanges }) => {
  ...
  const promises = changes.map((undoChange) => undoRedoChange({ undoChange, selection }));
  const redoChanges = await Promise.all(promises);
  pushTo({ changes: redoChanges });
  popFrom();
};
const undoRedoChange = async ({ undoChange, selection }) => {
...
const undoRedoParagraph = async ({ undoChange, selection }) => {
  const { data, target } = undoChange;
  const container = toolbar.toHTMLElement(target);
...
const undoRedoUpdate = async ({ undoChange, selection }) => {
  const { data, target } = undoChange;
  const paragraphs = data;
  const container = toolbar.toHTMLElement(target);
  const to = [];
...
class EnterEvents {
  ...
  async createParagraph($event) {
    ...
    if (toolbar.isParagraphList({ paragraph })) {
      return;
    }
...
const replaceBacktickFirefox = async () => {
  ...
  const text = toolbar.isTextNode(previousSibling) ? previousSibling : previousSibling.firstChild;
...
const IconCode = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("path", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "32", d: "M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320" })));

const IconEllipsisHorizontal = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("circle", { cx: "256", cy: "256", r: "48" }),
  index.h("circle", { cx: "416", cy: "256", r: "48" }),
  index.h("circle", { cx: "96", cy: "256", r: "48" })));

const IconImages = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "512", height: "512", viewBox: "0 0 512 512" },
  index.h("path", { d: "M432,112V96a48.14,48.14,0,0,0-48-48H64A48.14,48.14,0,0,0,16,96V352a48.14,48.14,0,0,0,48,48H80", style: { fill: 'none', stroke: 'currentColor', strokeLinejoin: 'round', strokeWidth: '32px' } }),
  index.h("rect", { x: "96", y: "128", width: "400", height: "336", rx: "45.99", ry: "45.99", style: { fill: 'none', stroke: 'currentColor', strokeLinejoin: 'round', strokeWidth: '32px' } }),
  index.h("ellipse", { cx: "372.92", cy: "219.64", rx: "30.77", ry: "30.55", style: { fill: 'none', stroke: 'currentColor', strokeMiterlimit: '10', strokeWidth: '32px' } }),
  index.h("path", { d: "M342.15,372.17,255,285.78a30.93,30.93,0,0,0-42.18-1.21L96,387.64", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
  ...
  index.h("path", { d: "M265.23,464,383.82,346.27a31,31,0,0,1,41.46-1.87L496,402.91", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
...
const IconList = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "512", height: "512", viewBox: "0 0 512 512" },
  index.h("line", { x1: "160", y1: "144", x2: "448", y2: "144", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  index.h("line", { x1: "160", y1: "256", x2: "448", y2: "256", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  index.h("line", { x1: "160", y1: "368", x2: "448", y2: "368", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  index.h("circle", { cx: "80", cy: "144", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  index.h("circle", { cx: "80", cy: "256", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
  ...
  index.h("circle", { cx: "80", cy: "368", r: "16", style: {
      fill: 'none',
      stroke: 'currentColor',
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
...
let List = class {
  ...
  render() {
    return (index.h(index.Fragment, null, configStore.state.plugins.map((plugin) => this.renderPlugin(plugin))));
  }
  renderPlugin(plugin) {
    var _a, _b;
    const { text, icon: iconSrc } = plugin;
    const icon = renderIcon(iconSrc);
    return (index.h("button", Object.assign({ onClick: ($event) => this.emitPlugin($event, plugin) }, (icon === undefined && { innerHTML: iconSrc })), icon, (_b = (_a = i18n.state.plugins[text]) !== null && _a !== void 0 ? _a : i18n.state.custom[text]) !== null && _b !== void 0 ? _b : text));
  }
  get el() { return index.getElement(this); }
};
...
let Plugins = class {
  ...
  render() {
    const style = this.position === undefined
      ? {}
      : {
  ...
  renderList() {
    return (index.h("stylo-list", { onApplyPlugin: async ({ detail }) => await this.onApplyPlugin(detail), onCancelPlugins: () => this.onCancelPlugins() }));
  }
  get el() { return index.getElement(this); }
};
...
const IconAlignCenter = () => (index.h("svg", { width: "100%", height: "100%", viewBox: "0 0 512 512", style: {
    fillRule: 'evenodd',
    clipRule: 'evenodd',
    strokeLinecap: 'round',
    strokeLinejoin: 'round'
  } },
  index.h("path", { d: "M176,331l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M176,185l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M96,258l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,112l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,400l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } })));

const IconAlignLeft = () => (index.h("svg", { width: "100%", height: "100%", viewBox: "0 0 512 512", style: {
    fillRule: 'evenodd',
    clipRule: 'evenodd',
    strokeLinecap: 'round',
    strokeLinejoin: 'round'
  } },
  index.h("path", { d: "M96,331l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M96,185l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M96,258l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,112l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,400l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } })));

const IconAlignRight = () => (index.h("svg", { width: "100%", height: "100%", viewBox: "0 0 512 512", style: {
    fillRule: 'evenodd',
    clipRule: 'evenodd',
    strokeLinecap: 'round',
    strokeLinejoin: 'round'
  } },
  index.h("path", { d: "M256,331l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M256,185l160,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '25.3px' } }),
  index.h("path", { d: "M96,258l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,112l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } }),
  index.h("path", { d: "M96,400l320,0", style: { fill: 'none', fillRule: 'nonzero', stroke: 'currentColor', strokeWidth: '32px' } })));

const IconColor = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("path", { d: "M419.1 337.45a3.94 3.94 0 00-6.1 0c-10.5 12.4-45 46.55-45 77.66 0 27 21.5 48.89 48 48.89h0c26.5 0 48-22 48-48.89 0-31.11-34.3-65.26-44.9-77.66zM387 287.9L155.61 58.36a36 36 0 00-51 0l-5.15 5.15a36 36 0 000 51l52.89 52.89 57-57L56.33 263.2a28 28 0 00.3 40l131.2 126a28.05 28.05 0 0038.9-.1c37.8-36.6 118.3-114.5 126.7-122.9 5.8-5.8 18.2-7.1 28.7-7.1h.3a6.53 6.53 0 004.57-11.2z", fill: "none", stroke: "currentColor", "stroke-miterlimit": "10", "stroke-width": "32" })));

const IconLink = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("path", { d: "M208 352h-64a96 96 0 010-192h64M304 160h64a96 96 0 010 192h-64M163.29 256h187.42", fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "36" })));

const IconOl = () => (index.h("svg", { width: "100%", height: "100%", viewBox: "0 0 512 512", style: {
    fillRule: 'evenodd',
    clipRule: 'evenodd',
    strokeLinejoin: 'round',
    strokeMiterlimit: '1.41421'
  } },
  index.h("path", { d: "M432,240l-240.5,0c-8.8,0 -16,7.2 -16,16c0,8.8 7.2,16 16,16l240.5,0c8.8,0 16,-7.2 16,-16c0,-8.8 -7.2,-16 -16,-16Zm0,124l-240.5,0c-8.8,0 -16,7.2 -16,16c0,8.8 7.2,16 16,16l240.5,0c8.8,0 16,-7.2 16,-16c0,-8.8 -7.2,-16 -16,-16Zm-240.5,-216l240.5,0c8.8,0 16,-7.2 16,-16c0,-8.8 -7.2,-16 -16,-16l-240.5,0c-8.8,0 -16,7.2 -16,16c0,8.8 7.2,16 16,16Z", style: { fillRule: 'nonzero', fill: 'currentColor' } }),
  index.h("path", { d: "M80.784,159.32l14.784,0l0,-46.896c0,-1.408 0.048,-2.832 0.144,-4.272l-12.288,10.512c-0.32,0.256 -0.64,0.44 -0.96,0.552c-0.32,0.112 -0.624,0.168 -0.912,0.168c-0.48,0 -0.912,-0.104 -1.296,-0.312c-0.384,-0.208 -0.672,-0.456 -0.864,-0.744l-2.688,-3.696l20.448,-17.712l6.96,0l0,62.4l13.536,0l0,6.528l-36.864,0l0,-6.528Z", style: { fillRule: 'nonzero', fill: 'currentColor' } }),
  index.h("path", { d: "M95.856,221.296c2.912,0 5.632,0.432 8.16,1.296c2.528,0.864 4.712,2.12 6.552,3.768c1.84,1.648 3.288,3.656 4.344,6.024c1.056,2.368 1.584,5.056 1.584,8.064c0,2.56 -0.384,4.928 -1.152,7.104c-0.768,2.176 -1.808,4.264 -3.12,6.264c-1.312,2 -2.824,3.936 -4.536,5.808c-1.712,1.872 -3.528,3.784 -5.448,5.736l-18.096,18.528c1.28,-0.352 2.576,-0.632 3.888,-0.84c1.312,-0.208 2.576,-0.312 3.792,-0.312l23.04,0c0.928,0 1.664,0.272 2.208,0.816c0.544,0.544 0.816,1.248 0.816,2.112l0,5.184l-45.888,0l0,-2.928c0,-0.608 0.12,-1.232 0.36,-1.872c0.24,-0.64 0.632,-1.232 1.176,-1.776l22.032,-22.128c1.824,-1.856 3.488,-3.64 4.992,-5.352c1.504,-1.712 2.792,-3.432 3.864,-5.16c1.072,-1.728 1.896,-3.48 2.472,-5.256c0.576,-1.776 0.864,-3.672 0.864,-5.688c0,-2.016 -0.32,-3.784 -0.96,-5.304c-0.64,-1.52 -1.52,-2.776 -2.64,-3.768c-1.12,-0.992 -2.432,-1.736 -3.936,-2.232c-1.504,-0.496 -3.12,-0.744 -4.848,-0.744c-1.728,0 -3.328,0.256 -4.8,0.768c-1.472,0.512 -2.776,1.224 -3.912,2.136c-1.136,0.912 -2.096,1.992 -2.88,3.24c-0.784,1.248 -1.336,2.624 -1.656,4.128c-0.256,0.928 -0.64,1.6 -1.152,2.016c-0.512,0.416 -1.184,0.624 -2.016,0.624c-0.16,0 -0.328,-0.008 -0.504,-0.024c-0.176,-0.016 -0.376,-0.04 -0.6,-0.072l-4.464,-0.768c0.448,-3.136 1.312,-5.912 2.592,-8.328c1.28,-2.416 2.904,-4.44 4.872,-6.072c1.968,-1.632 4.224,-2.872 6.768,-3.72c2.544,-0.848 5.288,-1.272 8.232,-1.272Z", style: { fillRule: 'nonzero', fill: 'currentColor' } }),
  index.h("path", { d: "M96.768,345.296c2.912,0 5.6,0.416 8.064,1.248c2.464,0.832 4.584,2.016 6.36,3.552c1.776,1.536 3.16,3.392 4.152,5.568c0.992,2.176 1.488,4.592 1.488,7.248c0,2.176 -0.28,4.12 -0.84,5.832c-0.56,1.712 -1.36,3.216 -2.4,4.512c-1.04,1.296 -2.296,2.392 -3.768,3.288c-1.472,0.896 -3.12,1.616 -4.944,2.16c4.48,1.184 7.848,3.168 10.104,5.952c2.256,2.784 3.384,6.272 3.384,10.464c0,3.168 -0.6,6.016 -1.8,8.544c-1.2,2.528 -2.84,4.68 -4.92,6.456c-2.08,1.776 -4.504,3.136 -7.272,4.08c-2.768,0.944 -5.736,1.416 -8.904,1.416c-3.648,0 -6.768,-0.456 -9.36,-1.368c-2.592,-0.912 -4.784,-2.168 -6.576,-3.768c-1.792,-1.6 -3.264,-3.496 -4.416,-5.688c-1.152,-2.192 -2.128,-4.568 -2.928,-7.128l3.648,-1.536c0.672,-0.288 1.344,-0.432 2.016,-0.432c0.64,0 1.208,0.136 1.704,0.408c0.496,0.272 0.872,0.696 1.128,1.272c0.064,0.128 0.128,0.264 0.192,0.408c0.064,0.144 0.128,0.296 0.192,0.456c0.448,0.928 0.992,1.976 1.632,3.144c0.64,1.168 1.504,2.264 2.592,3.288c1.088,1.024 2.44,1.888 4.056,2.592c1.616,0.704 3.624,1.056 6.024,1.056c2.4,0 4.504,-0.392 6.312,-1.176c1.808,-0.784 3.312,-1.8 4.512,-3.048c1.2,-1.248 2.104,-2.64 2.712,-4.176c0.608,-1.536 0.912,-3.056 0.912,-4.56c0,-1.856 -0.248,-3.552 -0.744,-5.088c-0.496,-1.536 -1.392,-2.864 -2.688,-3.984c-1.296,-1.12 -3.088,-2 -5.376,-2.64c-2.288,-0.64 -5.224,-0.96 -8.808,-0.96l0,-6.192c2.912,-0.032 5.4,-0.352 7.464,-0.96c2.064,-0.608 3.752,-1.44 5.064,-2.496c1.312,-1.056 2.264,-2.32 2.856,-3.792c0.592,-1.472 0.888,-3.104 0.888,-4.896c0,-1.984 -0.312,-3.712 -0.936,-5.184c-0.624,-1.472 -1.48,-2.688 -2.568,-3.648c-1.088,-0.96 -2.376,-1.68 -3.864,-2.16c-1.488,-0.48 -3.096,-0.72 -4.824,-0.72c-1.728,0 -3.328,0.256 -4.8,0.768c-1.472,0.512 -2.776,1.224 -3.912,2.136c-1.136,0.912 -2.088,2 -2.856,3.264c-0.768,1.264 -1.344,2.632 -1.728,4.104c-0.256,0.928 -0.64,1.6 -1.152,2.016c-0.512,0.416 -1.168,0.624 -1.968,0.624c-0.16,0 -0.328,-0.008 -0.504,-0.024c-0.176,-0.016 -0.376,-0.04 -0.6,-0.072l-4.464,-0.768c0.448,-3.136 1.312,-5.912 2.592,-8.328c1.28,-2.416 2.904,-4.44 4.872,-6.072c1.968,-1.632 4.224,-2.872 6.768,-3.72c2.544,-0.848 5.288,-1.272 8.232,-1.272Z", style: { fillRule: 'nonzero', fill: 'currentColor' } })));

const IconPalette = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("path", { d: "M430.11 347.9c-6.6-6.1-16.3-7.6-24.6-9-11.5-1.9-15.9-4-22.6-10-14.3-12.7-14.3-31.1 0-43.8l30.3-26.9c46.4-41 46.4-108.2 0-149.2-34.2-30.1-80.1-45-127.8-45-55.7 0-113.9 20.3-158.8 60.1-83.5 73.8-83.5 194.7 0 268.5 41.5 36.7 97.5 55 152.9 55.4h1.7c55.4 0 110-17.9 148.8-52.4 14.4-12.7 11.99-36.6.1-47.7z", fill: "none", stroke: "currentColor", "stroke-miterlimit": "10", "stroke-width": "32" }),
  index.h("circle", { cx: "144", cy: "208", r: "32", fill: "currentColor" }),
  index.h("circle", { cx: "152", cy: "311", r: "32", fill: "currentColor" }),
  index.h("circle", { cx: "224", cy: "144", r: "32", fill: "currentColor" }),
  index.h("circle", { cx: "256", cy: "367", r: "48", fill: "currentColor" }),
  index.h("circle", { cx: "328", cy: "144", r: "32", fill: "currentColor" })));

const IconUl = () => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" },
  index.h("circle", { cx: "92", cy: "256", r: "28", style: { fill: 'currentColor' } }),
  index.h("circle", { cx: "92", cy: "132", r: "28", style: { fill: 'currentColor' } }),
  index.h("circle", { cx: "92", cy: "380", r: "28", style: { fill: 'currentColor' } }),
  index.h("path", { style: { fill: 'currentColor' }, d: "M432 240H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16H432c8.8 0 16-7.2 16-16s-7.2-16-16-16zM432 364H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16H432c8.8 0 16-7.2 16-16s-7.2-16-16-16zM191.5 148H432c8.8 0 16-7.2 16-16s-7.2-16-16-16H191.5c-8.8 0-16 7.2-16 16s7.2 16 16 16z" })));
...
let Toolbar = class {
  constructor(hostRef) {
    ...
    this.startSelection = ($event) => {
      const action = $event.composedPath().includes(this.el);
      if (action) {
        return;
      }
  ...
  render() {
    ...
    const style = this.toolsPosition
      ...
      : undefined;
    return (index.h("div", { class: classNames, ref: (el) => (this.tools = el), style: style }, index.h("stylo-toolbar-triangle", { class: position === 'above' ? 'bottom' : 'top', style: {
  ...
  renderActions() {
    if (this.toolbarActions === toolbar.ToolbarActions.LINK) {
      return (index.h("stylo-toolbar-link", { containerRef: this.containerRef, toolbarActions: this.toolbarActions, anchorLink: this.anchorLink, linkCreated: this.linkCreated, onLinkModified: ($event) => this.reset($event.detail) }));
    }
    if (this.toolbarActions === toolbar.ToolbarActions.COLOR ||
      this.toolbarActions === toolbar.ToolbarActions.BACKGROUND_COLOR) {
      return (index.h("stylo-toolbar-color", { containerRef: this.containerRef, action: this.toolbarActions === toolbar.ToolbarActions.BACKGROUND_COLOR ? 'background-color' : 'color', onExecCommand: this.onExecCommand }));
    }
...
let Button = class {
  ...
  render() {
    return (index.h("button", { onMouseDown: ($event) => $event.stopPropagation(), onTouchStart: ($event) => $event.stopPropagation(), onClick: ($event) => this.action.emit($event), disabled: this.disableAction, class: this.cssClass, "aria-label": this.label }, index.h("slot", null)));
  }
};
...
let FontSize = class {
  ...
  renderAction(size) {
    return (index.h("stylo-toolbar-button", { label: `${i18n.state.toolbar.align_center} ${size}`, onAction: ($event) => this.modifyFontSize($event.detail, size), class: this.fontSize === size ? 'active' : undefined }, index.h("span", null, size.toString())));
  }
};
FontSize.style = fontSizeCss;

const linkCss = ":host{width:100%;height:100%;z-index:var(--stylo-toolbar-link-zindex, 2)}:host input{pointer-events:visible;background:transparent;width:97%;height:100%;color:var(--stylo-toolbar-link-color, black);border:none;outline:0;font-size:16px}:host input::-moz-placeholder{color:var(--stylo-toolbar-link-placeholder-color, black)}:host input:-ms-input-placeholder{color:var(--stylo-toolbar-link-placeholder-color, black)}:host input::placeholder{color:var(--stylo-toolbar-link-placeholder-color, black)}";
