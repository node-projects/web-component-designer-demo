...
const toolbar = require('./toolbar-53f2250d.js');
...
const DEFAULT_PLUGINS = [toolbar.h1, toolbar.h2, toolbar.h3, toolbar.ul, toolbar.ol, toolbar.img, toolbar.code, toolbar.hr];
...
const esI18n = async () => {
  const { es } = await Promise.resolve().then(function () { return require('./es-f7149b19.js'); });
  return es;
};
const deI18n = async () => {
  const { de } = await Promise.resolve().then(function () { return require('./de-da135d1a.js'); });
  return de;
};
const nlI18n = async () => {
  const { nl } = await Promise.resolve().then(function () { return require('./nl-e093e235.js'); });
  return nl;
};
const enI18n = () => en;
  ...
  return new Promise((resolve) => {
    const changeObserver = new MutationObserver(async (mutations) => {
      ...
      if (w()) {
        ...
        const parent = toolbar.toHTMLElement(target);
        toolbar.u((parent === null || parent === void 0 ? void 0 : parent.nodeName.toLowerCase()) === 'mark' ? parent.nextSibling : target.nextSibling);
        resolve();
        return;
      }
      toolbar.u(target);
