...
const index = require('./index-adfb7c03.js');
const toolbar = require('./toolbar-966b04f3.js');
...
const Toolbar = class {
  ...
  addListener() {
    ...
    listenerElement === null || listenerElement === void 0 ? void 0 : listenerElement.addEventListener('keydown', this.onKeyDown, { passive: true });
  }
  removeListener() {
    const listenerElement = this.containerRef || document;
