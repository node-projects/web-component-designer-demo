...
let Plugins = class {
  ...
  render() {
    const style = Object.assign({ visibility: this.display ? 'visible' : 'hidden' }, (this.position === undefined
      ? {}
      : {
