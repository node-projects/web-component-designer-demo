...
const index = require('./index-c30048b4.js');
const toolbar = require('./toolbar-d5ce1bf3.js');
...
const esI18n = async () => {
  const { es } = await Promise.resolve().then(function () { return require('./es-4f84dc62.js'); });
  return es;
};
const deI18n = async () => {
  const { de } = await Promise.resolve().then(function () { return require('./de-a2edbcee.js'); });
  return de;
};
const nlI18n = async () => {
  const { nl } = await Promise.resolve().then(function () { return require('./nl-667a72cb.js'); });
  return nl;
};
const jaI18n = async () => {
  const { ja } = await Promise.resolve().then(function () { return require('./ja-e71f9fae.js'); });
  return ja;
};
const enI18n = () => en;
