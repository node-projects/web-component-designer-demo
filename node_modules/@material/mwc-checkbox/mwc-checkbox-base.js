...
import { eventOptions, html, internalProperty, property, query, queryAsync } from "./node_modules/lit-element/lit-element.js";
...
export class CheckboxBase extends FormElement {
  constructor() {
    ...
    this.focused = false; // MDC Foundation is unused
...
__decorate([internalProperty()], CheckboxBase.prototype, "animationClass", void 0);

__decorate([internalProperty()], CheckboxBase.prototype, "shouldRenderRipple", void 0);

__decorate([internalProperty()], CheckboxBase.prototype, "focused", void 0);

__decorate([queryAsync('mwc-ripple')], CheckboxBase.prototype, "ripple", void 0);

__decorate([eventOptions({
  passive: true
})], CheckboxBase.prototype, "handleRippleTouchStart", null); //# sourceMappingURL=mwc-checkbox-base.js.map