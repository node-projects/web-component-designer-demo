...
export let MenuBar = _decorate([customElement('paint-menu-bar')], function (_initialize, _LitElement) {
  class MenuBar extends _LitElement {
    constructor() {
      super(); // TODO: removeEventListeners on destroy
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "onClick",
      value: function onClick(entry) {
        this.activeMenu = this.activeMenu === entry ? null : entry;
      }
    }, {
      kind: "method",
      key: "onPointerEnter",
      value: function onPointerEnter(entry) {
