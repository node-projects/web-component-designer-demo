...
export let ToolBrush = _decorate([customElement('paint-tool-brush')], function (_initialize, _LitElement) {
  class ToolBrush extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    `;
      ...
      value: function render() {
        return html`${this.brushConfigs.map(({
          type,
          sizes
        }) => sizes.map(({
          value: size,
      ...
      kind: "method",
      key: "onSelect",
      value: function onSelect(type, size) {
