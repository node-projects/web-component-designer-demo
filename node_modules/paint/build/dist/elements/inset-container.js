...
export let InsetContainer = _decorate([customElement('paint-inset-container')], function (_initialize, _LitElement) {
  class InsetContainer extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    d: [{
      ...
      static: true,
      key: "styles",
      value: // TODO: InsetContainer should not define align-items, maybe not even display: flex.
