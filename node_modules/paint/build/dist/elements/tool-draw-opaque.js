...
export let ToolDrawOpaque = _decorate([customElement('paint-tool-draw-opaque')], function (_initialize, _LitElement) {
  class ToolDrawOpaque extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "getClasses",
      value: function getClasses(value) {
