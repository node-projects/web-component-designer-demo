...
export let ToolLineWidth = _decorate([customElement('paint-tool-line-width')], function (_initialize, _LitElement) {
  class ToolLineWidth extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "onUpdateWidth",
      value: function onUpdateWidth(lineWidth) {
