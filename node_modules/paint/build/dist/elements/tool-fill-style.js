...
export let ToolFillStyle = _decorate([customElement('paint-tool-fill-style')], function (_initialize, _LitElement) {
  class ToolFillStyle extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "onSelect",
      value: function onSelect(fillStyle) {
