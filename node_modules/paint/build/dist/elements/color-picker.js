...
export let ColorPicker = _decorate([customElement('paint-color-picker')], function (_initialize, _LitElement) {
  class ColorPicker extends _LitElement {
    constructor() {
      super();
  ...
  return {
    ...
    `;
      ...
      kind: "method",
      key: "dispatchColorEvent",
      value: function dispatchColorEvent(type) {
