...
(() => {
  class DockSpawnTsWebcomponent extends HTMLElement {
    ...
    handleAddedChildNode(element) {
      ...
      if (dockPanelTypeAttribute) dockPanelType = dockPanelTypeAttribute;
      ...
      if (dockRatioAttribute) dockRatio = dockRatioAttribute;
      ...
      if (dockType == 'left') this.dockManager.dockLeft(dockRelativeTo, container, dockRatio);else if (dockType == 'right') this.dockManager.dockRight(dockRelativeTo, container, dockRatio);else if (dockType == 'up') this.dockManager.dockUp(dockRelativeTo, container, dockRatio);else if (dockType == 'down') this.dockManager.dockDown(dockRelativeTo, container, dockRatio);else this.dockManager.dockFill(dockRelativeTo, container);
      if (element.style.display == 'none') element.style.display = 'block';
    }

    handleRemovedChildNode(element) {
      let node = this.getDockNodeForElement(element);
      if (node) node.container.close();
    ...
    getDockNodeForElement(elementOrContainer) {
      ...
      if (element.containerElement) element = elementOrContainer.containerElement;
...
window.customElements.define('dock-spawn-ts', DockSpawnTsWebcomponent); //# sourceMappingURL=DockSpawnTsWebcomponent.js.map