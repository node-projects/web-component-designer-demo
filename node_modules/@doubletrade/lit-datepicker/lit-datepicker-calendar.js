...
import endOfMonth from "../../date-fns/esm/endOfMonth/index.js";
import startOfDay from "../../date-fns/esm/startOfDay/index.js";
import getDay from "../../date-fns/esm/getDay/index.js";
import getMonth from "../../date-fns/esm/getMonth/index.js";
import getYear from "../../date-fns/esm/getYear/index.js";
import addMonths from "../../date-fns/esm/addMonths/index.js";
...
`;
  ...
  localeChanged() {
    if (locales[this.locale]) {
      ...
      for (i; i < 7; i += 1) {
        dayNamesOfTheWeek.push(locales[this.locale].localize.day(i, {
          width: 'short'
        }));
      }
      ...
      const newDayNamesOfTheWeek = dayNamesOfTheWeek.slice().splice(firstDayOfWeek, dayNamesOfTheWeek.length).concat(tmp);
    ...
    if (year && month) {
      ...
      while (startDateString !== endDateString) {
        ...
        const columnFn = {
          ...
          title: parseInt(format(startDateFn, 'd', {
            awareOfUnicodeTokens: true
          }), 10)
        };
  ...
  handleYearListChanged({
    detail
  }) {
    this.year = detail.value;
  }

  handleMonthListChanged({
    detail
  }) {
