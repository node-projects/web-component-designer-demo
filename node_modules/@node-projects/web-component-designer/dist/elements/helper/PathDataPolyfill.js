...
if (!SVGPathElement.prototype.getPathData || !SVGPathElement.prototype.setPathData) {
  (function () {
    ...
    var Source = function (string) {
      //@ts-ignore
      this._string = string; //@ts-ignore

      this._currentIndex = 0; //@ts-ignore

      this._endIndex = this._string.length; //@ts-ignore

      this._prevCommand = null; //@ts-ignore
    ...
    SVGPathElement.prototype.getPathData = function (options) {
      if (options && options.normalize) {
        ...
        else */
        {
          ...
          {
            pathData = parsePathDataString(this.getAttribute("d") || ""); //this[$cachedPathData] = clonePathData(pathData);
          }
          let normalizedPathData = reducePathData(absolutizePathData(pathData)); //this[$cachedNormalizedPathData] = clonePathData(normalizedPathData);
        ...
        {
          let pathData = parsePathDataString(this.getAttribute("d") || ""); //this[$cachedPathData] = clonePathData(pathData);
...
export function movePathData(path, xFactor, yFactor) {
  let newPathData = "";
  let pd = path.getPathData({
    normalize: true
  });
  {
    for (let p of pd) {
