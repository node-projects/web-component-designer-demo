...
(() => {
  class CssCombiner {
    ...
    static combineMargin(styles) {//let e = CssCombiner._helperElement;
    }

    static combinePadding(styles) {//let e = CssCombiner._helperElement;
    }

    static combineBackground(styles) {//let e = CssCombiner._helperElement;
    }
