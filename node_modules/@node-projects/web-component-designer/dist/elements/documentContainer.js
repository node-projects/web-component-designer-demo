...
export class DocumentContainer extends BaseCustomWebComponent {
  ...
  set content(value) {
    this._content = value;
    if (this._tabControl.selectedIndex === 0) this._designerView.parseHTML(this._content);else if (this._tabControl.selectedIndex === 1) this._codeView.update(this._content);
  }
  ...
  ready() {
    ...
    this._tabControl.onSelectedTabChanged.on(i => {
      ...
      if (i.newIndex === 0) this._designerView.parseHTML(this._content);else if (i.newIndex === 1) this._codeView.update(this._content);
    });
  }
