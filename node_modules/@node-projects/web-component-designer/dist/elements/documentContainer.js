import { BaseCustomWebComponentLazyAppend, css } from "../../node_modules/@node-projects/base-custom-webcomponent/dist/index.js";
...
export class DocumentContainer extends BaseCustomWebComponentLazyAppend {
  ...
  ready() {
    this._tabControl.onSelectedTabChanged.on(i => {
      if (i.oldIndex === 0) this._content = this.designerView.getHTML();else if (i.oldIndex === 1) this._content = this.codeView.getText();
      if (i.newIndex === 0) this.designerView.parseHTML(this._content);else if (i.newIndex === 1) this.codeView.update(this._content);else if (i.newIndex === 2) this.demoView.display(this._content);
    });
