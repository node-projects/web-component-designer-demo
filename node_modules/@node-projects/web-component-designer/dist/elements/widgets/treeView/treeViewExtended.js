import { css, html, BaseCustomWebComponentConstructorAppend } from "../../../../../base-custom-webcomponent/dist/index.js";
...
export class TreeViewExtended extends BaseCustomWebComponentConstructorAppend {
  ...
  _showHideAtDesignTimeState(img, designItem) {
    if (designItem.hideAtDesignTime) img.src = assetsPath + "images/treeview/eyeclose.png";else img.src = assetsPath + "images/treeview/eyeopen.png";
  }
  ...
  _showLockAtDesignTimeState(img, designItem) {
    if (designItem.lockAtDesignTime) img.src = assetsPath + "images/treeview/lock.png";else img.src = assetsPath + "images/treeview/dot.png";
  }
  ...
  _showHideAtRunTimeState(img, designItem) {
    if (designItem.hideAtRunTime) img.src = assetsPath + "images/treeview/eyeclose.png";else img.src = assetsPath + "images/treeview/eyeopen.png";
  }
  ...
  async ready() {
    ...
    $(this._treeDiv).fancytree({
      ...
      activate: (event, data) => {
        ...
        if (designItem) designItem.instanceServiceContainer.selectionService.setSelectedElements([designItem]);
      },
