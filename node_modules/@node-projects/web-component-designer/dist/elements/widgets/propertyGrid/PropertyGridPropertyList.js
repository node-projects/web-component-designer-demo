import { BaseCustomWebComponentLazyAppend, css, DomHelper } from "../../../../../base-custom-webcomponent/dist/index.js";
...
export class PropertyGridPropertyList extends BaseCustomWebComponentLazyAppend {
  ...
  refreshForDesignItems(items) {
    for (let m of this._propertyMap) {
      ...
      } else if (s == ValueType.all) m[1].isSetElement.style.background = 'white';else if (s == ValueType.some) m[1].isSetElement.style.background = 'gray';else if (s == ValueType.bound) m[1].isSetElement.style.background = 'orange';
