export class AbstractExtension {
  ...
  _drawLineOverlay(x1, y1, x2, y2, className, line) {
    if (!line) {
  ...
  _drawCircleOverlay(x, y, radius, className, circle) {
    if (!circle) {
  ...
  _drawRect(x, y, w, h, className, rect) {
    if (!rect) {
  ...
  _drawText(text, x, y, className, textEl) {
    if (!textEl) {
