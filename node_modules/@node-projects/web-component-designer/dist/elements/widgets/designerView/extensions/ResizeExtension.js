  ...
  _pointerActionTypeResize(event, actionMode = 'se-resize') {
    ...
    switch (event.type) {
      case EventNames.PointerDown:
        ...
        if (this.designerView.alignOnSnap) this.designerView.snapLines.calculateSnaplines(this.designerView.instanceServiceContainer.selectionService.selectedElements);
        break;
