    ...
    _pointerActionTypeDragOrSelect(event, currentDesignItem, currentPoint) {
      ...
      switch (event.type) {
        ...
        case EventNames.PointerUp:
          ...
          let cg = this.rootDesignItem.openGroup("Move Element", this.instanceServiceContainer.selectionService.selectedElements); //todo this needs also to get info from container handler, cause position is dependent of container
