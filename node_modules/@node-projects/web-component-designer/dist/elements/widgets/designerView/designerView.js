...
/** @class */
(() => {
  class DesignerView extends BaseCustomWebComponent {
    constructor() {
      super(); // Settings
      ...
      let zoomInput = this._getDomElement('zoomInput');

      zoomInput.onchange = () => {
        this._zoomFactor = parseInt(zoomInput.value);
        zoomInput.value = this._zoomFactor + '%';
      ...
      this._snaplines = new Snaplines(this._getDomElement('svg'));
    }
    ...
    _pointerActionTypeDragOrSelect(event, currentDesignItem, currentPoint) {
      ...
      switch (event.type) {
        ...
        case EventNames.PointerUp:
          ...
          let cg = this.rootDesignItem.openGroup("Move Elements", this.instanceServiceContainer.selectionService.selectedElements); //todo this needs also to get info from container handler, cause position is dependent of container
          ...
          for (const designItem of this.instanceServiceContainer.selectionService.selectedElements) {
            ...
            if (this._dropTarget && this._dropTarget != movedElement.parentElement) {
              ...
              designItem.setStyle('top', trackY + oldTop + "px"); //todo
