...
import { BaseCustomWebComponentLazyAppend, css, html } from '/node_modules/@node-projects/base-custom-webcomponent/./dist/index.js';
...
import { DomHelper } from '/node_modules/@node-projects/base-custom-webcomponent/dist/DomHelper.js';
...
export class DesignerView extends BaseCustomWebComponentLazyAppend {
    ...
    _pointerEventHandler(event) {
        ...
        if (currentElement && DesignerView.getHost(currentElement.parentNode) === this.overlayLayer)
            currentElement = (_a = this.instanceServiceContainer.selectionService.primarySelection.element) !== null && _a !== void 0 ? _a : this._canvas;
        this._fillCalculationrects();
