...
import * as monaco from '/web-component-designer-demo/node_modules/monaco-editor/./esm/vs/editor/editor.main.js';
  ...
  `;
    ...
    async ready() {
        ...
        if (window.importShim)
            ...
            //@ts-ignore
            style = await import("/web-component-designer-demo/node_modules/monaco-editor/min/vs/editor/editor.main.css", { assert: { type: 'css' } });
