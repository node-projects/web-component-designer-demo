...
export class CodeViewCodeMirror extends BaseCustomWebComponentLazyAppend {
    ...
    constructor() {
        super();
        //@ts-ignore
        import("/web-component-designer-demo/node_modules/codemirror/lib/codemirror.css", { assert: { type: 'css' } }).then(x => this.shadowRoot.adoptedStyleSheets = [x.default, this.constructor.style]);
