  ...
  static createDesignItemFromInstance(node, serviceContainer, instanceServiceContainer) {
    ...
    for (let a of designItem.element.attributes) {
      if (a.name !== 'style') {
        ...
        if (a.name === 'node-projects-hide-at-design-time') designItem._hideAtDesignTime = true;
        if (a.name === 'node-projects-hide-at-run-time') designItem._hideAtRunTime = true;
        if (a.name === 'node-projects-lock-at-design-time') designItem._lockAtDesignTime = true;
      }
    }
