import { BaseCustomWebComponentLazyAppend, css, TypedEvent } from "../../../../base-custom-webcomponent/dist/index.js";
  ...
  _createItems() {
    ...
    for (let item of this.children) {
      ...
      tabHeaderDiv.onpointerdown = () => {
        ...
        if (this._headerDiv.children.length) this._selectedIndexChanged(old, true);
      };
  ...
  _selectedIndexChanged(oldIndex, viaClick = false) {
    for (let index = 0; index < this.children.length; index++) {
      ...
      if (index == this._selectedIndex) {
        ...
        if (element.activated) element.activated();
      } else {
