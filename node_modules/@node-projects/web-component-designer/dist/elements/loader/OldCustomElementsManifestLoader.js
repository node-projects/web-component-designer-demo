import { LazyLoader } from "../../../../base-custom-webcomponent/dist/index.js";
...
export class OldCustomElementsManifestLoader {
  static async loadManifest(serviceContainer, nodeModule, options) {
    ...
    if (packageJson.module) jsModule = nodePath + nodeModule + '/' + packageJson.module;
    ...
    if (!options || !options.dontLoadWidgets) {
      ...
      const service = new PreDefinedElementsService(name, {
