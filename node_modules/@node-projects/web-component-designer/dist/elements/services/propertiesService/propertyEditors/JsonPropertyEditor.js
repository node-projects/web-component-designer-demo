...
import { html } from "../../../../../node_modules/@node-projects/base-custom-webcomponent/dist/index.js";
export class JsonPropertyEditor extends BasePropertyEditor {
  ...
  refreshValue(valueType, value) {
    if (valueType == 'none') this._input.value = null;else this._input.value = value;
  }
