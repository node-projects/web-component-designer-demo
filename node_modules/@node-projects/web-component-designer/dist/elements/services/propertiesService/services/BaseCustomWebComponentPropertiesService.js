...
import { BaseCustomWebComponentLazyAppend, BaseCustomWebComponentConstructorAppend } from "../../../../../node_modules/@node-projects/base-custom-webcomponent/dist/index.js";
export class BaseCustomWebComponentPropertiesService {
  ...
  clearValue(designItems, property) {
    for (let d of designItems) {
      if (property.type === 'object') d.removeAttribute(property.name); //@ts-ignore
