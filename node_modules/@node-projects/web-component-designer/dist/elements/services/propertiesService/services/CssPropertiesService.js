...
export class CssPropertiesService {
  ...
  isSet(designItems, property) {
    let all = true;
    let some = false;
    if (designItems != null && designItems.length !== 0) designItems.forEach(x => {
  ...
  getUnsetValue(designItems, property) {
    return null; //return window.getComputedStyle(designItem.element)[property.name]; //todo cache the computed style per design item when selction changes
  }
