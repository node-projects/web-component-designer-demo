...
export function createDefaultServiceContainer() {
    ...
    serviceContainer.designViewToolbarButtons.push(new PointerToolButtonProvider(), new SelectorToolButtonProvider(), new SimpleToolButtonProvider("Margin", assetsPath + 'images/tools/Margin.svg'), new SimpleToolButtonProvider("Padding", assetsPath + 'images/tools/Padding.svg'), new ZoomToolButtonProvider(), new DrawToolButtonProvider(), new TextToolButtonProvider(), new TransformToolButtonProvider());
