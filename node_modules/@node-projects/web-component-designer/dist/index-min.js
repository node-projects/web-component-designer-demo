var Ep=Object.defineProperty;var p=(s,e)=>()=>(s&&(e=s(s=0)),e);var Ap=(s,e)=>{for(var t in e)Ep(s,t,{get:e[t],enumerable:!0})};import{BaseCustomWebComponentLazyAppend as Pp,css as kp,TypedEvent as Ip,DomHelper as Ah}from"@node-projects/base-custom-webcomponent";var Ye,Ot=p(()=>{"use strict";Ye=class extends Pp{_selectedIndex=-1;_panels;_headerDiv;_moreDiv;_moreContainer;_elementMap=new WeakMap;_firstConnect=!0;static style=kp`
        :host {
            height: 100%;
        }
        .outer {
...
`}getString(){return this._textHolder}}});var dr,Oh=p(()=>{"use strict";dr=class{_textHolder="";get position(){return this._textHolder.length}isLastCharNewline(){return this._textHolder[this._textHolder.length-1]===`
`}levelRaise(){}levelShrink(){}write(e){this._textHolder+=e}writeLine(e){this._textHolder+=e}writeIndent(){}writeNewline(){}getString(){return this._textHolder}}});var K,Te=p(()=>{"use strict";zo();Oh();K=class{static normalizeAttributeValue(e,t=!1){return typeof e=="number"&&(e=e.toString()),e?t?e.replaceAll("&","&amp;").replaceAll("'","&#39;").replaceAll("<","&lt;").replaceAll(">","&gt;"):e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;").replaceAll(">","&gt;"):e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}static normalizeContentValue(e){return e&&e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll("\xA0","&nbsp;")}static IsSelfClosingElement(e){return e==="area"||e==="base"||e==="br"||e==="col"||e==="embed"||e==="hr"||e==="img"||e==="input"||e==="keygen"||e==="link"||e==="meta"||e==="param"||e==="source"||e==="track"||e==="wbr"}static ConvertToString(e,t,i=!1){let r=t!==!1?new hr:new dr;return e[0].serviceContainer.htmlWriterService.write(r,e,!0,i),r.getString()}}});import{css as jp}from"@node-projects/base-custom-webcomponent";var he,Bo,at=p(()=>{"use strict";he=class s{static _contextMenuCss=jp`
	  .context_menu {
		position: fixed;
		opacity: 0;
		transform: scale(0);
  ...
  `;_leftInput;_topInput;_rightInput;_bottomInput;_valueLeft;get valueLeft(){return this._valueLeft}set valueLeft(e){let t=this._valueLeft;this._valueLeft=e,t!==e&&(this._updateValue(),this.valueLeftChanged.emit({newValue:e,oldValue:t}))}valueLeftChanged=new kr;_valueTop;get valueTop(){return this._valueTop}set valueTop(e){let t=this._valueTop;this._valueTop=e,t!==e&&(this._updateValue(),this.valueTopChanged.emit({newValue:e,oldValue:t}))}valueTopChanged=new kr;_valueRight;get valueRight(){return this._valueRight}set valueRight(e){let t=this._valueRight;this._valueRight=e,t!==e&&(this._updateValue(),this.valueRightChanged.emit({newValue:e,oldValue:t}))}valueRightChanged=new kr;_valueBottom;get valueBottom(){return this._valueBottom}set valueBottom(e){let t=this._valueBottom;this._valueBottom=e,t!==e&&(this._updateValue(),this.valueBottomChanged.emit({newValue:e,oldValue:t}))}valueBottomChanged=new kr;property;unsetValue;_updateValue(){this._leftInput.value=this.valueLeft,this._topInput.value=this.valueTop,this._rightInput.value=this.valueRight,this._bottomInput.value=this._valueBottom}ready(){this._parseAttributesToProperties(),this._leftInput=this._getDomElement("left"),this._topInput=this._getDomElement("top"),this._rightInput=this._getDomElement("right"),this._bottomInput=this._getDomElement("bottom"),this._leftInput.onkeyup=e=>{e.key==="Enter"&&(this._valueLeft=this._leftInput.value)},this._topInput.onkeyup=e=>{e.key==="Enter"&&(this._valueTop=this._topInput.value)},this._rightInput.onkeyup=e=>{e.key==="Enter"&&(this._valueRight=this._rightInput.value)},this._bottomInput.onkeyup=e=>{e.key==="Enter"&&(this._valueBottom=this._bottomInput.value)},this._leftInput.onblur=e=>this._valueLeft=this._leftInput.value,this._topInput.onblur=e=>this._valueTop=this._topInput.value,this._rightInput.onblur=e=>this._valueRight=this._rightInput.value,this._bottomInput.onblur=e=>this._valueBottom=this._bottomInput.value,this._updateValue()}};customElements.define("node-projects-thickness-editor",Ci)});var Ir,na=p(()=>{"use strict";ve();Bh();Ir=class extends Q{constructor(e){super(e);let t=new Ci;t.property=e.name,t.valueLeftChanged.on(i=>this._valueChanged(i.newValue)),this.element=t}refreshValue(e,t){this.element.valueLeft=t}}});var Vt,sa=p(()=>{"use strict";ve();Vt=class s extends Q{static fontList;constructor(e){super(e);let t=document.createElement("select");e.readonly&&(t.disabled=!0),this.element=t,s.addFontsToSelect(t),this.element.onchange=i=>this._valueChanged(this.element.value)}static addFontsToSelect(e){s.fontList?s.parseFontList(e):window.queryLocalFonts?window.queryLocalFonts().then(t=>{s.fontList=[...new Set(t.map(i=>i.family))],s.parseFontList(e)}):(s.fontList=["Verdana","Arial","Tahoma","Trebuchet MS","Times New Roman","Georgia","Garamond","Courier New","Brush Script MT"],s.parseFontList(e))}static parseFontList(e){for(let t of s.fontList){let i=document.createElement("option");i.value=t,i.text=t,e.appendChild(i)}}refreshValue(e,t){this.element.value=t}}});var Dr,oa=p(()=>{"use strict";Zo();$o();qo();Qo();Jo();ea();ta();ra();na();sa();Dr=class{getEditorForProperty(e){if(e.createEditor)return e.createEditor(e);switch(e.type){case"json":return new wr(e);case"color":return new _r(e);case"font":return new Vt(e);case"date":return new br(e);case"number":return new Sr(e);case"list":return new wi(e);case"enum":return new wi(e);case"boolean":return new Er(e);case"img-list":return new Pr(e);case"thickness":return new Ir(e);case"css-length":case"string":default:return new Cr(e)}}}});import{BaseCustomWebComponentLazyAppend as em,BaseCustomWebComponentConstructorAppend as tm,BaseCustomWebComponentNoAttachedTemplate as im,BaseCustomWebComponentConstructorAppendLazyReady as rm}from"@node-projects/base-custom-webcomponent";var Tr,aa=p(()=>{"use strict";Lt();Tr=class extends Fe{name="baseCustomWebComponent";isHandledElement(e){return e.element instanceof em||e.element instanceof rm||e.element instanceof tm||e.element instanceof im}_notifyChangedProperty(e,t,i){e.element._parseAttributesToProperties()}}});function Mr(s,e,t){if(e==null||e==""){s.style.transform=t;return}let i=new DOMMatrix(e),n=new DOMMatrix(t).multiply(i);s.style.transform=n.toString()}function la(s,e){let t=e.inverse();return s.matrixTransform(t)}function Ht(s){return new DOMPoint(s.m41,s.m42,0,0)}var Or=p(()=>{"use strict"});function ne(s){let e=[];e:for(let t of s){let i=t.parent;for(;i!=null&&!i.isRootItem;){if(s.indexOf(i)>=0)continue e;i=i.parent}e.push(t)}return e}function Nr(s,e){if(e==="position"){let t=getComputedStyle(s.element),i=parseFloat(t.left);i=Number.isNaN(i)?null:i;let r=parseFloat(t.top);return r=Number.isNaN(r)?null:r,{x:i,y:r}}return{x:0,y:0}}function Lr(s,e,t,i){let r=e.element,n=getComputedStyle(r);if(i==="position"){let o=s.element,a=s.getComputedStyle();a.position!=="relative"&&a.position!=="absolute"&&o.offsetParent&&(o=o.offsetParent,a=s.window.getComputedStyle(o));let l=null,c=null,h=null,d=null,m=0,g=0,u=0,f=0,b=!1;if(n.position==="relative"||n.position==="absolute")l=parseFloat(r.style.left),l=Number.isNaN(l)?null:l,h=parseFloat(r.style.top),h=Number.isNaN(h)?null:h,c=parseFloat(r.style.right),c=Number.isNaN(c)?null:c,d=parseFloat(r.style.bottom),d=Number.isNaN(d)?null:d,b=!0;else if(o!==s.element){let _=W(o),C=W(e.element);m=C.left-_.left,g=C.right-_.right,u=C.top-_.top,f=C.bottom-_.bottom}b||e.setStyle("position","absolute"),(l||c==null)&&e.setStyle("left",O(e,t.x+(l??0)+m)+"px"),(h||d==null)&&e.setStyle("top",O(e,t.y+(h??0)+u)+"px"),c&&e.setStyle("right",O(e,(c??0)-t.x+g)+"px"),d&&e.setStyle("bottom",O(e,(d??0)-t.y+f)+"px")}}function O(s,e){return s.serviceContainer.options.roundPixelsToDecimalPlaces>=0?e.toFixed(s.serviceContainer.options.roundPixelsToDecimalPlaces):e.toString()}var be=p(()=>{"use strict";te()});function Ze(s,e,t=!1){let i,r=Vh(s,e),n;return t?r>=315&&r<360||r>=0&&r<45?i={x:e.x,y:s.y}:r>=45&&r<135?i={x:s.x,y:e.y}:r>=135&&r<225?i={x:e.x,y:s.y}:r>=225&&r<315&&(i={x:s.x,y:e.y}):r>=337.5&&r<360||r>=0&&r<22.5?i={x:e.x,y:s.y}:r>=22.5&&r<67.5?(n=Be(s,e),i={x:s.x+n,y:s.y-n}):r>=67.5&&r<112.5?i={x:s.x,y:e.y}:r>=112.5&&r<157.5?(n=Be(s,e),i={x:s.x-n,y:s.y-n}):r>=157.5&&r<202.5?i={x:e.x,y:s.y}:r>=202.5&&r<247.5?(n=Be(s,e),i={x:s.x-n,y:s.y+n}):r>=247.5&&r<292.5?i={x:s.x,y:e.y}:r>=292.5&&r<337.5&&(n=Be(s,e),i={x:s.x+n,y:s.y+n}),i}function Be(s,e){let t,i=Math.sqrt(Math.pow(e.x-s.x,2)+Math.pow(e.y-s.y,2)),r=Vh(s,e),n=r-(Math.floor(r/90)*90+45);return t=i*Math.cos(n*(Math.PI/180))/Math.sqrt(2),t}function Vh(s,e){let t=-1*Math.atan2(e.y-s.y,e.x-s.x)*180/Math.PI;return t<0&&(t+=360),t}function Hh(s,e,t){let i="",r=s.getPathData({normalize:!0});for(let n of r)switch(n.type){case"M":case"m":case"L":case"l":case"T":case"t":i+=n.type+" "+(n.values[0]-e)+" "+(n.values[1]-t)+" ";break;case"Z":case"z":i+=n.type+" ";break;case"C":case"c":i+=n.type+" "+(n.values[0]-e)+" "+(n.values[1]-t)+" "+(n.values[2]-e)+" "+(n.values[3]-t)+" "+(n.values[4]-e)+" "+(n.values[5]-t)+" ";break;case"S":case"s":case"Q":case"q":i+=n.type+" "+(n.values[0]-e)+" "+(n.values[1]-t)+" "+(n.values[2]-e)+" "+(n.values[3]-t)+" ";break;case"A":case"a":i+=n.type+" "+(n.values[0]-e)+" "+(n.values[1]-t)+" "+n.values[2]+" "+n.values[3]+" "+n.values[4]+" "+(n.values[5]-e)+" "+(n.values[6]-t)+" ";break}return i}function Me(s){let e="";for(let i of s){e+=i.type+" ";for(var t=0;t<i.values.length;t++)i.values[t]!=null&&!isNaN(i.values[t])&&(e+=i.values[t]+" ")}return e}var Oe=p(()=>{"use strict";(!SVGPathElement.prototype.getPathData||!SVGPathElement.prototype.setPathData)&&(function(){var s={Z:"Z",M:"M",L:"L",C:"C",Q:"Q",A:"A",H:"H",V:"V",S:"S",T:"T",z:"Z",m:"m",l:"l",c:"c",q:"q",a:"a",h:"h",v:"v",s:"s",t:"t"},e=function(o){this._string=o,this._currentIndex=0,this._endIndex=this._string.length,this._prevCommand=null,this._skipOptionalSpaces()};e.prototype={parseSegment:function(){var o=this._string[this._currentIndex],a=s[o]?s[o]:null;if(a===null){if(this._prevCommand===null||((o==="+"||o==="-"||o==="."||o>="0"&&o<="9")&&this._prevCommand!=="Z"?this._prevCommand==="M"?a="L":this._prevCommand==="m"?a="l":a=this._prevCommand:a=null,a===null))return null}else this._currentIndex+=1;this._prevCommand=a;var l=null,c=a.toUpperCase();return c==="H"||c==="V"?l=[this._parseNumber()]:c==="M"||c==="L"||c==="T"?l=[this._parseNumber(),this._parseNumber()]:c==="S"||c==="Q"?l=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:c==="C"?l=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseNumber()]:c==="A"?l=[this._parseNumber(),this._parseNumber(),this._parseNumber(),this._parseArcFlag(),this._parseArcFlag(),this._parseNumber(),this._parseNumber()]:c==="Z"&&(this._skipOptionalSpaces(),l=[]),l===null||l.indexOf(null)>=0?null:{type:a,values:l}},hasMoreData:function(){return this._currentIndex<this._endIndex},peekSegmentType:function(){var o=this._string[this._currentIndex];return s[o]?s[o]:null},initialCommandIsMoveTo:function(){if(!this.hasMoreData())return!0;var o=this.peekSegmentType();return o==="M"||o==="m"},_isCurrentSpace:function(){var o=this._string[this._currentIndex];return o<=" "&&(o===" "||o===`
`||o==="	"||o==="\r"||o==="\f")},_skipOptionalSpaces:function(){for(;this._currentIndex<this._endIndex&&this._isCurrentSpace();)this._currentIndex+=1;return this._currentIndex<this._endIndex},_skipOptionalSpacesOrDelimiter:function(){return this._currentIndex<this._endIndex&&!this._isCurrentSpace()&&this._string[this._currentIndex]!==","?!1:(this._skipOptionalSpaces()&&this._currentIndex<this._endIndex&&this._string[this._currentIndex]===","&&(this._currentIndex+=1,this._skipOptionalSpaces()),this._currentIndex<this._endIndex)},_parseNumber:function(){var o=0,a=0,l=1,c=0,h=1,d=1,m=this._currentIndex;if(this._skipOptionalSpaces(),this._currentIndex<this._endIndex&&this._string[this._currentIndex]==="+"?this._currentIndex+=1:this._currentIndex<this._endIndex&&this._string[this._currentIndex]==="-"&&(this._currentIndex+=1,h=-1),this._currentIndex===this._endIndex||(this._string[this._currentIndex]<"0"||this._string[this._currentIndex]>"9")&&this._string[this._currentIndex]!==".")return null;for(var g=this._currentIndex;this._currentIndex<this._endIndex&&this._string[this._currentIndex]>="0"&&this._string[this._currentIndex]<="9";)this._currentIndex+=1;if(this._currentIndex!==g)for(var u=this._currentIndex-1,f=1;u>=g;)a+=f*(this._string[u]-"0"),u-=1,f*=10;if(this._currentIndex<this._endIndex&&this._string[this._currentIndex]==="."){if(this._currentIndex+=1,this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||this._string[this._currentIndex]>"9")return null;for(;this._currentIndex<this._endIndex&&this._string[this._currentIndex]>="0"&&this._string[this._currentIndex]<="9";)l*=10,c+=(this._string.charAt(this._currentIndex)-"0")/l,this._currentIndex+=1}if(this._currentIndex!==m&&this._currentIndex+1<this._endIndex&&(this._string[this._currentIndex]==="e"||this._string[this._currentIndex]==="E")&&this._string[this._currentIndex+1]!=="x"&&this._string[this._currentIndex+1]!=="m"){if(this._currentIndex+=1,this._string[this._currentIndex]==="+"?this._currentIndex+=1:this._string[this._currentIndex]==="-"&&(this._currentIndex+=1,d=-1),this._currentIndex>=this._endIndex||this._string[this._currentIndex]<"0"||this._string[this._currentIndex]>"9")return null;for(;this._currentIndex<this._endIndex&&this._string[this._currentIndex]>="0"&&this._string[this._currentIndex]<="9";)o*=10,o+=this._string[this._currentIndex]-"0",this._currentIndex+=1}var b=a+c;return b*=h,o&&(b*=Math.pow(10,d*o)),m===this._currentIndex?null:(this._skipOptionalSpacesOrDelimiter(),b)},_parseArcFlag:function(){if(this._currentIndex>=this._endIndex)return null;var o=null,a=this._string[this._currentIndex];if(this._currentIndex+=1,a==="0")o=0;else if(a==="1")o=1;else return null;return this._skipOptionalSpacesOrDelimiter(),o}};var t=function(o){if(!o||o.length===0)return[];var a=new e(o),l=[];if(a.initialCommandIsMoveTo())for(;a.hasMoreData();){var c=a.parseSegment();if(c===null)break;l.push(c)}return l},i=function(o,a,l,c,h,d,m,g,u,f){var b=function(yt){return Math.PI*yt/180},_=function(yt,hi,vt){var Sp=yt*Math.cos(vt)-hi*Math.sin(vt),Cp=yt*Math.sin(vt)+hi*Math.cos(vt);return{x:Sp,y:Cp}},C=b(m),I=[],P,D,A,L;if(f)P=f[0],D=f[1],A=f[2],L=f[3];else{var H=_(o,a,-C);o=H.x,a=H.y;var ae=_(l,c,-C);l=ae.x,c=ae.y;var B=(o-l)/2,xe=(a-c)/2,Re=B*B/(h*h)+xe*xe/(d*d);Re>1&&(Re=Math.sqrt(Re),h=Re*h,d=Re*d);var gt;g===u?gt=-1:gt=1;var Ke=h*h,Tt=d*d,up=Ke*Tt-Ke*xe*xe-Tt*B*B,fp=Ke*xe*xe+Tt*B*B,Xi=gt*Math.sqrt(Math.abs(up/fp));A=Xi*h*xe/d+(o+l)/2,L=Xi*-d*B/h+(a+c)/2,P=Math.asin(parseFloat(((a-L)/d).toFixed(9))),D=Math.asin(parseFloat(((c-L)/d).toFixed(9))),o<A&&(P=Math.PI-P),l<A&&(D=Math.PI-D),P<0&&(P=Math.PI*2+P),D<0&&(D=Math.PI*2+D),u&&P>D&&(P=P-Math.PI*2),!u&&D>P&&(D=D-Math.PI*2)}var Co=D-P;if(Math.abs(Co)>Math.PI*120/180){var gp=D,yp=l,vp=c;u&&D>P?D=P+Math.PI*120/180*1:D=P+Math.PI*120/180*-1,l=A+h*Math.cos(D),c=L+d*Math.sin(D),I=i(l,c,yp,vp,h,d,m,0,u,[D,gp,A,L])}Co=D-P;var xp=Math.cos(P),_p=Math.sin(P),bp=Math.cos(D),wp=Math.sin(D),xh=Math.tan(Co/4),_h=4/3*h*xh,bh=4/3*d*xh,wh=[o,a],Mt=[o+_h*_p,a-bh*xp],Sh=[l+_h*wp,c-bh*bp],Ch=[l,c];if(Mt[0]=2*wh[0]-Mt[0],Mt[1]=2*wh[1]-Mt[1],f)return[Mt,Sh,Ch].concat(I);I=[Mt,Sh,Ch].concat(I);for(var Eh=[],rt=0;rt<I.length;rt+=3){let yt=_(I[rt][0],I[rt][1],C),hi=_(I[rt+1][0],I[rt+1][1],C),vt=_(I[rt+2][0],I[rt+2][1],C);Eh.push([yt.x,yt.y,hi.x,hi.y,vt.x,vt.y])}return Eh},r=function(o){var a=[],l=null,c=null,h=null,d=null;return o.forEach(function(m){var g=m.type;if(g==="M"){var u=m.values[0],f=m.values[1];a.push({type:"M",values:[u,f]}),h=u,d=f,l=u,c=f}else if(g==="m"){var u=l+m.values[0],f=c+m.values[1];a.push({type:"M",values:[u,f]}),h=u,d=f,l=u,c=f}else if(g==="L"){var u=m.values[0],f=m.values[1];a.push({type:"L",values:[u,f]}),l=u,c=f}else if(g==="l"){var u=l+m.values[0],f=c+m.values[1];a.push({type:"L",values:[u,f]}),l=u,c=f}else if(g==="C"){var b=m.values[0],_=m.values[1],C=m.values[2],I=m.values[3],u=m.values[4],f=m.values[5];a.push({type:"C",values:[b,_,C,I,u,f]}),l=u,c=f}else if(g==="c"){var b=l+m.values[0],_=c+m.values[1],C=l+m.values[2],I=c+m.values[3],u=l+m.values[4],f=c+m.values[5];a.push({type:"C",values:[b,_,C,I,u,f]}),l=u,c=f}else if(g==="Q"){var b=m.values[0],_=m.values[1],u=m.values[2],f=m.values[3];a.push({type:"Q",values:[b,_,u,f]}),l=u,c=f}else if(g==="q"){var b=l+m.values[0],_=c+m.values[1],u=l+m.values[2],f=c+m.values[3];a.push({type:"Q",values:[b,_,u,f]}),l=u,c=f}else if(g==="A"){var u=m.values[5],f=m.values[6];a.push({type:"A",values:[m.values[0],m.values[1],m.values[2],m.values[3],m.values[4],u,f]}),l=u,c=f}else if(g==="a"){var u=l+m.values[5],f=c+m.values[6];a.push({type:"A",values:[m.values[0],m.values[1],m.values[2],m.values[3],m.values[4],u,f]}),l=u,c=f}else if(g==="H"){var u=m.values[0];a.push({type:"H",values:[u]}),l=u}else if(g==="h"){var u=l+m.values[0];a.push({type:"H",values:[u]}),l=u}else if(g==="V"){var f=m.values[0];a.push({type:"V",values:[f]}),c=f}else if(g==="v"){var f=c+m.values[0];a.push({type:"V",values:[f]}),c=f}else if(g==="S"){var C=m.values[0],I=m.values[1],u=m.values[2],f=m.values[3];a.push({type:"S",values:[C,I,u,f]}),l=u,c=f}else if(g==="s"){var C=l+m.values[0],I=c+m.values[1],u=l+m.values[2],f=c+m.values[3];a.push({type:"S",values:[C,I,u,f]}),l=u,c=f}else if(g==="T"){var u=m.values[0],f=m.values[1];a.push({type:"T",values:[u,f]}),l=u,c=f}else if(g==="t"){var u=l+m.values[0],f=c+m.values[1];a.push({type:"T",values:[u,f]}),l=u,c=f}else(g==="Z"||g==="z")&&(a.push({type:"Z",values:[]}),l=h,c=d)}),a},n=function(o){var a=[],l=null,c=null,h=null,d=null,m=null,g=null,u=null;return o.forEach(function(f){if(f.type==="M"){var b=f.values[0],_=f.values[1];a.push({type:"M",values:[b,_]}),g=b,u=_,d=b,m=_}else if(f.type==="C"){var C=f.values[0],I=f.values[1],P=f.values[2],D=f.values[3],b=f.values[4],_=f.values[5];a.push({type:"C",values:[C,I,P,D,b,_]}),c=P,h=D,d=b,m=_}else if(f.type==="L"){var b=f.values[0],_=f.values[1];a.push({type:"L",values:[b,_]}),d=b,m=_}else if(f.type==="H"){var b=f.values[0];a.push({type:"L",values:[b,m]}),d=b}else if(f.type==="V"){var _=f.values[0];a.push({type:"L",values:[d,_]}),m=_}else if(f.type==="S"){var P=f.values[0],D=f.values[1],b=f.values[2],_=f.values[3],A,L;l==="C"||l==="S"?(A=d+(d-c),L=m+(m-h)):(A=d,L=m),a.push({type:"C",values:[A,L,P,D,b,_]}),c=P,h=D,d=b,m=_}else if(f.type==="T"){var b=f.values[0],_=f.values[1],C,I;l==="Q"||l==="T"?(C=d+(d-c),I=m+(m-h)):(C=d,I=m);var A=d+2*(C-d)/3,L=m+2*(I-m)/3,H=b+2*(C-b)/3,ae=_+2*(I-_)/3;a.push({type:"C",values:[A,L,H,ae,b,_]}),c=C,h=I,d=b,m=_}else if(f.type==="Q"){var C=f.values[0],I=f.values[1],b=f.values[2],_=f.values[3],A=d+2*(C-d)/3,L=m+2*(I-m)/3,H=b+2*(C-b)/3,ae=_+2*(I-_)/3;a.push({type:"C",values:[A,L,H,ae,b,_]}),c=C,h=I,d=b,m=_}else if(f.type==="A"){let Ke=Math.abs(f.values[0]),Tt=Math.abs(f.values[1]);var B=f.values[2],xe=f.values[3],Re=f.values[4],b=f.values[5],_=f.values[6];if(Ke===0||Tt===0)a.push({type:"C",values:[d,m,b,_,b,_]}),d=b,m=_;else if(d!==b||m!==_){var gt=i(d,m,b,_,Ke,Tt,B,xe,Re);gt.forEach(function(Xi){a.push({type:"C",values:Xi})}),d=b,m=_}}else f.type==="Z"&&(a.push(f),d=g,m=u);l=f.type}),a};SVGPathElement.prototype.getPathData=function(o){if(o&&o.normalize){let a;return a=t(this.getAttribute("d")||""),n(r(a))}else return t(this.getAttribute("d")||"")},SVGPathElement.prototype.setPathData=function(o){if(o.length===0)this.removeAttribute("d");else{let a="";for(let l=0,c=o.length;l<c;l+=1){let h=o[l];l>0&&(a+=" "),a+=h.type,h.values&&h.values.length>0&&(a+=" "+h.values.join(" "))}this.setAttribute("d",a)}},SVGRectElement.prototype.getPathData=function(o){var a=this.x.baseVal.value,l=this.y.baseVal.value,c=this.width.baseVal.value,h=this.height.baseVal.value,d=this.hasAttribute("rx")?this.rx.baseVal.value:this.ry.baseVal.value,m=this.hasAttribute("ry")?this.ry.baseVal.value:this.rx.baseVal.value;d>c/2&&(d=c/2),m>h/2&&(m=h/2);var g=[{type:"M",values:[a+d,l]},{type:"H",values:[a+c-d]},{type:"A",values:[d,m,0,0,1,a+c,l+m]},{type:"V",values:[l+h-m]},{type:"A",values:[d,m,0,0,1,a+c-d,l+h]},{type:"H",values:[a+d]},{type:"A",values:[d,m,0,0,1,a,l+h-m]},{type:"V",values:[l+m]},{type:"A",values:[d,m,0,0,1,a+d,l]},{type:"Z",values:[]}];return g=g.filter(function(u){return!(u.type==="A"&&(u.values[0]===0||u.values[1]===0))}),o&&o.normalize===!0&&(g=n(g)),g},SVGCircleElement.prototype.getPathData=function(o){var a=this.cx.baseVal.value,l=this.cy.baseVal.value,c=this.r.baseVal.value,h=[{type:"M",values:[a+c,l]},{type:"A",values:[c,c,0,0,1,a,l+c]},{type:"A",values:[c,c,0,0,1,a-c,l]},{type:"A",values:[c,c,0,0,1,a,l-c]},{type:"A",values:[c,c,0,0,1,a+c,l]},{type:"Z",values:[]}];return o&&o.normalize===!0&&(h=n(h)),h},SVGEllipseElement.prototype.getPathData=function(o){var a=this.cx.baseVal.value,l=this.cy.baseVal.value,c=this.rx.baseVal.value,h=this.ry.baseVal.value,d=[{type:"M",values:[a+c,l]},{type:"A",values:[c,h,0,0,1,a,l+h]},{type:"A",values:[c,h,0,0,1,a-c,l]},{type:"A",values:[c,h,0,0,1,a,l-h]},{type:"A",values:[c,h,0,0,1,a+c,l]},{type:"Z",values:[]}];return o&&o.normalize===!0&&(d=n(d)),d},SVGLineElement.prototype.getPathData=function(){return[{type:"M",values:[this.x1.baseVal.value,this.y1.baseVal.value]},{type:"L",values:[this.x2.baseVal.value,this.y2.baseVal.value]}]},SVGPolylineElement.prototype.getPathData=function(){for(var o=[],a=0;a<this.points.numberOfItems;a+=1){var l=this.points.getItem(a);o.push({type:a===0?"M":"L",values:[l.x,l.y]})}return o},SVGPolygonElement.prototype.getPathData=function(){for(var o=[],a=0;a<this.points.numberOfItems;a+=1){var l=this.points.getItem(a);o.push({type:a===0?"M":"L",values:[l.x,l.y]})}return o.push({type:"Z",values:[]}),o}})()});function j(s){return Nh()?s.metaKey:s.ctrlKey}var Ne=p(()=>{"use strict";Pe()});function ca(s){let e=[];for(let t of s)t.nodeType===E.TextNode||t.nodeType===E.Comment||e.push(t);return e}var Ve,Gt=p(()=>{"use strict";Te();Or();be();De();Oe();Ne();Z();te();Ve=class{serviceForContainer(e,t,i){return i!=null&&i.getComputedStyle()?.position=="absolute"?!0:!(t.display==="grid"||t.display==="inline-grid"||t.display==="flex"||t.display==="inline-flex")}isEnterableContainer(e){return!(K.IsSelfClosingElement(e.element.localName)||!e.isRootItem&&e.element.shadowRoot&&e.element.shadowRoot.querySelector("slot")==null)}canEnter(e,t){return!(!this.isEnterableContainer(e)||!t.every(i=>!i.element.contains(e.element)&&i!==e))}canLeave(e,t){return!0}getElementOffset(e,t){return e.instanceServiceContainer.designerCanvas.getNormalizedElementCoordinates(e.element)}calculateTrack(e,t,i,r,n,o){let a=n.x-i.x,l=n.y-i.y;if(!j(e)){if(t.alignOnGrid){let c=Nr(o,"position");c.x=c.x%t.gridSize,c.y=c.y%t.gridSize,a=Math.round(a/t.gridSize)*t.gridSize-c.x,l=Math.round(l/t.gridSize)*t.gridSize-c.y}else if(t.alignOnSnap){let c=W(o.element),h=t.snapLines.snapToPosition({x:n.x-r.x,y:n.y-r.y},{width:c.width/t.scaleFactor,height:c.height/t.scaleFactor},{x:a>0?1:-1,y:l>0?1:-1});h.x!==null?a=h.x-Math.round(i.x)+Math.round(r.x):a=Math.round(a),h.y!==null?l=h.y-Math.round(i.y)+Math.round(r.y):l=Math.round(l)}}return{x:a,y:l}}placePoint(e,t,i,r,n,o,a){let l=o.x,c=o.y;if(!j(e)){if(t.alignOnGrid)l=Math.round(l/t.gridSize)*t.gridSize,c=Math.round(c/t.gridSize)*t.gridSize;else if(t.alignOnSnap){let h=t.snapLines.snapToPosition({x:o.x-n.x,y:o.y-n.y},null,{x:l>0?1:-1,y:c>0?1:-1});h.x!==null?l=h.x:l=Math.round(l),h.y!==null?c=h.y:c=Math.round(c)}}return{x:l,y:c}}startPlace(e,t,i,r,n,o,a){}place(e,t,i,r,n,o,a){let l=this.calculateTrack(e,t,r,n,o,a[0]);e.shiftKey&&(l=Ze({x:0,y:0},l,!0));let c=ne(ca(a));for(let h of c){let d=h.instanceServiceContainer.designerCanvas.canvas,m=h.parent.element.getBoxQuads({relativeTo:d,iframes:h.instanceServiceContainer.designerCanvas.iframes})[0],g=h.parent.element.convertPointFromNode(new DOMPoint(l.x+m.p1.x,l.y+m.p1.y),d,{iframes:h.instanceServiceContainer.designerCanvas.iframes}),u=getComputedStyle(h.element),f=new DOMMatrix;u.rotate!="none"&&u.rotate&&(f=f.multiply(new DOMMatrix("rotate("+u.rotate.replace(" ",",")+")"))),u.scale!="none"&&u.scale&&(f=f.multiply(new DOMMatrix("scale("+u.scale.replace(" ",",")+")"))),g=f.inverse().transformPoint(g);let b=new DOMMatrix().translate(g.x,g.y);Mr(h.element,h.getStyle("transform"),b.toString())}a[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(c,"place",!1)}moveElements(e,t,i){for(let r of e)t.x&&r.setStyle("left",parseInt(r.element.style.left)-t.x+"px"),t.y&&r.setStyle("top",parseInt(r.element.style.top)-t.y+"px");e[0].instanceServiceContainer.designerCanvas.extensionManager.refreshExtensions(e),e[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(e,"place",!0)}enterContainer(e,t,i){let r=ne(t);for(let n of r)i=="drop"&&n.setStyle("position","absolute"),e.insertChild(n),n.lastContainerSize&&(n.hasStyle("width")||n.setStyle("width",n.lastContainerSize.width+"px"),n.hasStyle("height")||n.setStyle("height",n.lastContainerSize.height+"px"));t[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(r,"place",!0)}leaveContainer(e,t){let i=ne(t);t[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(i,"place",!0)}finishPlace(e,t,i,r,n,o,a){let l=ne(a);for(let c of l){let h=Ht(new DOMMatrix(c.element.style.transform)),d=Ht(new DOMMatrix(c.getStyle("transform")??""));c.element.style.transform=c.getStyle("transform")??"";let m={x:h.x,y:h.y},g=getComputedStyle(c.element),u=new DOMMatrix;g.rotate!="none"&&g.rotate&&(u=u.multiply(new DOMMatrix("rotate("+g.rotate.replace(" ",",")+")"))),g.scale!="none"&&g.scale&&(u=u.multiply(new DOMMatrix("scale("+g.scale.replace(" ",",")+")"))),m=u.transformPoint(m),Lr(i,c,{x:m.x-d.x,y:m.y-d.y},"position")}for(let c of a)t.extensionManager.removeExtension(c,w.Placement);a[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(l,"place",!0)}}});var ht,Ei=p(()=>{"use strict";q();vr();ht=class{async parse(e,t,i,r){let n;Document.parseHTMLUnsafe&&!yr?n=Document.parseHTMLUnsafe(e):n=new DOMParser().parseFromString(e,"text/html",{includeShadowRoots:!0});let o=this.createDesignItems(n.head.childNodes,t,i),a=this.createDesignItems(n.body.childNodes,t,i);return[...o,...a]}createDesignItems(e,t,i){let r=[];for(let n of e)r.push(this._createDesignItemsRecursive(n,t,i));return r}_createDesignItemsRecursive(e,t,i){return T.createDesignItemFromInstance(e,t,i)}}});var Rr,ha=p(()=>{"use strict";Lt();ge();ie();Rr=class extends Fe{name="lit2";isHandledElement(e){return!!e.element.constructor.elementProperties}async getProperties(e){if(!this.isHandledElement(e))return null;let t=[];for(let i of e.element.constructor.elementProperties.entries()){let r=i[0],n=i[1],o=n;if(n.type&&(o=n.type),o===String){let a={name:r,type:"string",service:this,propertyType:y.propertyAndAttribute};t.push(a)}else if(o===Object){let a={name:r,type:"string",service:this,propertyType:y.propertyAndAttribute};t.push(a)}else if(o===Number){let a={name:r,type:"number",service:this,propertyType:y.propertyAndAttribute};t.push(a)}else if(o===Date){let a={name:r,type:"date",service:this,propertyType:y.propertyAndAttribute};t.push(a)}else if(o===Boolean){let a={name:r,type:"boolean",service:this,propertyType:y.propertyAndAttribute};t.push(a)}else if(R.isTypescriptEnum(o)){let a={name:r,type:"enum",enumValues:R.getTypescriptEnumEntries(o),service:this,propertyType:y.propertyAndAttribute};t.push(a)}}return t}_notifyChangedProperty(e,t,i){}}});function Gh(s,e){da||(da=document.createElement("canvas"));let t=da.getContext("2d");return t.font=e,t.measureText(s).width}var da,Wh=p(()=>{"use strict"});var U,$e=p(()=>{"use strict";(function(s){s.Pointer="Pointer",s.DrawSelection="DrawSelection",s.DrawPath="DrawPath",s.DrawRect="DrawRect",s.DrawEllipsis="DrawEllipsis",s.DrawLine="DrawLine",s.Zoom="Zoom",s.Pan="Pan",s.MagicWandSelector="MagicWandSelector",s.RectangleSelector="RectangleSelector",s.PickColor="PickColor",s.Text="Text",s.DrawElementTool="DrawElementTool",s.Guides="Guides",s.Inspect="Inspect",s.Accessibility="Accessibility",s.Position="Position",s.Padding="Padding",s.Margin="Margin",s.Flexbox="Flexbox",s.Move="Move",s.HueShift="HueShift",s.BoxShadows="BoxShadows",s.FontStyles="FontStyles"})(U||(U={}))});var k,X=p(()=>{"use strict";(function(s){s[s.Background=10]="Background",s[s.Normal=20]="Normal",s[s.Foreground=30]="Foreground"})(k||(k={}))});var Wt,pa=p(()=>{"use strict";X();Wt=class{overlays=[];overlayLayerView;extensionManager;designerCanvas;constructor(e,t){this.extensionManager=e,this.designerCanvas=t,this.overlayLayerView=t.overlayLayer}_backup;_valuesHaveChanges(...e){if(this._backup==null)return this._backup=e,!0;for(let t=0;t<e.length;t++)if(e[t]!==this._backup[t])return this._backup=e,!0;return!1}_removeAllOverlays(){for(let e of this.overlays)try{this.overlayLayerView.removeOverlay(e)}catch(t){console.error(t)}this.overlays=[]}_addOverlay(e,t=k.Normal){this.overlayLayerView.addOverlay(this.constructor.name,e,t),this.overlays.push(e)}_drawGroup(e,t,i){let r=this.overlayLayerView.drawGroup(this.constructor.name,e,t,i);return t||this.overlays.push(r),r}_drawLine(e,t,i,r,n,o,a){let l=this.overlayLayerView.drawLine(this.constructor.name,e,t,i,r,n,o,a);return o||this.overlays.push(l),l}_drawCircle(e,t,i,r,n,o){let a=this.overlayLayerView.drawCircle(this.constructor.name,e,t,i,r,n,o);return n||this.overlays.push(a),a}_drawRect(e,t,i,r,n,o,a){let l=this.overlayLayerView.drawRect(this.constructor.name,e,t,i,r,n,o,a);return o||this.overlays.push(l),l}_drawComplexRect(e,t,i,r){let n="M"+e.map(a=>a.x+","+a.y).join(" ")+"Z",o=this.overlayLayerView.drawPath(this.constructor.name,n,t,i,r);return i||this.overlays.push(o),o}_drawPath(e,t,i,r){let n=this.overlayLayerView.drawPath(this.constructor.name,e,t,i,r);return i||this.overlays.push(n),n}_drawText(e,t,i,r,n,o){let a=this.overlayLayerView.drawText(this.constructor.name,e,t,i,r,n,o);return n||this.overlays.push(a),a}_drawHTML(e,t,i,r,n,o,a,l){let c=this.overlayLayerView.drawHTML(this.constructor.name,e,t,i,r,n,o,a,l);return a||this.overlays.push(c),c}_drawTextWithBackground(e,t,i,r,n,o,a){let l=this.overlayLayerView.drawTextWithBackground(this.constructor.name,e,t,i,r,n,o,a);return o||this.overlays.push(...l),l}_drawTransformedRect(e,t,i,r){let n="M"+e.p1.x+" "+e.p1.y+" L"+e.p2.x+" "+e.p2.y+" L"+e.p3.x+" "+e.p3.y+" L"+e.p4.x+" "+e.p4.y+"Z",o=this.overlayLayerView.drawPath(this.constructor.name,n,t,i,r);return i||this.overlays.push(o),o}}});var N,J=p(()=>{"use strict";pa();X();N=class extends Wt{extendedItem;constructor(e,t,i){super(e,t),this.extendedItem=i}remove(){this.extensionManager.removeExtensionInstance(this.extendedItem,this)}createToolbar(e,t,i,r=k.Foreground){let n=e.content.cloneNode(!0);n.querySelectorAll("*").forEach(a=>{a.onpointerdown=l=>{this.designerCanvas.ignoreEvent(l)},a instanceof HTMLInputElement&&(a.addEventListener("keydown",l=>{this.designerCanvas.ignoreEvent(l)},{capture:!0}),a.addEventListener("keyup",l=>{this.designerCanvas.ignoreEvent(l)},{capture:!0}))});let o=document.createElementNS("http://www.w3.org/2000/svg","foreignObject");return o.classList.add("svg-toolbar-container"),o.setAttribute("width",""+t),o.setAttribute("height",""+i),o.appendChild(n),o.style.scale=""+1/this.designerCanvas.zoomFactor,o.style.transformBox="fill-box",this._addOverlay(o,r),o.updatePosition=a=>{o.style.scale=""+1/this.designerCanvas.zoomFactor;let l=this.overlayLayerView.getBoundingClientRect(),c=o.children[0].getBoundingClientRect(),h=this.designerCanvas.scaleFactor,d=l.width/h-this.designerCanvas.canvasOffset.x*h;c.width+a.x*h>d&&(a.x=(d-c.width)/h),a.x<-this.designerCanvas.canvasOffset.x&&(a.x=-this.designerCanvas.canvasOffset.x),o.setAttribute("x",""+a.x),o.setAttribute("y",""+a.y)},o.getById=a=>o.querySelector("#"+a),o}}});var nm,Fr,ma=p(()=>{"use strict";te();Wh();$e();J();nm=60,Fr=class extends N{_rect;_clickRect;_text;_width;_createTitleText;constructor(e,t,i,r){super(e,t,i),this._createTitleText=r}extend(e,t){let i=this.extendedItem.element.getBoxQuads({relativeTo:this.designerCanvas.canvas})[0];if(i&&!isNaN(i.p1.x)){let r=W(this.extendedItem.element),n=Gh(this.extendedItem.name,"10px monospace"),o=Math.sqrt(Math.pow(i.p2.x-i.p1.x,2)+Math.pow(i.p2.y-i.p1.y,2)),a=this.extendedItem.name;this.extendedItem.id&&(a="#"+this.extendedItem.id),this._createTitleText&&(a=this._createTitleText(this.extendedItem)),this._width=Math.max(Math.min(o,n),nm),this._rect=this._drawRect(i.p1.x,i.p1.y,this._width,15,"svg-primary-selection-move",this._rect),this._clickRect=this._drawRect(i.p1.x,i.p1.y,this._width,18,"svg-invisible",this._clickRect),this._clickRect.style.background="transparent",this._text=this._drawHTML('<div style="position:relative; pointer-events: none;"><span style="width: 100%; position: absolute; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; transform-origin: 0 0; padding-left: 2px;">'+a+"</span></div>",(r.x-this.designerCanvas.containerBoundingRect.x)/this.designerCanvas.scaleFactor,i.p1.y-16,this._width,15,"svg-text-primary",this._text),this._text.style.overflow="visible",this._clickRect.addEventListener("pointerdown",l=>this._pointerEvent(l)),this._clickRect.addEventListener("pointermove",l=>this._pointerEvent(l)),this._clickRect.addEventListener("pointerup",l=>this._pointerEvent(l)),this._clickRect.addEventListener("contextmenu",l=>{l.preventDefault(),this.designerCanvas.showDesignItemContextMenu(this.extendedItem,l)}),this.refresh(e,t)}}_drawMoveOverlay(e){}refresh(e,t){let i=this.extendedItem.element.getBoxQuads({relativeTo:this.designerCanvas.canvas})[0];if(!isNaN(i.p1.x)){let r=Math.atan2(i.p2.y-i.p1.y,i.p2.x-i.p1.x)*180/Math.PI;if(this._valuesHaveChanges(i.p1.x,i.p1.y,r,this.designerCanvas.scaleFactor)){let n=15/this.designerCanvas.scaleFactor,o=-(16/this.designerCanvas.scaleFactor),a=this._width/this.designerCanvas.scaleFactor;this._rect.setAttribute("x",""+i.p1.x),this._rect.setAttribute("y",""+i.p1.y),this._rect.style.rotate=r+"deg",this._rect.style.translate="0 "+o+"px",this._rect.style.transformOrigin="0 100%",this._rect.style.transformBox="fill-box",this._rect.setAttribute("height",""+n),this._rect.setAttribute("width",""+a),this._rect.style.strokeWidth=(1/this.designerCanvas.scaleFactor).toString(),this._clickRect.setAttribute("x",""+i.p1.x),this._clickRect.setAttribute("y",""+i.p1.y),this._clickRect.style.rotate=r+"deg",this._clickRect.style.translate="0 "+o+"px",this._clickRect.style.transformOrigin="0 100%",this._clickRect.style.transformBox="fill-box",this._clickRect.setAttribute("height",""+(n+3)),this._clickRect.setAttribute("width",""+a),this._clickRect.style.strokeWidth=(1/this.designerCanvas.scaleFactor).toString(),this._text.setAttribute("x",""+i.p1.x),this._text.setAttribute("y",""+i.p1.y),this._text.style.fontSize=10/this.designerCanvas.scaleFactor+"px",this._text.setAttribute("height",""+n),this._text.setAttribute("width",""+a),this._text.children[0].children[0].style.rotate=r+"deg",this._text.children[0].children[0].style.translate="0 "+o+"px",this._text.children[0].children[0].style.transformOrigin="0 100%"}}}_pointerEvent(e){e.preventDefault(),e.stopPropagation(),e.button!=2&&this.designerCanvas.serviceContainer.designerTools.get(U.Pointer).pointerEventHandler(this.designerCanvas,e,this.extendedItem.element)}dispose(){this._removeAllOverlays()}}});import{css as sm}from"@node-projects/base-custom-webcomponent";var zr,ua=p(()=>{"use strict";ma();zr=class{_createTitleText;constructor(e){this._createTitleText=e}shouldExtend(e,t,i){return!i.isRootItem&&!(i.element instanceof HTMLTemplateElement)}getExtension(e,t,i){return new Fr(e,t,i,this._createTitleText)}static style=sm`
    .svg-text-primary { stroke: none; color: white; font-family: monospace; }
  `}});var x,ee=p(()=>{"use strict";(function(s){s.PointerDown="pointerdown",s.PointerMove="pointermove",s.PointerUp="pointerup",s.DragEnter="dragenter",s.DragEnd="dragend",s.DragLeave="dragleave",s.DragOver="dragover",s.Drop="drop",s.Scroll="scroll",s.Wheel="wheel",s.ContextMenu="contextmenu",s.KeyDown="keydown",s.KeyUp="keyup",s.DblClick="dblclick"})(x||(x={}))});function fa(s,e,t){if(!s)return null;let i={px:n=>n,cm:n=>n*38,mm:n=>n*3.8,q:n=>n*.95,in:n=>n*96,pc:n=>n*16,pt:n=>n*1.333333,rem:n=>n*parseFloat(getComputedStyle(document.documentElement).fontSize),em:n=>n*parseFloat(getComputedStyle(e).fontSize),vw:n=>n/100*window.innerWidth,vh:n=>n/100*window.innerHeight,vmin:n=>n/100*(window.innerHeight<window.innerWidth?window.innerHeight:window.innerWidth),vmax:n=>n/100*(window.innerHeight>window.innerWidth?window.innerHeight:window.innerWidth),lh:n=>n*parseFloat(getComputedStyle(e).lineHeight),rlh:n=>n*parseFloat(getComputedStyle(document.documentElement).lineHeight),"%":n=>n/100*(t=="height"?Br(e).height:Br(e).width),ms:n=>n,s:n=>n*1e3,deg:n=>n,rad:n=>n*(180/Math.PI),grad:n=>n*(180/200),turn:n=>n*360},r=s.trim().match(jh);if(r){let n=Number(r[1]),o=r[2].toLowerCase();if(o in i)return i[o](n)}return s}function Et(s){let e=s.trim().match(jh);return e?e[2].toLowerCase():null}function jt(s,e,t,i,r){if(!s)return null;let n={px:o=>o,cm:o=>o/38,mm:o=>o/3.8,q:o=>o/.95,in:o=>o/96,pc:o=>o/16,pt:o=>o/1.333333,rem:o=>o/parseFloat(getComputedStyle(document.documentElement).fontSize),em:o=>o/parseFloat(getComputedStyle(e).fontSize),vw:o=>o*100/window.innerWidth,vh:o=>o*100/window.innerHeight,vmin:o=>o*100/(window.innerHeight<window.innerWidth?window.innerHeight:window.innerWidth),vmax:o=>o*100/(window.innerHeight>window.innerWidth?window.innerHeight:window.innerWidth),lh:o=>o/parseFloat(getComputedStyle(e).lineHeight),rlh:o=>o/parseFloat(getComputedStyle(document.documentElement).lineHeight),"%":o=>o*100/(t=="height"?Br(e).height:Br(e).width),ms:o=>o,s:o=>o/1e3,deg:o=>o,rad:o=>o/(180/Math.PI),grad:o=>o/(180/200),turn:o=>o/360};if(typeof s=="string"&&(s=fa(s,e,t)),i in n){let o=n[i](s);return r?r(o)+i:o+i}return r?r(s):s}function Br(s){return{width:s.offsetWidth,height:s.offsetHeight}}function am(s){let e=s.split(" "),t=[];for(let i=0;i<e.length;i++){let r=e[i];if(r.startsWith("repeat("))for(;!r.includes(")");)i++,e[i]&&(r+=e[i]);t.push(r)}return t}function Uh(s){let e=am(s),t=[];for(let i of e)if(i.startsWith("repeat(")){let r=i.split(",");for(let n=0;n<parseInt(r[0].substring(7));n++)t.push(r[1].substring(0,r[1].length-1))}else t.push(i);return t.map(i=>Et(i))}var om,jh,ga=p(()=>{"use strict";om=["px","cm","mm","q","in","pc","pt","rem","em","vw","vh","vmin","vmax","lh","rlh","%","ms","s","deg","rad","grad","turn","cqw","cqh","cqi","cqb","cqmin","cqmax","fr"],jh=new RegExp(`^([-+]?(?:\\d+(?:\\.\\d+)?))(${om.join("|")})$`,"i")});var Vr,ya=p(()=>{"use strict";ee();ga();te();be();J();Vr=class extends N{_startPos;_circle;_circle2;_oldValue;_offsetInControl;constructor(e,t,i){super(e,t,i)}refresh(e,t){let r=getComputedStyle(this.extendedItem.element).transformOrigin.split(" "),n=this.designerCanvas.canvas.convertPointFromNode({x:parseFloat(r[0]),y:parseFloat(r[1])},this.extendedItem.element);this._valuesHaveChanges(n.x,n.y,this.designerCanvas.zoomFactor)&&(this._removeAllOverlays(),this._circle=this._drawCircle(n.x,n.y,5/this.designerCanvas.zoomFactor,"svg-transform-origin"),this._circle.style.strokeWidth=(1/this.designerCanvas.zoomFactor).toString(),this._circle.style.cursor="pointer",this._circle2=this._drawCircle(n.x,n.y,1/this.designerCanvas.zoomFactor,"svg-transform-origin"),this._circle2.style.strokeWidth=(1/this.designerCanvas.zoomFactor).toString(),this._circle2.style.pointerEvents="none",this._circle.addEventListener(x.PointerDown,o=>this.pointerEvent(o)),this._circle.addEventListener(x.PointerMove,o=>this.pointerEvent(o)),this._circle.addEventListener(x.PointerUp,o=>this.pointerEvent(o)))}extend(e,t){let r=getComputedStyle(this.extendedItem.element).transformOrigin.split(" "),n=this.designerCanvas.canvas.convertPointFromNode({x:parseFloat(r[0]),y:parseFloat(r[1])},this.extendedItem.element);if(isNaN(n.x)||isNaN(n.y)){this.remove();return}else{let o=this.extendedItem.getStyleFromSheetOrLocal("transform-origin");o&&(this._oldValue=o),this.refresh(e,t)}}pointerEvent(e){e.stopPropagation();let t=getComputedStyle(this.extendedItem.element),i=t.transformOrigin.split(" "),r=[];r[0]=parseFloat(i[0])/parseFloat(this.extendedItem.element.style.width),r[1]=parseFloat(i[1])/parseFloat(this.extendedItem.element.style.height);let n=this.designerCanvas.canvas.convertPointFromNode({x:parseFloat(i[0]),y:parseFloat(i[1])},this.extendedItem.element),o=this.designerCanvas.getNormalizedEventCoordinates(e),a=this.extendedItem.element.convertPointFromNode(o,this.designerCanvas.canvas),l=this.designerCanvas.getNormalizedEventCoordinates(e);switch(e.type){case x.PointerDown:e.target.setPointerCapture(e.pointerId);let c=W(e.target);this._offsetInControl={x:c.width/2+(c.x-e.x),y:c.height/2+(c.y-e.y)},this._startPos={x:l.x,y:l.y};break;case x.PointerMove:if(this._startPos&&e.buttons>0){let h=l.x-this._startPos.x,d=l.y-this._startPos.y;this._circle.setAttribute("cx",n.x+h),this._circle.setAttribute("cy",n.y+d),this._circle2.setAttribute("cx",n.x+h),this._circle2.setAttribute("cy",n.y+d)}break;case x.PointerUp:if(e.target.releasePointerCapture(e.pointerId),this._startPos){a.x+=this._offsetInControl.x,a.y+=this._offsetInControl.y;let h=this.extendedItem.openGroup("change transform-origin"),d=this.extendedItem.element.getBoxQuads({relativeTo:this.designerCanvas.rootDesignItem.element})[0];if(this._oldValue)try{let u=this._oldValue.split(" "),f=jt(a.x,this.extendedItem.element,"width",Et(u[0]),_=>O(this.extendedItem,_)),b=jt(a.x,this.extendedItem.element,"width",Et(u[0]),_=>O(this.extendedItem,_));u.length>1&&(b=jt(a.y,this.extendedItem.element,"height",Et(u[1]),_=>O(this.extendedItem,_))),this.extendedItem.updateStyleInSheetOrLocal("transform-origin",f+" "+b)}catch{this.extendedItem.updateStyleInSheetOrLocal("transform-origin",O(this.extendedItem,a.x)+"px "+O(this.extendedItem,a.y)+"px")}else this.extendedItem.updateStyleInSheetOrLocal("transform-origin",O(this.extendedItem,a.x)+"px "+O(this.extendedItem,a.y)+"px");let m=this.extendedItem.element.getBoxQuads({relativeTo:this.designerCanvas.rootDesignItem.element})[0],g={x:d.p1.x-m.p1.x,y:d.p1.y-m.p1.y};t.translate&&t.translate!=="none"&&(g.x+=parseFloat(t.translate.split(" ")[0]),t.translate.split(" ").length===1?g.y+=parseFloat(t.translate.split(" ")[0]):g.y+=parseFloat(t.translate.split(" ")[1])),this.extendedItem.updateStyleInSheetOrLocal("translate",O(this.extendedItem,g.x)+"px "+O(this.extendedItem,g.y)+"px"),h.commit(),this.refresh(null,null),this._startPos=null}break}}dispose(){this._removeAllOverlays()}}});import{css as lm}from"@node-projects/base-custom-webcomponent";var Hr,va=p(()=>{"use strict";ya();te();Hr=class{showOnlyWhenSet;constructor(e=!0){this.showOnlyWhenSet=e}shouldExtend(e,t,i){if(!i.isRootItem&&i.node instanceof HTMLElement||i.node instanceof SVGElement&&i.node.localName==="svg"){if(!this.showOnlyWhenSet||i.hasStyle("transformOrigin"))return!0;let r=getComputedStyle(i.element);if(r.display!="inline"&&i.element.getBoundingClientRect){let n=W(i.element),o=r.transformOrigin.split(" "),a=parseFloat(o[0])-n.width/2,l=parseFloat(o[1])-n.height/2;if(a>.5||a<-.5||l>.5||l<-.5)return!0}}return!1}getExtension(e,t,i){return new Vr(e,t,i)}static style=lm`
    .svg-transform-origin { stroke: #3899ec; fill: black; pointer-events: all }
  `}});var Gr,xa=p(()=>{"use strict";J();X();Gr=class extends N{constructor(e,t,i){super(e,t,i)}_path;_path2;extend(e,t){this.refresh(e,t)}refresh(e,t){let i=getComputedStyle(this.extendedItem.element);if(i.margin!=="0px"){let r=Number.parseFloat(i.marginLeft.replace("px","")),n=Number.parseFloat(i.marginTop.replace("px","")),o=Number.parseFloat(i.marginRight.replace("px","")),a=Number.parseFloat(i.marginBottom.replace("px",""));if(!isNaN(r)&&!isNaN(n)&&!isNaN(o)&&!isNaN(a)){let l=this.extendedItem.element.getBoxQuads({box:"border",relativeTo:this.designerCanvas.canvas})[0];if(!isNaN(l.p1.x)&&this._valuesHaveChanges(r,n,o,a,l.p1.x,l.p1.y,l.p2.x,l.p2.y,l.p3.x,l.p3.y,l.p4.x,l.p4.y)){let c=this.extendedItem.element.getBoxQuads({box:"margin",relativeTo:this.designerCanvas.canvas})[0],h="M"+[l.p1,l.p2,l.p3,l.p4].map(d=>d.x+","+d.y).join(" ")+"Z ";h+="M"+[c.p1,c.p2,c.p3,c.p4].map(d=>d.x+","+d.y).join(" ")+"Z ",this._path=this._drawPath(h,"svg-margin-fill",this._path,k.Background),this._path2=this._drawPath(h,"svg-margin",this._path2,k.Background)}}}}dispose(){this._removeAllOverlays()}}});import{css as cm}from"@node-projects/base-custom-webcomponent";var Wr,_a=p(()=>{"use strict";xa();Z();Wr=class{shouldExtend(e,t,i){return i.nodeType==E.Element}getExtension(e,t,i){return new Gr(e,t,i)}style=cm`
  ...
  `;static svgDefs=`
    ...
    `;static template=Om`<div id="div"><img id="img"></div>`;tools;popup;currentToolOnButton;_img;_div;_longPress;constructor(e,t){super(),this.tools=t,this._img=this._getDomElement("img"),this._div=this._getDomElement("div"),this._div.onpointerdown=()=>{this.currentToolOnButton?(this.getRootNode().host.setTool(this.currentToolOnButton),setTimeout(()=>{e.clickOverlay.focus()},50),this.popup&&(this._longPress=setTimeout(()=>{this._longPress=null,this.getRootNode().host.showPopup(this)},200))):this.popup&&this.getRootNode().host.showPopup(this)},this._div.onpointerup=()=>{this._longPress&&(clearTimeout(this._longPress),this._longPress=null)},this.showTool(Object.getOwnPropertyNames(t)[0])}showTool(e){let t=this.tools[e];t&&(this._img.title=e,this._img.src=t.icon,this.currentToolOnButton=e)}setActiveTool(e){this.showTool(e),this.tools[e]?this._div.style.backgroundColor="lightgreen":this._div.style.backgroundColor=""}};customElements.define("node-projects-designer-toolbar-button",se)});import{BaseCustomWebComponentConstructorAppend as Nm,css as Lm}from"@node-projects/base-custom-webcomponent";var ut,Di=p(()=>{"use strict";ut=class extends Nm{static style=Lm`
      ...
      .tools {
          ...
          margin-bottom: 5px;
          gap: 3px;
      }`;constructor(){super();for(let e of[...this.shadowRoot.querySelectorAll("div.tool")]){let t=e;t.onclick=()=>this.getRootNode().host.setTool(t.dataset.commandParameter)}}}});import{html as Rm}from"@node-projects/base-custom-webcomponent";var Ti,Cl=p(()=>{"use strict";$();Di();Ti=class extends ut{static template=Rm`
        <div class="container">
        ...
        </div>`};customElements.define("node-projects-designer-pointer-tool-popup",Ti)});var Xn,El=p(()=>{"use strict";We();$();Cl();Xn=class{provideButton(e){let t=new se(e,{Pointer:{icon:v+"images/tools/PointerTool.svg"}});return t.popup=Ti,t}}});var je,Al=p(()=>{"use strict";je=class{constructor(e){this.distance=e}distance;provideButton(e){let t=document.createElement("div");return t.style.marginTop=this.distance+"px",t}}});var Zn,Pl=p(()=>{"use strict";We();$();Zn=class{provideButton(e){return new se(e,{Zoom:{icon:v+"images/tools/ZoomTool.svg"}})}}});import{html as Fm,css as zm}from"@node-projects/base-custom-webcomponent";var Mi,kl=p(()=>{"use strict";$();Di();Mi=class extends ut{static style=[super.style,zm`
      .container {
          width: 220px;
          min-height: 300px;
      }
...
span {
  ...
  `}});var ti,ic=p(()=>{"use strict";ti=class{extensions;extIndex;style;svgDefs;constructor(...e){this.extensions=e;for(let t of e)t.style&&(this.style||(this.style=[]),Array.isArray(t.style)?this.style.push(...t.style):this.style.push(t.style)),t.constructor.style&&(this.style||(this.style=[]),Array.isArray(t.constructor.style)?this.style.push(...t.constructor.style):this.style.push(t.constructor.style)),t.svgDefs&&(this.svgDefs||(this.svgDefs=[]),Array.isArray(t.svgDefs)?this.svgDefs.push(...t.svgDefs):this.svgDefs.push(t.svgDefs)),t.constructor.svgDefs&&(this.svgDefs||(this.svgDefs=[]),Array.isArray(t.constructor.svgDefs)?this.svgDefs.push(...t.svgDefs):this.svgDefs.push(t.constructor.svgDefs))}shouldExtend(e,t,i){for(this.extIndex=0;this.extIndex<this.extensions.length;this.extIndex++)if(this.extensions[this.extIndex].shouldExtend(e,t,i))return!0;return!1}getExtension(e,t,i){return this.extensions[this.extIndex].getExtension(e,t,i)}}});var xs,rc=p(()=>{"use strict";xs=class{_designItemsAssignmentList=new WeakMap;constructor(e){}setPosition(e,t){this._designItemsAssignmentList.set(e,t)}getPosition(e){return this._designItemsAssignmentList.get(e)}}});import{html as $m,BaseCustomWebComponentConstructorAppend as qm,css as Qm}from"@node-projects/base-custom-webcomponent";var Bi,nc=p(()=>{"use strict";be();te();Bi=class extends qm{_designerView;_previousSelectionRect;_selectionChanged;_relativeButton;_absoluteButton;_applyButton;_inputX;_inputY;_inputR;_inputSpacingX;_inputSpacingY;_originTopLeft;_originTopMid;_originTopRight;_originMidLeft;_originMidMid;_originMidRight;_originBotLeft;_originBotMid;_originBotRight;_transformMode;_transformOrigin;static style=Qm`
      .container {
          width: 220px;
          min-height: 200px;
          color: white;
  ...
  `;constructor(e,t,i){super(e,t,i),this._size.width=625}extend(e,t){super.extend(e,t),this._addFlexDirectionButton(),this._addStyleButton("flex-wrap"),this._addStyleButton("align-content"),this._addStyleButton("justify-content"),this._addStyleButton("align-items"),this.refresh(e,t)}_addFlexDirectionButton(){let e=getComputedStyle(this.extendedItem.element),t=this._toolbar.getById("flex-direction");t.addEventListener("value-changed",async()=>{await this.extendedItem.updateStyleInSheetOrLocalAsync("flex-direction",t.value),this.rotateImagesAcordingFlexDirection(t.value)}),t.value=e["flex-direction"],this.rotateImagesAcordingFlexDirection(t.value)}rotateImagesAcordingFlexDirection(e){let t=0;(e=="column"||e=="column-reverse")&&(t=-90),this._toolbar.getById("flex-wrap").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("align-content").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("justify-content").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("align-items").querySelectorAll("img:nth-child(-n+4)").forEach(i=>i.style.rotate=t+"deg")}}});var Ns,_c=p(()=>{"use strict";xc();Z();Le();Ns=class{shouldExtend(e,t,i){if(i.nodeType===E.Element){let r=getComputedStyle(i.element).display;if(r==="flex"||r==="inline-flex")return t.instanceServiceContainer.designContext.extensionOptions[Ue]!==!1}return!1}getExtension(e,t,i){return new Os(e,t,i)}}});import{html as su}from"@node-projects/base-custom-webcomponent";var Ls,bc=p(()=>{"use strict";Le();Ls=class extends Ce{static template=su`
      <div style="height: 100%; width: 100%;">
        ${Ce.basicTemplate}
      </div>
    `;constructor(e,t,i){super(e,t,i)}extend(e,t){super.extend(e,t),this.refresh(e,t)}}});var Rs,wc=p(()=>{"use strict";bc();Z();Le();Rs=class{shouldExtend(e,t,i){if(i.nodeType===E.Element){let r=getComputedStyle(i.element).display;if(r==="block"||r==="inline"||r==="inline-block")return t.instanceServiceContainer.designContext.extensionOptions[Ue]!==!1}return!1}getExtension(e,t,i){return new Ls(e,t,i)}}});var It,Sc=p(()=>{"use strict";Wn();It=class{_title;_contextMenus;constructor(e,...t){this._title=e,this._contextMenus=t}shouldProvideContextmenu(e,t,i,r){return this._contextMenus.some(n=>!(n instanceof we)&&n.shouldProvideContextmenu(e,t,i,r))}provideContextMenuItems(e,t,i,r){return[{title:this._title,children:this._contextMenus.map(n=>n.shouldProvideContextmenu(e,t,i,r)?n.provideContextMenuItems(e,t,i,r):[]).flat()}]}}});import{html as ou}from"@node-projects/base-custom-webcomponent";var Fs,Cc=p(()=>{"use strict";$();Le();Fs=class extends Ce{static template=ou`
    <div style="height: 100%; width: 100%;">
...
--warning-mid: #ED1C24;
}`},"@material/web":{import:"@material/web/all.js"},"@stencil/core":{map:{"@stencil/core/internal/client":"internal/client/index.js","@stencil/core/internal/app-data":"internal/app-data/index.js"}}}});var hd,dd=p(()=>{"use strict";Kc();Yc();so();Pe();cd();Wc();hd=class s{static registryPatchedTohandleErrors;_packageSource;_dependecies=new Map;constructor(e="//cdn.jsdelivr.net/npm/"){this._packageSource=e,s.patchCustomElementsRegistryToHandleErrors()}static patchCustomElementsRegistryToHandleErrors(){if(!s.registryPatchedTohandleErrors){s.registryPatchedTohandleErrors=!0;let e=window.customElements,t={};t.define=function(i,r,n){try{e.define(i,r,n)}catch(o){console.warn(o)}},t.get=function(i){return e.get(i)},t.upgrade=function(i){return e.upgrade(i)},t.whenDefined=function(i){return e.whenDefined(i)},Object.defineProperty(window,"customElements",{get(){return t}})}}async loadNpmPackage(e,t,i,r,n){let o=window.location.protocol+this._packageSource+e+"/",a=o+"package.json";n&&n(e+": loading package.json");let c=await(await fetch(a)).json();this.addToImportmap(o,c);let h=[];if(c.dependencies)for(let b in c.dependencies)h.push(this.loadDependency(b,c.dependencies[b]));await Promise.all(h);let d=o+"custom-elements.json",m=o;if(c.customElements&&(d=o+wt(c.customElements,"/"),d.includes("/"))){let b=d.lastIndexOf("/");m=d.substring(0,b+1)}let g=o+"web-component-designer.json";c.webComponentDesigner&&(g=o+de(c.webComponentDesigner,"/")),n&&n(e+": loading custom-elements.json");let u=await fetch(d);if(!u.ok&&c.homepage)try{let _="https://raw.githubusercontent.com/"+new URL(c.homepage).pathname+"/master/custom-elements.json";u=await fetch(_),console.warn("custom-elements.json was missing from npm package, but was loaded from github as a fallback.")}catch(b){console.warn("github custom elments json fallback",b)}if(t&&fetch(g).then(async b=>{if(b.ok){let _=await b.json();if(_.services)for(let C in _.services)for(let I of _.services[C]){I.startsWith("./")&&(I=I.substring(2));let P=(await importShim(o+I)).default;t.register(C,new P)}}}),u.ok){let b=await u.json(),_=new no(c.name,m,b);if(t&&t.register("elementsService",_),t){let C=new oi(c.name,b);t.register("propertyService",C)}if(r)for(let C of await _.getElements())importShim(C.import);t&&i&&i.loadControls(t,t.elementsServices),me[e]?.import&&import(me[e]?.import),me[e]?.script&&import(URL.createObjectURL(new Blob([me[e]?.script],{type:"application/javascript"})))}else{console.warn("npm package: "+e+" - no custom-elements.json found, only loading javascript module");let b=new to;c.module?await importShim(o+de(c.module,"/")):c.main?await importShim(o+de(c.main,"/")):c.unpkg?await importShim(o+de(c.unpkg,"/")):console.warn("npm package: "+e+" - no entry point in package found."),me[e]?.import&&await import(me[e]?.import),me[e]?.script&&await import(URL.createObjectURL(new Blob([me[e]?.script],{type:"application/javascript"})));let _=b.getNewElements();if(_.length>0&&t&&i){let C={elements:_},I=new ro(e,C);t.register("elementsService",I),i.loadControls(t,t.elementsServices)}b.dispose()}n&&n(e+": done");let f={};return me[e]?.html&&(f.html=(me[e]?.html).replaceAll("${baseUrl}",o)),me[e]?.style&&(f.style=(me[e]?.style).replaceAll("${baseUrl}",o)),f}async loadDependency(e,t,i){if(this._dependecies.has(e))return;if(this._dependecies.set(e,!0),e.startsWith("@types")){console.warn("ignoring wrong dependency: ",e);return}i&&i(e+": loading dependency: "+e);let r=window.location.protocol+this._packageSource+e+"/",n=r+"package.json",a=await(await fetch(n)).json(),l=[];if(a.dependencies)for(let c in a.dependencies)l.push(this.loadDependency(c,a.dependencies[c]));await Promise.all(l),this.addToImportmap(r,a)}async addToImportmap(e,t){let i=importShim.getImportMap().imports,r={imports:{},scopes:{}};if(!i.hasOwnProperty(t.name)){if(t.exports){let o=c=>c?.browser?c.browser:c?.import?c.import:c?.module?c.module:c?.default?c.default:c?.node,a=c=>{let h=o(c);return typeof h!="string"&&(h=o(h)),typeof h!="string"&&(h=o(h)),typeof h!="string"&&(h=null),h},l=a(t.exports);l?r.imports[t.name]=e+de(de(l,"."),"/"):(l=a(t.exports?.["."]))&&(r.imports[t.name]=e+de(de(l,"."),"/"))}let n=t.main;if(t.module&&(n=t.module),t.unpkg&&!n&&(n=t.unpkg),r.imports[t.name]||(n?r.imports[t.name]=e+de(de(n,"."),"/"):console.warn("package: "+e+"no main import found")),r.imports[t.name+"/"]=e,me[t.name]?.map)for(let o in me[t.name]?.map)r.imports[o]=e+me[t.name].map[o];importShim.addImportMap(r)}}}});var Gi,Xc=p(()=>{"use strict";(function(s){s.oneWay="oneWay",s.twoWay="twoWay"})(Gi||(Gi={}))});var pd,md=p(()=>{"use strict";(function(s){s.undefined="undefined",s.folder="folder",s.boolean="boolean",s.number="number",s.string="string",s.date="date",s.color="color",s.object="object"})(pd||(pd={}))});var ud=p(()=>{"use strict"});var fd,gd=p(()=>{"use strict";Xc();ke();ge();fd=class s{static type="base-custom-webcomponent-binding";getBindings(e){let t=null;for(let i of e.attributes()){let r=i[0],n=i[1];if((n.startsWith("[[")||n.startsWith("{{"))&&(n.endsWith("}}")||n.endsWith("]]"))){t||(t=[]);let o={rawName:r,rawValue:n,service:this};i[0]==="bcw:visible"?(o.targetName="visibility",o.target=M.css,o.expression=n.substring(2,n.length-2)):i[0].startsWith("css:")?(o.targetName=r.substring(4),o.target=M.css,o.expression=n.substring(2,n.length-2)):i[0].startsWith("class:")?(o.targetName=r.substring(4),o.target=M.class,o.expression=n.substring(2,n.length-2)):i[0].startsWith("$")?(o.targetName=r.substring(1),o.target=M.attribute,o.expression=n.substring(2,n.length-2)):i[0].startsWith("@")?(o.targetName=r.substring(1),o.target=M.event,o.expression=n.substring(2,n.length-2)):i[0].startsWith(".")?(o.targetName=R.dashToCamelCase(r.substring(1)),o.target=M.explicitProperty,o.expression=n.substring(2,n.length-2)):(o.targetName=R.dashToCamelCase(r),o.target=M.property,o.expression=n.substring(2,n.length-2)),o.type=s.type,o.targetName=o.targetName,o.bindableObjectNames=[n.substring(2,n.length-2)],t.push(o)}}return t}setBinding(e,t){if(t.type!==s.type)return!1;let i="";switch(t.target){case M.explicitProperty:i+=".";break;case M.css:i+="css:";break;case M.class:i+="class";break;case M.attribute:i+="$";break;case M.event:i+="@";break}i+=t.targetName;let r=(t.mode==Gi.oneWay?"[[":"{{")+t.expression+(t.mode==Gi.oneWay?"]]":"}}");return e.setAttribute(i,r),!0}clearBinding(e,t,i){return!0}}});var oo,Zc=p(()=>{"use strict";Te();Or();be();De();Oe();Ne();Gt();te();oo=class{serviceForContainer(e,t,i){return i!=null&&i.getComputedStyle()?.position=="absolute"?!0:!(t.display==="grid"||t.display==="inline-grid"||t.display==="flex"||t.display==="inline-flex")}isEnterableContainer(e){return!(K.IsSelfClosingElement(e.element.localName)||!e.isRootItem&&e.element.shadowRoot&&e.element.shadowRoot.querySelector("slot")==null)}canEnter(e,t){return!(!this.isEnterableContainer(e)||!t.every(i=>!i.element.contains(e.element)&&i!==e))}canLeave(e,t){return!0}getElementOffset(e,t){return e.instanceServiceContainer.designerCanvas.getNormalizedElementCoordinates(e.element)}calculateTrack(e,t,i,r,n,o){let a=n.x-i.x,l=n.y-i.y;if(!j(e)){if(t.alignOnGrid){let c=Nr(o,"position");c.x=c.x%t.gridSize,c.y=c.y%t.gridSize,a=Math.round(a/t.gridSize)*t.gridSize-c.x,l=Math.round(l/t.gridSize)*t.gridSize-c.y}else if(t.alignOnSnap){let c=W(o.element),h=t.snapLines.snapToPosition({x:n.x-r.x,y:n.y-r.y},{width:c.width/t.scaleFactor,height:c.height/t.scaleFactor},{x:a>0?1:-1,y:l>0?1:-1});h.x!==null?a=h.x-Math.round(i.x)+Math.round(r.x):a=Math.round(a),h.y!==null?l=h.y-Math.round(i.y)+Math.round(r.y):l=Math.round(l)}}return{x:a,y:l}}placePoint(e,t,i,r,n,o,a){let l=o.x,c=o.y;if(!j(e)){if(t.alignOnGrid)l=Math.round(l/t.gridSize)*t.gridSize,c=Math.round(c/t.gridSize)*t.gridSize;else if(t.alignOnSnap){let h=t.snapLines.snapToPosition({x:o.x-n.x,y:o.y-n.y},null,{x:l>0?1:-1,y:c>0?1:-1});h.x!==null?l=h.x:l=Math.round(l),h.y!==null?c=h.y:c=Math.round(c)}}return{x:l,y:c}}startPlace(e,t,i,r,n,o,a){}place(e,t,i,r,n,o,a){let l=this.calculateTrack(e,t,r,n,o,a[0]);e.shiftKey&&(l=Ze({x:0,y:0},l,!0));let c=ne(ca(a));for(let h of c){let d=h.instanceServiceContainer.designerCanvas.rootDesignItem.element,m=h.parent.element.convertPointFromNode(new DOMPoint(l.x,l.y,0,0),d),g=new DOMMatrix().translate(m.x,m.y);Mr(h.element,h.getStyle("transform"),g.toString())}t?.raiseDesignItemsChanged(c,"place",!1)}moveElements(e,t,i){for(let r of e)t.x&&r.setStyle("left",parseInt(r.element.style.left)-t.x+"px"),t.y&&r.setStyle("top",parseInt(r.element.style.top)-t.y+"px");e[0].instanceServiceContainer.designerCanvas.extensionManager.refreshExtensions(e),e[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(e,"place",!0)}enterContainer(e,t,i){let r=ne(t);for(let n of r)i=="drop"&&n.setStyle("position","absolute"),e.insertChild(n),n.lastContainerSize&&(n.hasStyle("width")||n.setStyle("width",n.lastContainerSize.width+"px"),n.hasStyle("height")||n.setStyle("height",n.lastContainerSize.height+"px"));t[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(r,"place",!0)}leaveContainer(e,t){let i=ne(t);t[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(i,"place",!0)}finishPlace(e,t,i,r,n,o,a){let l=ne(a);for(let c of l){let h=Ht(new DOMMatrix(c.element.style.transform)),d=Ht(new DOMMatrix(c.getStyle("transform")??""));c.element.style.transform=c.getStyle("transform")??"";let m={x:h.x,y:h.y};Lr(i,c,{x:m.x-d.x,y:m.y-d.y},"position")}for(let c of a)t.extensionManager.removeExtension(c,w.Placement);a[0].instanceServiceContainer.designerCanvas?.raiseDesignItemsChanged(l,"place",!0)}}});var yd,vd=p(()=>{"use strict";Zc();yd=class extends oo{serviceForContainer(e,t,i){return!0}}});var xd,_d=p(()=>{"use strict";Te();Dn();q();be();xd=class{async copyItems(e){let t=ne(e),i=K.ConvertToString(t,!1),r=t.map(o=>o.instanceServiceContainer.designerCanvas.getNormalizedElementCoordinates(o.element));Pi([["application/json",JSON.stringify({html:i,positions:r})]])}async getPasteItems(e,t){let i="",r="",n=null,o=await In();if(o!=null){try{i=await(await o[0].getType("text/html"))?.text()}catch{}if(!i)try{i=await(await o[0].getType("text/plain"))?.text()}catch{}try{i=await(await o[0].getType("application/json"))?.text()}catch{}try{let l=o[0].types.find(c=>c.startsWith("image/"));if(l){let c=await o[0].getType(l);return[[await T.createDesignItemFromImageBlob(e,t,c)]]}}catch{}}else i=await kn();if(i.startsWith("{")){let l=JSON.parse(i);r=l.html,n=l.positions}else r=i;return[await e.htmlParserService.parse(r,e,t,!0),n]}}});import{DomHelper as du}from"@node-projects/base-custom-webcomponent";var bd,wd=p(()=>{"use strict";bd=class{provideDemo(e,t,i,r,n){return new Promise(o=>{let a=document.createElement("iframe");a.style.width="100%",a.style.height="100%",a.style.border="none",a.style.display="none",du.removeAllChildnodes(e),e.appendChild(a),a.onload=()=>{a.style.display="block",o()};let l=a.contentWindow.document;if(l.open(),l.write('<script type="module">'),i.designContext.npmPackages?.length){l.write("import { NpmPackageLoader } from '../../helper/NpmPackageLoader.js'"),l.write("let loader =  new NpmPackageLoader();");for(let c of i.designContext.npmPackages)l.write("loader.loadNpmPackage('"+c+"', null, null, true);")}if(i.designContext.imports?.length)for(let c of i.designContext.imports)l.write("import '"+c+"';");l.write("document.body.style.display='';"),l.write("</script>"),l.write("<style>"+(n??"")+"</style>"),l.write('<body style="display:none; width: 100%; height: 100%; margin: 0; padding: 0; position: absolute;">'+r+"</body>"),l.close()})}}});var Sd,Cd=p(()=>{"use strict";q();qs();Sd=class extends ni{createDesignItem(e,t,i,r){let n=new T(e,t,i,r);return e instanceof(e.ownerDocument.defaultView??window).HTMLTemplateElement&&requestAnimationFrame(()=>{let o=1,a=e.getAttribute("sample-repeat-count");a&&(o=parseInt(a));for(let l=0;l<o;l++){let c=e;for(let h of e.content.childNodes)c=this.instancateNode(c,h)}}),n}instancateNode(e,t,i=!1){let r=t.cloneNode(!1);i?e.appendChild(r):e.parentNode.insertBefore(r,e.nextSibling),T.GetDesignItem(t).setView(r);for(let n of t.childNodes)this.instancateNode(r,n,!0);return r}}});import{LazyLoader as pu}from"@node-projects/base-custom-webcomponent";var Ed,Ad=p(()=>{"use strict";Ed=class{_name;get name(){return this._name}_elementList;_resolveStored;_rejectStored;getElements(){return this._elementList?Promise.resolve(this._elementList):(this._resolveStored||(this._resolveStored=[],this._rejectStored=[]),new Promise((e,t)=>{this._resolveStored.push(e),this._rejectStored.push(t)}))}constructor(e,t){this._name=e,pu.LoadText(t.toString()).then(i=>{let r=JSON.parse(i);this._elementList=[],r.elements.forEach(n=>{this.isIElementDefintion(n)?this._elementList.push(n):this._elementList.push({tag:n})}),this._resolveStored&&(this._resolveStored.forEach(n=>n(this._elementList)),this._resolveStored=null,this._rejectStored=null)}).catch(i=>{this._rejectStored&&(this._rejectStored.forEach(r=>r(i)),this._resolveStored=null,this._rejectStored=null)})}isIElementDefintion(e){return e!=null&&e.tag!=null}}});var Pd,kd=p(()=>{"use strict";Vi();Pd=class extends fe{isHandledElementFromEventsService(e){return this.__eventsList?.[e.name]!=null}getPossibleEvents(e){return[...this.__eventsList[e.name],...fe._simpleMouseEvents,...fe._pointerEvents,...fe._allElements,...fe._focusableEvents]}getEvent(e,t){return this.getPossibleEvents(e).find(r=>r.name==t)??{name:t,propertyName:"on"+t,eventObjectName:"Event"}}__eventsList;constructor(e,t){super(),this._parseManifest(t)}_parseManifest(e){this.__eventsList={};let t=[];for(let i of e.modules)i.declarations&&t.push(...i.declarations);for(let i of e.modules)for(let r of i.exports)if(r.kind=="custom-element-definition"){let n=t.find(o=>o.name==r.declaration.name);if(n){if(n.events){let o=[];for(let a of n.events)o.push({name:a.name});o.length&&(this.__eventsList[r.name]=o)}}else console.warn("declaration for "+r.declaration.name+" not found",e)}}}});var ai,Id,Dd=p(()=>{"use strict";Te();zn();Z();ge();te();(function(s){s[s.block=0]="block",s[s.complex=1]="complex"})(ai||(ai={}));Id=class{options;constructor(e){this.options=e??{},this.options.beautifyOutput??=!0,this.options.compressCssToShorthandProperties??=!0,this.options.writeDesignerProperties??=!0,this.options.parseJsonInAttributes??=!0,this.options.jsonWriteMode??="min"}writeAttributes(e,t){if(t.hasAttributes)for(let i of t.attributes())e.indentedTextWriter.write(" "),typeof i[1]=="string"?i[1]===""?e.indentedTextWriter.write(i[0]):e.indentedTextWriter.write(i[0]+'="'+K.normalizeAttributeValue(i[1])+'"'):i[1]||e.indentedTextWriter.write(i[0])}writeStyles(e,t){if(t.hasStyles){e.indentedTextWriter.write(' style="');let i=t.styles();e.options.compressCssToShorthandProperties&&(i=qt.combine(new Map(i)));for(let r of i)r[0]&&e.indentedTextWriter.write(R.camelToDashCase(r[0])+":"+K.normalizeAttributeValue(r[1])+";");e.indentedTextWriter.write('"')}}_writeTextNode(e,t){e.lastElementDisplayType=_e.inline;let i=K.normalizeContentValue(t.content).trim();i&&e.indentedTextWriter.write(i)}_writeCommentNode(e,t){e.indentedTextWriter.write("<!--"+t.content+"-->")}_writeElementNode(e,t){let i=Th(t.element);e.lastElementDisplayType=i,e.indentedTextWriter.write("<"+t.name),this.writeAttributes(e,t),this.writeStyles(e,t),e.indentedTextWriter.write(">");let r=!1;if(t.hasChildren){let n=t.children();if(r=t.childCount===1&&t.firstChild.nodeType===E.TextNode,r)this._writeInternal(e,t.firstChild);else{let o=e.containerDisplayType;e.containerDisplayType=this.getContainerType(t.element),e.indentedTextWriter.levelRaise(),this._writeDesignItemList(i,e,n),e.indentedTextWriter.levelShrink(),e.containerDisplayType=o}}else t.hasContent&&e.indentedTextWriter.write(K.normalizeContentValue(t.content));K.IsSelfClosingElement(t.name)||(i===_e.block&&t.hasChildren&&!r&&this._writeNewlineAndIntend(e),e.indentedTextWriter.write("</"+t.name+">"),i!==_e.none&&(e.lastElementDisplayType=i))}_writeDesignItemList(e,t,i){for(let r of i)t.lastElementDisplayType==null||(t.containerDisplayType===ai.complex?this._writeNewlineAndIntend(t):t.lastElementDisplayType!==_e.inline&&this._writeNewlineAndIntend(t)),this._writeInternal(t,r)}_writeNewlineAndIntend(e){e.indentedTextWriter.writeNewline(),e.indentedTextWriter.writeIndent()}_writeInternal(e,t){let i=e.indentedTextWriter.position;t.nodeType===E.TextNode?this._writeTextNode(e,t):t.nodeType===E.Comment?this._writeCommentNode(e,t):t.nodeType===E.Element&&this._writeElementNode(e,t),e.designItemsAssignmentList&&e.designItemsAssignmentList.set(t,{start:i,length:e.indentedTextWriter.position-i-1})}getContainerType(e){let t=window.getComputedStyle(e).display;return t==="block"||t==="inline-block"||t==""?ai.block:ai.complex}write(e,t,i){let r={indentedTextWriter:e,options:this.options,lastElementDisplayType:null,containerDisplayType:ai.block};this._writeDesignItemList(_e.inline,r,t)}}});var Td,Md=p(()=>{"use strict";Td=class{options;constructor(e){this.options=e??{},this.options.beautifyOutput??=!0,this.options.compressCssToShorthandProperties??=!0,this.options.writeDesignerProperties??=!0,this.options.parseJsonInAttributes??=!0,this.options.jsonWriteMode??="min"}write(e,t,i){throw new Error("Method not implemented.")}static head=`import { html, css, LitElement, CSSResultArray } from 'lit';
...
`,"<br>"),i.className="group-header",this._div.appendChild(i);let r=document.createElement("span");r.innerHTML=t.description??"",r.className="group-desc",this.propertyGroupHover&&(i.onmouseenter=()=>{this.propertyGroupHover(t,"name")?i.setAttribute("clickable",""):i.removeAttribute("clickable")},i.onclick=()=>{this.propertyGroupClick&&this.propertyGroupClick(t,"name")},r.onmouseenter=()=>{this.propertyGroupHover(t,"desc")?r.setAttribute("clickable",""):r.removeAttribute("clickable")},r.onclick=()=>{this.propertyGroupClick&&this.propertyGroupClick(t,"desc")}),this._div.appendChild(r),this.createPropertyEditors(t.properties)}}createPropertyEditors(e){for(let t of e){let i;if(t.createEditor?i=t.createEditor(t):i=this._serviceContainer.forSomeServicesTillResult("editorTypesService",r=>r.getEditorForProperty(t)),i){let r=document.createElement("div");r.style.width="20px",r.style.height="20px",r.style.display="flex",r.style.alignItems="center";let n=document.createElement("div");if(n.style.width="7px",n.style.height="7px",n.style.border="1px white solid",n.style.cursor="pointer",t.propertyType!=y.complex&&r.appendChild(n),this._div.appendChild(r),t.readonly!==!0&&(n.oncontextmenu=o=>{o.preventDefault(),this.openContextMenu(o,t)},n.onclick=o=>{o.preventDefault(),this.openContextMenu(o,t)}),t.type=="addNew"){let o=i.element;o.disabled=!0,o.id="addNew_input_"+ ++this._addCounter;let a=document.createElement("input");if(a.value=t.name,a.type="text",a.id="addNew_label_"+this._addCounter,a.onkeyup=l=>{l.key=="Enter"&&a.value&&(t.name=a.value,a.disabled=!0,o.disabled=!1,o.focus())},t.service.getPropertyNameSuggestions){let l=t.service.getPropertyNameSuggestions(null),c=document.createElement("datalist");c.id="addNew_"+this._addCounter+"_datalist";for(let h of l){let d=document.createElement("option");d.value=h,c.append(d)}this._div.appendChild(c),a.setAttribute("list",c.id)}this._div.appendChild(a)}else if(t.renamable){let o=document.createElement("input");o.id="label_"+t.name;let a=i.element;o.value=t.name,o.onkeyup=async l=>{if(l.key=="Enter"&&o.value){let c=this._designItems[0].openGroup("rename property name from '"+t.name+"' to '"+o.value+"'");t.service.clearValue(this._designItems,t,"all"),t.name=o.value,await t.service.setValue(this._designItems,t,a.value),c.commit(),this._designItems[0].instanceServiceContainer.designerCanvas.extensionManager.refreshAllExtensions(this._designItems)}},this._div.appendChild(o)}else{let o=document.createElement("label");o.htmlFor=t.name,o.textContent=t.name,o.title=t.description??t.name+" (type: "+t.type+(t.defaultValue?", default: "+t.defaultValue:"")+", propertytype: "+t.propertyType+")",o.ondragleave=a=>this._onDragLeave(a,t,o),o.ondragover=a=>this._onDragOver(a,t,o),o.ondrop=a=>this._onDrop(a,t,o),this._div.appendChild(o)}t.name&&(i.element.id=t.name),this._div.appendChild(i.element),this._propertyMap.set(t,{isSetElement:n,editor:i})}}}_onDragLeave(e,t,i){e.preventDefault(),i.classList.remove("dragOverProperty")}_onDragOver(e,t,i){if(e.preventDefault(),e.dataTransfer.types.indexOf(Ct)>=0){let o=this._serviceContainer.bindableObjectDragDropService;if(o){let a=o.dragOverOnProperty(e,t,this._designItems);(a??"none")!="none"?(i.classList.add("dragOverProperty"),e.dataTransfer.dropEffect=a):i.classList.remove("dragOverProperty")}}if(e.dataTransfer.types.indexOf(ia)>=0){let o=this._serviceContainer.propertyGridDragDropService;if(o){let a=o.dragOverOnProperty(e,t,this._designItems);(a??"none")!="none"?(i.classList.add("dragOverProperty"),e.dataTransfer.dropEffect=a):i.classList.remove("dragOverProperty")}}}_onDrop(e,t,i){e.preventDefault(),i.classList.remove("dragOverProperty");let r=e.dataTransfer.getData(Ct);if(r){let o=JSON.parse(r),a=this._serviceContainer.bindableObjectDragDropService;a&&a.dropOnProperty(e,t,o,this._designItems)}let n=e.dataTransfer.getData(ia);if(n){let o=JSON.parse(n),a=this._serviceContainer.propertyGridDragDropService;a&&a.dropOnProperty(e,t,o,this._designItems)}}openContextMenu(e,t){let i;this.propertyContextMenuProvider&&(i=this.propertyContextMenuProvider(this._designItems,t)),i||(i=t.service.getContextMenu(this._designItems,t)),he.show(i,e)}designItemsChanged(e){this._designItems=e;for(let t of this._propertyMap)t[1].editor.designItemsChanged(e)}refreshForDesignItems(e){for(let t of this._propertyMap)s.refreshIsSetElementAndEditorForDesignItems(t[1].isSetElement,t[0],e,this._propertiesService,t[1].editor)}static refreshIsSetElementAndEditorForDesignItems(e,t,i,r,n){if(i&&i.length){let o=r.isSet(i,t),a=r.getValue(i,t);e.title=t.name+": "+o,o==V.none?(e.style.background="",a=r.getUnsetValue(i,t)):o==V.all?e.style.background="white":o==V.some?e.style.background="gray":o==V.bound?e.style.background="orange":o==V.fromStylesheet&&(a=r.getUnsetValue(i,t),e.style.background="yellow"),n?.refreshValueWithoutNotification(o,a)}else e.style.background=""}};customElements.define("node-projects-property-grid-property-list",Ee)});import{BaseCustomWebComponentLazyAppend as vu,css as xu}from"@node-projects/base-custom-webcomponent";var rh,$d=p(()=>{"use strict";uo();Ot();re();rh=class extends vu{_serviceContainer;_designerTabControl;_selectedItems;_propertyGridPropertyLists;_propertyGridPropertyListsDict;_itemsObserver;_nodeReplacedCb;_instanceServiceContainer;_selectionChangedHandler;propertyGroupHover;propertyGroupClick;propertyContextMenuProvider;static style=xu`
  ...
  * {
  ...
  `;extensionManager;_pointerextensions;_lastCopiedPrimaryItem;_ignoreEvent;_useIframe=!0;_iframe;_window;_resizeObserver;iframes;constructor(e=!1){super(),this._restoreCachedInititalValues(),Da(),this._useIframe=e,this._canvas=this._getDomElement("node-projects-designer-canvas-canvas"),this._useIframe?(this._iframe=document.createElement("iframe"),this._iframe.setAttribute("sandbox","allow-same-origin"),this._iframe.setAttribute("scrolling","no"),this.iframes=[this._iframe],this._canvas.appendChild(this._iframe),requestAnimationFrame(()=>{this._window=this._iframe.contentWindow,Da(this._iframe.contentWindow),this._canvasShadowRoot=this._iframe.contentWindow.document})):(this._window=window,this._canvasShadowRoot=this._canvas.attachShadow({mode:"open"})),this._canvasContainer=this._getDomElement("node-projects-designer-canvas-canvasContainer"),this._outercanvas2=this._getDomElement("node-projects-designer-canvas-outercanvas2"),this.clickOverlay=this._getDomElement("node-projects-designer-canvas-clickOverlay"),this.onKeyDown=this.onKeyDown.bind(this),this.onKeyUp=this.onKeyUp.bind(this),this._onDblClick=this._onDblClick.bind(this),this._pointerEventHandler=this._pointerEventHandler.bind(this),this._onWheel=this._onWheel.bind(this),this._getDomElement("node-projects-designer-search-close").onclick=()=>this._searchHideOverlay(),this._getDomElement("node-projects-designer-search-start").onclick=()=>this._searchRun(),this._getDomElement("node-projects-designer-search-container").onkeydown=t=>{t.key==="Enter"&&this._searchRun()},this.clickOverlay.oncontextmenu=t=>t.preventDefault(),this._resizeObserver=new ResizeObserver(()=>{this.extensionManager.refreshAllAppliedExtentions()}),this._resizeObserver.observe(this)}get designerWidth(){return this._canvasContainer.style.width}set designerWidth(e){this._canvasContainer.style.width=e,this._zoomFactorChanged()}get designerHeight(){return this._canvasContainer.style.height}set designerHeight(e){this._canvasContainer.style.height=e,this._zoomFactorChanged()}getDesignSurfaceDimensions(){let e={width:null,height:null},t=getComputedStyle(this._canvasContainer);return this._canvasContainer.style.width&&(e.width=parseFloat(t.width)),this._canvasContainer.style.height&&(e.height=parseFloat(t.height)),e}get designerOffsetWidth(){return this._canvasContainer.offsetWidth}get designerOffsetHeight(){return this._canvasContainer.offsetHeight}set additionalStyles(e){this._additionalStyle=e,this.applyAllStyles()}get additionalStyles(){return this._additionalStyle}applyAllStyles(){if(this._window){let e=[];this._additionalStyle&&e.push(...this._additionalStyle),this.instanceServiceContainer.stylesheetService&&e.push(...this.instanceServiceContainer.stylesheetService.getStylesheets().map(t=>Jd(this._window,lo.patchStylesheetSelectorForDesigner(t.content)))),this._pauseAnimations&&e.push(Du),this._useIframe?this._iframe.contentWindow.document.adoptedStyleSheets=e:this._canvasShadowRoot.adoptedStyleSheets=e}else requestAnimationFrame(()=>this.applyAllStyles())}ignoreEvent(e){this._ignoreEvent=e}canExecuteCommand(e){let t=this.serviceContainer.modelCommandService;if(t){let i=t.canExecuteCommand(this,e);if(i!==null)return i}return e.type===S.undo?this.instanceServiceContainer.undoService.canUndo():e.type===S.redo?this.instanceServiceContainer.undoService.canRedo():e.type===S.setTool?this.serviceContainer.designerTools.has(e.parameter):e.type===S.paste?!0:e.type===S.copy||e.type===S.cut||e.type===S.delete?this.instanceServiceContainer.selectionService.primarySelection!=null&&!this.instanceServiceContainer.selectionService.primarySelection.isRootItem:!0}async executeCommand(e){let t=this.serviceContainer.modelCommandService;if(!(t&&await t.executeCommand(this,e)!=null))switch(e.type){case S.screenshot:if(si.screenshotsEnabled||alert("you need to select current tab in next browser dialog, or screenshots will not work correctly"),this.instanceServiceContainer.selectionService.primarySelection){this.disableBackgroud();try{let a=this.instanceServiceContainer.selectionService.primarySelection.element,l=this.instanceServiceContainer.selectionService.selectedElements;this.instanceServiceContainer.selectionService.setSelectedElements(null),await lt(100);let c=await si.takeScreenshot(a,a.clientWidth,a.clientHeight);await Ho(Go(c),"screenshot.png"),this.instanceServiceContainer.selectionService.setSelectedElements(l)}catch(a){console.error(a)}this.enableBackground()}else{this.zoomToFit(),this.disableBackgroud();try{let a=this.rootDesignItem.element,l=this.instanceServiceContainer.selectionService.selectedElements;this.instanceServiceContainer.selectionService.setSelectedElements(null),await lt(100);let c=await si.takeScreenshot(a,a.clientWidth,a.clientHeight);await Ho(Go(c),"screenshot.png"),this.instanceServiceContainer.selectionService.setSelectedElements(l)}catch(a){console.error(a)}this.enableBackground()}break;case S.setTool:this.serviceContainer.globalContext.tool=this.serviceContainer.designerTools.get(e.parameter),this.extensionManager.reapplyAllAppliedExtentions();break;case S.setStrokeColor:this.serviceContainer.globalContext.strokeColor=e.parameter;break;case S.setFillBrush:this.serviceContainer.globalContext.fillBrush=e.parameter;break;case S.setStrokeThickness:this.serviceContainer.globalContext.strokeThickness=e.parameter;break;case S.delete:this.handleDeleteCommand();break;case S.undo:this.instanceServiceContainer.undoService.undo();break;case S.holdUndo:let i=this.instanceServiceContainer.undoService.getUndoEntryNames(20),r=Array.from(i).map((a,l)=>({title:"undo: "+a,action:()=>{for(let c=0;c<=l;c++)this.instanceServiceContainer.undoService.undo()}}));r.length>0&&he.show(r,e.event,{mode:"undo"});break;case S.redo:this.instanceServiceContainer.undoService.redo();break;case S.holdRedo:let n=this.instanceServiceContainer.undoService.getRedoEntryNames(20),o=Array.from(n).map((a,l)=>({title:"redo: "+a,action:()=>{for(let c=0;c<=l;c++)this.instanceServiceContainer.undoService.redo()}}));o.length>0&&he.show(o,e.event,{mode:"undo"});break;case S.copy:this.handleCopyCommand();break;case S.cut:this.handleCopyCommand(),this.handleDeleteCommand();break;case S.paste:this.handlePasteCommand(e.altKey==!0);break;case S.selectAll:this.handleSelectAll();break}}disableBackgroud(){this._canvasContainer.style.background="var(--node-projects-web-component-designer-screenshot-background, white)"}enableBackground(){this._canvasContainer.style.background=""}zoomToFit(){let t=0,i=0,r=0,n=0;this.canvasOffset={x:0,y:0},this.zoomFactor=1;for(let d of this.rootDesignItem.querySelectorAll("*"))if(d instanceof(d.ownerDocument.defaultView??window).Element){let m=W(d);r=r<m.x?r:m.x,n=n<m.y?n:m.y,t=t>m.x+m.width+10?t:m.x+m.width+10,i=i>m.y+m.height+10?i:m.y+m.height+10}let o=this.getBoundingClientRect();t-=o.x,i-=o.y;let a=o.width/(t/this.zoomFactor),l=o.height/(i/this.zoomFactor),c=this.getDesignSurfaceDimensions();c.width&&(a=o.width/c.width),c.height&&(l=o.height/c.height);let h=a<l?a:l;isNaN(h)||(this.zoomFactor=h)}handleSelectAll(){let e=Array.from(this.rootDesignItem.children(!0)).filter(i=>!i.isEmptyTextNode),t=this.instanceServiceContainer.selectionService.primarySelection;if(t){let i=e.indexOf(t);i>=0&&(e.splice(i,1),e.unshift(t))}this.instanceServiceContainer.selectionService.setSelectedElements(e)}async handleCopyCommand(){this._currentPasteOffset=this.pasteOffset,this._lastCopiedPrimaryItem=this.instanceServiceContainer.selectionService.primarySelection,await this.serviceContainer.copyPasteService.copyItems(this.instanceServiceContainer.selectionService.selectedElements)}async handlePasteCommand(e){let[t,i]=await this.serviceContainer.copyPasteService.getPasteItems(this.serviceContainer,this.instanceServiceContainer),r=this.rootDesignItem.openGroup("Insert"),n=this._lastCopiedPrimaryItem,o=this._currentPasteOffset+this.pasteOffset,a=this.rootDesignItem,l=n?.parent??this.instanceServiceContainer.selectionService.primarySelection;for(;l!=null;){let c=getComputedStyle(l.element),h;if(h=this.serviceContainer.getLastServiceWhere("containerService",d=>d.serviceForContainer(l,c)),h)if(h.canEnter(l,t)){a=l;break}else{l=l.parent;continue}}if(t){let c=this.getNormalizedElementCoordinates(a.element);for(let d=0;d<t.length;d++){let m=t[d],g=i?i[d]:null;this.instanceServiceContainer.undoService.execute(new oe(a,a.childCount,m)),!e&&g&&m.nodeType==E.Element&&(m.setStyle("left",g.x-c.x+this._currentPasteOffset+"px"),m.setStyle("top",g.y-c.y+this._currentPasteOffset+"px"))}let h=this.serviceContainer.intializationService;if(h)for(let d of t)h.init(d);this.instanceServiceContainer.selectionService.setSelectedElements(t)}r.commit(),this.snapLines.clearSnaplines(),this._lastCopiedPrimaryItem=n,this._currentPasteOffset=o}handleDeleteCommand(){let e=this.instanceServiceContainer.selectionService.selectedElements;this.serviceContainer.deletionService.removeItems(e),this.instanceServiceContainer.selectionService.setSelectedElements(null)}initialize(e){this.serviceContainer=e,this.instanceServiceContainer=new mo(this);let t=this.serviceContainer.getLastService("undoService");t&&this.instanceServiceContainer.register("undoService",t(this));let i=this.serviceContainer.getLastService("selectionService");i&&(this.instanceServiceContainer.register("selectionService",i(this)),this.instanceServiceContainer.selectionService.onSelectionChanged.on(()=>{this._lastCopiedPrimaryItem=null,this._currentPasteOffset=this.pasteOffset}));let r=this.serviceContainer.getLastService("designItemDocumentPositionService");r&&this.instanceServiceContainer.register("designItemDocumentPositionService",r(this)),this._useIframe?(this.rootDesignItem=T.GetOrCreateDesignItem(this._iframe,this._iframe,this.serviceContainer,this.instanceServiceContainer),requestAnimationFrame(()=>{this.rootDesignItem.updateChildrenFromNodesChildren()})):this.rootDesignItem=T.GetOrCreateDesignItem(this._canvas,this._canvas,this.serviceContainer,this.instanceServiceContainer);let n=this.serviceContainer.getLastService("contentService");n&&this.instanceServiceContainer.register("contentService",n(this));let o=this.serviceContainer.getLastService("stylesheetService");if(o){let a=o(this);this.instanceServiceContainer.register("stylesheetService",a),this.instanceServiceContainer.stylesheetService.stylesheetChanged.on(l=>{if(l.changeSource!="undo"){let c=new co(this.instanceServiceContainer.stylesheetService,l.name,l.newStyle,l.oldStyle);this.instanceServiceContainer.undoService.execute(c),this.applyAllStyles()}else this.applyAllStyles()}),this.instanceServiceContainer.stylesheetService.stylesheetsChanged.on(()=>{this.applyAllStyles()})}if(e.instanceServiceContainerCreatedCallbacks?.length&&e.instanceServiceContainerCreatedCallbacks.forEach(a=>a(this.instanceServiceContainer)),this.extensionManager=new go(this),this.overlayLayer=new li(e),this.overlayLayer.style.pointerEvents="none",this.overlayLayer.style.setProperty("margin","0","important"),this.overlayLayer.style.setProperty("padding","0","important"),this.overlayLayer.style.setProperty("border","none","important"),this.clickOverlay.appendChild(this.overlayLayer),this.snapLines=new fo(this.overlayLayer),this.snapLines.initialize(this.rootDesignItem),this.serviceContainer.designerPointerExtensions)for(let a of this.serviceContainer.designerPointerExtensions)this._pointerextensions||(this._pointerextensions=[]),this._pointerextensions.push(a.getExtension(this));if(this.children){let a=this.children;if(this.children.length==1&&this.children[0]instanceof HTMLSlotElement&&(a=this.children[0].assignedElements()),a?.length>0){let l=this.serviceContainer.getLastServiceWhere("htmlParserService",c=>c.constructor==ht);this.addDesignItems(l.createDesignItems(a,this.serviceContainer,this.instanceServiceContainer))}}this.serviceContainer.options.zoomDesignerBackground||requestAnimationFrame(()=>{this._resizeBackgroundGrid()}),this.isConnected&&this.extensionManager.connected()}connectedCallback(){this._firstConnect||(this._firstConnect=!0,this._touchGestureHelper=io.addTouchEvents(this.clickOverlay),this.clickOverlay.addEventListener(x.PointerDown,this._pointerEventHandler),this.clickOverlay.addEventListener(x.PointerMove,this._pointerEventHandler),this.clickOverlay.addEventListener(x.PointerUp,this._pointerEventHandler),this.clickOverlay.addEventListener(x.DragEnter,e=>this._onDragEnter(e)),this.clickOverlay.addEventListener(x.DragLeave,e=>this._onDragLeave(e)),this.clickOverlay.addEventListener(x.DragOver,e=>this._onDragOver(e)),this.clickOverlay.addEventListener(x.Drop,e=>this._onDrop(e)),this.clickOverlay.addEventListener(x.KeyDown,this.onKeyDown),this.clickOverlay.addEventListener(x.KeyUp,this.onKeyUp),this.clickOverlay.addEventListener(x.DblClick,this._onDblClick,!0),this.clickOverlay.addEventListener(x.Wheel,this._onWheel),this.clickOverlay.addEventListener("zoom",e=>{this.zoomFactor=this.zoomFactor+e.detail.diff/10}),this.clickOverlay.addEventListener("pan",e=>{let t={x:this.canvasOffset.x-e.detail.deltaX,y:this.canvasOffset.y-e.detail.deltaY};this.canvasOffset=t})),this.extensionManager&&this.extensionManager.connected()}disconnectedCallback(){this.extensionManager.disconnected()}_zoomFactorChanged(){this._canvasContainer.style.bottom=this._outercanvas2.offsetHeight>=this._canvasContainer.offsetHeight?"0":"",this._canvasContainer.style.right=this._outercanvas2.offsetWidth>=this._canvasContainer.offsetWidth?"0":"",this._updateTransform(),this.fillCalculationrects(),this.onZoomFactorChanged.emit(this._zoomFactor),this.serviceContainer.options.zoomDesignerBackground||this._resizeBackgroundGrid()}_resizeBackgroundGrid(){let r=2e3/this.canvas.getBoundingClientRect().width;this.canvas.style.backgroundSize=r.toString()+"%"}_updateTransform(){if(this._scaleFactor=this._zoomFactor,this._useIframe){let e=this._canvasOffset.x,t=this._canvasOffset.y;this._iframe.contentWindow.scrollTo(e*-1,t*-1),e+=this._iframe.contentWindow.scrollX,t+=this._iframe.contentWindow.scrollY,this._canvasContainer.style.transform="scale("+this._zoomFactor+") translate("+e+"px, "+t+"px)"}else this._canvasContainer.style.transform="scale("+this._zoomFactor+") translate("+(isNaN(this._canvasOffset.x)?"0":this._canvasOffset.x)+"px, "+(isNaN(this._canvasOffset.y)?"0":this._canvasOffset.y)+"px)";this._canvasContainer.style.transformOrigin="0 0",this.overlayLayer.style.transform=this._canvasContainer.style.transform,this.overlayLayer.style.transformOrigin="0 0",this.snapLines.clearSnaplines()}setDesignItems(e){this.instanceServiceContainer.undoService.clearTransactionstackIfNotEmpty();let t=new ho(e,[...this.rootDesignItem.children()]);this.instanceServiceContainer.undoService.execute(t)}_internalSetDesignItems(e){this.fillCalculationrects(),this.overlayLayer.removeAllOverlays(),ah.removeAllChildnodes(this.overlayLayer);for(let t of[...this.rootDesignItem.children()])this.rootDesignItem._removeChildInternal(t);this.addDesignItems(e),this.lazyTriggerReparseDocumentStylesheets(),this.instanceServiceContainer.contentService.onContentChanged.emit({changeType:"parsed"}),this.instanceServiceContainer.selectionService._withoutUndoSetSelectedElements(null),setTimeout(()=>this.extensionManager.refreshAllAppliedExtentions(),50)}reparseTimeout;lazyTriggerReparseDocumentStylesheets(){this.reparseTimeout&&clearTimeout(this.reparseTimeout),this.reparseTimeout=setTimeout(async()=>{await this.reparseDocumentStylesheets(),clearTimeout(this.reparseTimeout)},20)}async reparseDocumentStylesheets(){if(this.instanceServiceContainer.stylesheetService){let e=this.rootDesignItem.querySelectorAll("style"),t=1,i=[...e].map(r=>({name:"&lt;style&gt; #"+(r.id?r.id+"("+t+++")":t++),content:T.GetDesignItem(r).content,designItem:T.GetDesignItem(r)}));await this.instanceServiceContainer.stylesheetService.setDocumentStylesheets(i)}}addDesignItems(e){if(e)for(let i of e)this.rootDesignItem._insertChildInternal(i);let t=this.serviceContainer.intializationService;if(t)for(let i of e)t.init(i);this.snapLines.clearSnaplines()}_onDragEnter(e){if(this.fillCalculationrects(),e.preventDefault(),e.dataTransfer.types.indexOf(Ct)>=0){let i=this.serviceContainer.bindableObjectDragDropService;if(i){let r=this.getElementAtPoint({x:e.x,y:e.y});this._lastDdElement!=r&&(i.dragLeave(this,e,this._lastDdElement),i.dragEnter(this,e,r),this._lastDdElement=r)}else this._lastDdElement=null}else{this._lastDdElement=null;let i=this.serviceContainer.dragDropService;i&&i.dragEnter(this,e)}}_onDragLeave(e){this.fillCalculationrects(),e.preventDefault(),this._canvas.classList.remove("dragFileActive");let t=this.serviceContainer.dragDropService;t&&t.dragLeave(this,e)}_lastDdElement=null;_onDragOver(e){if(e.preventDefault(),this.fillCalculationrects(),e.dataTransfer.types.length>0&&e.dataTransfer.types[0]=="Files"){let t=this.serviceContainer.externalDragDropService;if(t){let i=t.dragOver(e);e.dataTransfer.dropEffect=i,i!=="none"&&this._canvas.classList.add("dragFileActive")}}else if(e.dataTransfer.types.indexOf(Ct)>=0){let i=this.serviceContainer.bindableObjectDragDropService;if(i){let r=this.getElementAtPoint({x:e.x,y:e.y});this._lastDdElement!=r&&(i.dragLeave(this,e,this._lastDdElement),i.dragEnter(this,e,r),this._lastDdElement=r);let n=i.dragOver(this,e,r);e.dataTransfer.dropEffect=n}}else{let i=this.serviceContainer.dragDropService;i&&i.dragOver(this,e)}}async _onDrop(e){if(this.serviceContainer.globalContext.tool=this.serviceContainer.designerTools.get(U.Pointer),this._lastDdElement=null,e.preventDefault(),this._canvas.classList.remove("dragFileActive"),this.fillCalculationrects(),e.dataTransfer.files?.length>0){let t=this.serviceContainer.externalDragDropService;t&&t.drop(this,e)}else{let t=e.dataTransfer.getData(Ct);if(t){let i=JSON.parse(t),r=this.serviceContainer.bindableObjectDragDropService;if(r){let n=this.getElementAtPoint({x:e.x,y:e.y});r.drop(this,e,i,n)}}else{let i=this.serviceContainer.dragDropService;i&&(this.fillCalculationrects(),i.drop(this,e))}}}showDesignItemContextMenu(e,t){let i=[];for(let n of this.serviceContainer.designerContextMenuExtensions)n.shouldProvideContextmenu(t,this,e,"designer")&&i.push(...n.provideContextMenuItems(t,this,e,"designer"));let r=new he(i,null);return r.display(t),r}_onDblClick(e){e.preventDefault(),e.target!==this.overlayLayer&&(e.altKey||(this.serviceContainer.globalContext.tool==null||this.serviceContainer.globalContext.tool===this.serviceContainer.designerTools.get(U.Pointer))&&(this.extensionManager.removeExtension(this.instanceServiceContainer.selectionService.primarySelection,w.PrimarySelectionRefreshed),this.extensionManager.applyExtension(this.instanceServiceContainer.selectionService.primarySelection,w.Doubleclick,e)))}_searchShowOverlay(){let e=this._getDomElement("node-projects-designer-search-container");e.style.display="",this._getDomElement("node-projects-designer-search-input").focus()}_searchHideOverlay(){let e=this._getDomElement("node-projects-designer-search-container");e.style.display="none"}_searchRun(){let e=this._getDomElement("node-projects-designer-search-input");if(this._getDomElement("node-projects-designer-search-result").innerHTML="0 selected",e.value!=""){let t=this._canvasShadowRoot.querySelectorAll(e.value),i=[];for(let r=0;r<=t.length;r++)this._canvasShadowRoot.contains(t[r])&&i.push(T.GetDesignItem(t[r]));i.length>0&&(this.instanceServiceContainer.selectionService.setSelectedElements(i),this._getDomElement("node-projects-designer-search-result").innerHTML=i.length.toString()+" selected")}}onKeyUp(e){this._ignoreEvent!==e&&(this.activeTool?.keyboardEventHandler&&(this.activeTool.keyboardEventHandler(this,e,this.instanceServiceContainer.selectionService.primarySelection.element),e.defaultPrevented)||(this._moveGroup&&(this._moveGroup.commit(),this._moveGroup=null),e.preventDefault()))}onKeyDown(e){if(this._ignoreEvent!==e&&!(this.activeTool?.keyboardEventHandler&&(this.activeTool.keyboardEventHandler(this,e,this.instanceServiceContainer.selectionService.primarySelection.element),e.defaultPrevented))){if(j(e)&&e.key==="z"&&!e.shiftKey)this.executeCommand({type:S.undo,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="z"&&e.shiftKey)this.executeCommand({type:S.redo,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="y")this.executeCommand({type:S.redo,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="a")this.executeCommand({type:S.selectAll,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="c")this.executeCommand({type:S.copy,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="v")this.executeCommand({type:S.paste,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="x")this.executeCommand({type:S.cut,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});else if(j(e)&&e.key==="f")this._searchShowOverlay();else{if(!this.instanceServiceContainer.selectionService.primarySelection)return;let i=1;switch(e.shiftKey&&(i=10),e.key){case"Delete":case"Backspace":this.executeCommand({type:S.delete,metaKey:e.metaKey,ctrlKey:e.ctrlKey,altKey:e.altKey,shiftKey:e.shiftKey});break;case"ArrowDown":case"ArrowUp":case"ArrowLeft":case"ArrowRight":{this._moveGroup||(this._moveGroup=this.rootDesignItem.openGroup("move items"));let r={x:0,y:0};e.key=="ArrowDown"&&(r.y=-i),e.key=="ArrowUp"&&(r.y=i),e.key=="ArrowRight"&&(r.x=-i),e.key=="ArrowLeft"&&(r.x=i);for(let n of ne(this.instanceServiceContainer.selectionService.selectedElements)){let o=getComputedStyle(n.parent.element);n.serviceContainer.getLastServiceWhere("containerService",a=>a.serviceForContainer(n.parent,o)).moveElements([n],r,!1)}}break}}e.preventDefault()}}getNormalizedEventCoordinates(e){let t=(e.clientX-this.outerRect.x)/this.zoomFactor,i=this.containerBoundingRect.x-this.outerRect.x,r=(e.clientY-this.outerRect.y)/this.zoomFactor,n=this.containerBoundingRect.y-this.outerRect.y;return{x:t-i/this.zoomFactor,y:r-n/this.zoomFactor}}getViewportCoordinates(e){return{x:e.clientX-this.outerRect.x,y:e.clientY-this.outerRect.y}}getNormalizedTextNodeCoordinates(e,t){let i=document.createRange();i.selectNodeContents(e);let r=i.getBoundingClientRect(),n=this.containerOffset;return{x:n.x+(r.x-this.containerBoundingRect.x)/(t?1:this.scaleFactor),y:n.y+(r.y-this.containerBoundingRect.y)/(t?1:this.scaleFactor),width:r.width/(t?1:this.scaleFactor),height:r.height/(t?1:this.scaleFactor)}}getNormalizedElementCoordinates(e,t){if(e.nodeType==E.TextNode)return this.getNormalizedTextNodeCoordinates(e,t);let i=W(e),r=this.containerOffset;return{x:r.x+(i.x-this.containerBoundingRect.x)/(t?1:this.scaleFactor),y:r.y+(i.y-this.containerBoundingRect.y)/(t?1:this.scaleFactor),width:i.width/(t?1:this.scaleFactor),height:i.height/(t?1:this.scaleFactor)}}getNormalizedElementCoordinatesAndRealSizes(e){let t=this.getNormalizedElementCoordinates(e),i=getComputedStyle(e),r=t.width,n=t.height;return i.boxSizing!="border-box"&&(r=r-(parseFloat(i.borderLeft)+parseFloat(i.paddingLeft)+parseFloat(i.paddingRight)+parseFloat(i.borderRight)),n=n-(parseFloat(i.borderTop)+parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)+parseFloat(i.borderBottom))),{...t,realWidth:r,realHeight:n}}getNormalizedOffsetInElement(e,t){let i=this.getNormalizedEventCoordinates(e),r=this.getNormalizedElementCoordinates(t);return{x:i.x-r.x,y:i.y-r.y}}transformPoint(e){if(this._useIframe){let t=this._canvasContainer.getBoundingClientRect();return{x:e.x-t.x,y:e.y-t.y}}return e}elementsFromPoint(e,t){let i=[],r=this.transformPoint({x:e,y:t}),n=this._canvasShadowRoot.elementsFromPoint(r.x,r.y);for(let o of n)o.getRootNode()===this._canvasShadowRoot&&i.push(o);return i}getElementAtPoint(e,t){let i=this.transformPoint(e),r=this._canvasShadowRoot.elementsFromPoint(i.x,i.y),n=null;for(let o=0;o<r.length;o++){if(n=r[o],t&&t(n)){n=null;continue}if(n.getRootNode()!==this._canvasShadowRoot){n=null;continue}if(!this.instanceServiceContainer.designContext.extensionOptions.selectUnhitableElements&&T.GetDesignItem(n).getStyleFromSheetOrLocal("pointer-events")=="none"){n=null;continue}break}return n}getDesignItemById(e){return T.GetDesignItem(this._canvasShadowRoot.getElementById(e))}querySelectorDesignItem(e){return T.GetDesignItem(this._canvasShadowRoot.querySelector(e))}querySelectorAllDesignItems(e){return[...this._canvasShadowRoot.querySelectorAll(e)].map(t=>T.GetDesignItem(t))}_hoverElement;showHoverExtension(e,t){let i=T.GetOrCreateDesignItem(e,e,this.serviceContainer,this.instanceServiceContainer);if(this._lastHoverDesignItem!=i&&(this._lastHoverDesignItem&&this.extensionManager.removeExtension(this._lastHoverDesignItem,w.MouseOver),i&&i!=this.rootDesignItem&&(!e.parentNode||ah.getHost(e.parentNode)!==this.overlayLayer)&&this.extensionManager.applyExtension(i,w.MouseOver,t),this._lastHoverDesignItem=i),this.instanceServiceContainer.designContext.extensionOptions.simulateHoverOnHover&&this._hoverElement!==e){let r=this._hoverElement;for(;r&&r!==this._canvas;)r.removeAttribute(ct),r=r.parentElement;if(this._hoverElement=null,e){for(e.nodeType==E.TextNode&&(e=e.parentElement),r=e;r&&r!==this._canvas;)r.setAttribute(ct,""),r=r.parentElement;this._hoverElement=e}}}_onWheel(e){let t=this.getElementAtPoint({x:e.clientX,y:e.clientY});for(;t;){let i=getComputedStyle(t);if(i.overflowY==="scroll"||i.overflowY==="auto"){let r=t;r.scrollBy?r.scrollBy(e.deltaX,e.deltaY):(r.scrollLeft+=e.deltaX,r.scrollTop+=e.deltaY),e.stopPropagation();break}t=t.parentElement}}_pointerEventHandler(e,t=null){if(this._ignoreEvent===e||!this.serviceContainer||this._touchGestureHelper.multitouchEventActive)return;if(this.fillCalculationrects(),this._pointerextensions)for(let o of this._pointerextensions)o.refresh(e);let i;if(t)i=t;else if(i=this.serviceContainer.elementAtPointService.getElementAtPoint(this,{x:e.x,y:e.y}),!i)i=this._canvas;else if(this._enableSelectTextNodesOnClick){let o=this.getNormalizedEventCoordinates(e);for(let a of i.childNodes)if(a.nodeType==E.TextNode){let l=this.getNormalizedElementCoordinates(a);if(l.x<=o.x&&l.x+l.width>=o.x&&l.y<=o.y&&l.y+l.height>=o.y){i=a;break}}}if(this._activeTool){this._activeTool.pointerEventHandler(this,e,i);return}this.clickOverlay.style.cursor=this._canvas.style.cursor;let r=T.GetOrCreateDesignItem(i,i,this.serviceContainer,this.instanceServiceContainer);this.showHoverExtension(r.element,e),i&&ah.getHost(i.parentNode)===this.overlayLayer&&(i=this.instanceServiceContainer.selectionService.primarySelection?.element??this._canvas);let n=this.serviceContainer.globalContext.tool??this.serviceContainer.designerTools.get(U.Pointer);n.pointerEventHandler(this,e,i),this._canvas.style.cursor=n.cursor}captureActiveTool(e){this._activeTool=e}releaseActiveTool(){this._activeTool=null}get activeTool(){return this.serviceContainer.globalContext.tool}fillCalculationrects(){this.containerBoundingRect=this._canvasContainer.getBoundingClientRect(),this.outerRect=this._outercanvas2.getBoundingClientRect()}removeOverlay(e){this.overlayLayer.removeOverlay(e)}zoomOntoRectangle(e,t){let i={x:e.x<t.x?e.x:t.x,y:e.y<t.y?e.y:t.y,width:Math.abs(e.x-t.x),height:Math.abs(e.y-t.y)},r=this.outerRect.width/i.width,n=this.outerRect.height/i.height,o=r>=n?n:r,a={x:i.width/2+i.x,y:i.height/2+i.y};this.zoomPoint(a,o)}zoomPoint(e,t){this.zoomFactor=t;let i={x:-e.x+this.outerRect.width/this.zoomFactor/2,y:-e.y+this.outerRect.height/this.zoomFactor/2};this.canvasOffset=i}zoomConvertEventToViewPortCoordinates(e){let t=this.containerBoundingRect.x-this.outerRect.x,i=this.containerBoundingRect.y-this.outerRect.y;return{x:(e.x+t/this.zoomFactor)*this.zoomFactor,y:(e.y+i/this.zoomFactor)*this.zoomFactor}}zoomTowardsPoint(e,t){let i=t/this.zoomFactor,r=this.zoomConvertEventToViewPortCoordinates(e),n={x:-(r.x*(i-1)+i*-this.canvasOffsetUnzoomed.x),y:-(r.y*(i-1)+i*-this.canvasOffsetUnzoomed.y)};this.zoomFactor=t,this.canvasOffsetUnzoomed=n}};customElements.define("node-projects-designer-canvas",ci)});import{BaseCustomWebComponentConstructorAppend as Tu,css as Mu,html as Ou}from"@node-projects/base-custom-webcomponent";var Ui,yo=p(()=>{"use strict";Qe();We();Ui=class extends Tu{static style=Mu`
        ...
        <div id="popup"></div>
        <div id="toolButtons"></div>`;_toolButtonsElem;_serviceContainer;_popupContainer;designerView;constructor(){super(),this._toolButtonsElem=this._getDomElement("toolButtons"),this._toolButtonsElem.onwheel=e=>e.stopPropagation(),this._popupContainer=this._getDomElement("popup")}initialize(e,t){this._serviceContainer=e,this.designerView=t;for(let i of this._serviceContainer.designViewToolbarButtons)this._toolButtonsElem.appendChild(i.provideButton(t.designerCanvas));this._serviceContainer.globalContext.onToolChanged.on(i=>{for(let r of this._toolButtonsElem.children)r instanceof se&&r.setActiveTool(i.newValue.name)})}showPopup(e){if(this._popupContainer.children.length)this._popupContainer.innerHTML="";else{let t;typeof e.popup=="string"?t=document.createElement(e.popup):t=new e.popup,this._popupContainer.appendChild(t)}}setTool(e){this._popupContainer.children.length&&(this._popupContainer.innerHTML=""),this.designerView.designerCanvas.executeCommand({type:S.setTool,parameter:e})}setStrokeColor(e){this._popupContainer.children.length&&(this._popupContainer.innerHTML=""),this.designerView.designerCanvas.executeCommand({type:S.setStrokeColor,parameter:e})}setFillBrush(e){this._popupContainer.children.length&&(this._popupContainer.innerHTML=""),this.designerView.designerCanvas.executeCommand({type:S.setFillBrush,parameter:e})}setStrokeThickness(e){this._popupContainer.children.length&&(this._popupContainer.innerHTML=""),this.designerView.designerCanvas.executeCommand({type:S.setStrokeThickness,parameter:e})}};customElements.define("node-projects-designer-toolbar",Ui)});import{css as Nu,DomHelper as Lu,html as Ru,BaseCustomWebComponentConstructorAppend as Fu}from"@node-projects/base-custom-webcomponent";var Dt,vo=p(()=>{"use strict";lh();Te();Ei();ee();yo();Dt=class extends Fu{_sVert;_sHor;get serviceContainer(){return this._designerCanvas.serviceContainer}set serviceContainer(e){this._designerCanvas.serviceContainer=e}get instanceServiceContainer(){return this._designerCanvas.instanceServiceContainer}set instanceServiceContainer(e){this._designerCanvas.instanceServiceContainer=e}_designerCanvas;get designerCanvas(){return this._designerCanvas}_zoomInput;_lowertoolbar;_toolbar;static style=Nu`
    :host {
      display: block;
      box-sizing: border-box;
      width: 100%;
...
`}else r.displayHtml?a.innerHTML=r.displayHtml:a.innerText=r.name?r.name:r.tag;a.draggable=!0,a.ondragstart=c=>{if(c.dataTransfer.setData(Ar,JSON.stringify(r)),c.currentTarget.style.outline="dashed",r.ghostElement)if(typeof r.ghostElement=="string"){let h=document.createRange();h.selectNode(document.body);let m=h.createContextualFragment(r.ghostElement).firstChild;m.style.position="absolute",m.style.top="-1000px",document.body.appendChild(m),c.dataTransfer.setDragImage(m,0,0),requestAnimationFrame(()=>document.body.removeChild(m))}else c.dataTransfer.setDragImage(r.ghostElement,0,0);else if(!r.import)try{let h=document.createElement(r.tag);if(r.defaultContent&&(h.innerHTML=r.defaultContent),r.defaultWidth&&(h.style.width=r.defaultWidth),r.defaultHeight&&(h.style.height=r.defaultHeight),r.defaultAttributes)for(let m in r.defaultAttributes)h.setAttribute(m,r.defaultAttributes[m]);if(r.defaultStyles)for(let m in r.defaultStyles)h.style[m]=r.defaultStyles[m];h.style.position="absolute",r.defaultWidth?h.style.top="-"+(parseInt(r.defaultHeight)+500)+"px":h.style.top="-500px",r.defaultWidth?h.style.left="-"+(parseInt(r.defaultWidth)+500)+"px":h.style.left="-500px",document.body.appendChild(h);let d=h.getBoundingClientRect();d.width>0&&d.height>0&&c.dataTransfer.setDragImage(h,0,0),requestAnimationFrame(()=>document.body.removeChild(h))}catch(h){console.warn("error creating gost elment",h)}},a.ondragend=c=>{r.import=null,c.currentTarget.style.outline="none"},a.ontouchstart=c=>{c.preventDefault()},a.onclick=c=>{let h=e.designerTools.get(r.tool??U.DrawElementTool);typeof h=="function"&&(h=new h(r)),e.globalContext.tool=h},o.appendChild(a),n.appendChild(o);let l=document.createElement("td");l.innerText=r.description??"",n.appendChild(l),this._table.appendChild(n)}}};customElements.define("node-projects-palette-elements",Ki)});import{BaseCustomWebComponentLazyAppend as Zu,css as $u}from"@node-projects/base-custom-webcomponent";var fh,hp=p(()=>{"use strict";Ot();uh();Ot();fh=class extends Zu{selected="native";_designerTabControl;static style=$u`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
      height: 100%;
    }`;constructor(){super(),this._restoreCachedInititalValues(),this._designerTabControl=new Ye,this._designerTabControl.selectedIndex=0,this.shadowRoot.appendChild(this._designerTabControl)}async loadControls(e,t){this._designerTabControl.innerHTML="";for(let i of t)try{let r=await i.getElements(),n=new Ki;n.title=i.name,this._designerTabControl.appendChild(n),n.loadElements(e,r)}catch(r){console.warn("Error loading elements",r)}this._designerTabControl.refreshItems()}};customElements.define("node-projects-palette-view",fh)});import{BaseCustomWebComponentLazyAppend as qu,css as Qu}from"@node-projects/base-custom-webcomponent";var gh,dp=p(()=>{"use strict";q();gh=class extends qu{_items;_index;_previouslySelected;_treeDiv;_instanceServiceContainer;_selectionChangedHandler;_contentChangedHandler;_mapElementTreeitem;_rootItem;static style=Qu`
    :host {
      --horz-margin: 20px;
      --vert-margin: 0px;
    ...
    <div id="split" style="--split: 50;">
    ...
    </div>`;static properties={orientation:String};orientation="vertical";constructor(){super()}ready(){this._parseAttributesToProperties(),this.setAttribute("orientation",this.orientation);let e=this._getDomElement("split"),t=this._getDomElement("splitter"),i=null;t.addEventListener("pointerdown",r=>{t.setPointerCapture(r.pointerId),i=!0}),t.addEventListener("pointerup",r=>{t.releasePointerCapture(r.pointerId),i=null}),t.addEventListener("pointermove",r=>{if(i!==null){let n=parseFloat(e.style.getPropertyValue("--split"));this.orientation==="horizontal"?n+=r.movementX*100/e.clientWidth:n+=r.movementY*100/e.clientHeight,isNaN(n)||e.style.setProperty("--split",n)}})}};customElements.define("node-projects-simple-split-view",Yi)});import{BaseCustomWebComponentLazyAppend as rf,css as nf,cssFromString as sf,debounce as of,TypedEvent as yh}from"@node-projects/base-custom-webcomponent";var z,vh,mp=p(()=>{"use strict";Ot();vo();pp();Pe();De();(function(s){s[s.designer=0]="designer",s[s.code=1]="code",s[s.split=2]="split",s[s.preview=3]="preview"})(z||(z={}));vh=class extends rf{designerView;codeView;demoView;additionalData;_firstLoad=!0;_stylesheetChangedEventRegistered;_additionalStyle;set additionalStyleString(e){this._additionalStyle=e,this.designerView.additionalStyles=[sf(e)]}get additionalStyleString(){return this._additionalStyle}_additionalStyles;set additionalStyles(e){this._additionalStyles=e,this.designerView.additionalStyles=this._additionalStyles}get additionalStyles(){return this._additionalStyles}_additionalStylesheets;set additionalStylesheets(e){this._additionalStylesheets=e,this.designerView.instanceServiceContainer.stylesheetService&&(this.designerView.instanceServiceContainer.stylesheetService.setStylesheets(e),this._stylesheetChangedEventRegistered||(this._stylesheetChangedEventRegistered=!0,this.designerView.instanceServiceContainer.stylesheetService.stylesheetChanged.on(t=>this.additionalStylesheetChanged.emit({name:t.name,newStyle:t.newStyle,oldStyle:t.oldStyle,changeSource:t.changeSource}))))}get additionalStylesheets(){return this._additionalStylesheets}additionalStylesheetChanged=new yh;onContentChanged=new yh;onTabChanged=new yh;_contentChangeSource="designer";_serviceContainer;_content="";_tabControl;_selectionPosition;_splitDiv;_designerDiv;_codeDiv;refreshInSplitViewDebounced;_disableChangeNotificationDesigner;_disableChangeNotificationEditor;static get style(){return nf`
      div {
        height: 100%;
        display: flex;
        flex-direction: column;
      ...
      `}constructor(e,t,i=!1){super(),this.refreshInSplitViewDebounced=of(this.refreshInSplitView,200),this._serviceContainer=e,t!=null&&(this._content=t);let r=document.createElement("div");this._tabControl=new Ye,r.appendChild(this._tabControl),this.designerView=new Dt(i),this.designerView.setAttribute("exportparts","canvas"),this.designerView.slot="top",this._designerDiv=document.createElement("div"),this._tabControl.appendChild(this._designerDiv),this._designerDiv.title="Designer",this._designerDiv.appendChild(this.designerView),this.designerView.initialize(this._serviceContainer),this.designerView.instanceServiceContainer.documentContainer=this,this.designerView.instanceServiceContainer.selectionService.onSelectionChanged.on(n=>this.designerSelectionChanged(n)),this.designerView.designerCanvas.onContentChanged.on(()=>this.designerContentChanged()),this.codeView=new e.config.codeViewWidget,this.codeView.slot="bottom",this.codeView.style.position="relative",this._codeDiv=document.createElement("div"),this._tabControl.appendChild(this._codeDiv),this._codeDiv.title="Code",this._codeDiv.style.position="relative",this._codeDiv.appendChild(this.codeView),this.codeView.onTextChanged.on(n=>{this._disableChangeNotificationDesigner||(this._tabControl.selectedIndex===z.code||this._tabControl.selectedIndex===z.split)&&(this._disableChangeNotificationEditor=!0,this._content=n,this.refreshInSplitViewDebounced())}),this._splitDiv=new Yi,this._splitDiv.style.height="100%",this._splitDiv.title="Split",this._tabControl.appendChild(this._splitDiv),e.config.demoViewWidget&&(this.demoView=new e.config.demoViewWidget,this.demoView.title="Preview",this._tabControl.appendChild(this.demoView)),queueMicrotask(()=>{this.shadowRoot.appendChild(r),this._tabControl.selectedIndex=z.designer})}async refreshInSplitView(){try{await this.updateDesignerHtml()}catch(e){console.error(e)}this._disableChangeNotificationEditor=!1}get currentView(){return this._tabControl.selectedIndex==z.designer?"designer":this._tabControl.selectedIndex==z.split?"split":this._tabControl.selectedIndex==z.code?"code":this._tabControl.selectedIndex==z.preview?"preview":null}set currentView(e){e=="designer"&&(this._tabControl.selectedIndex=z.designer),e=="split"&&(this._tabControl.selectedIndex=z.split),e=="code"&&(this._tabControl.selectedIndex=z.code),e=="preview"&&(this._tabControl.selectedIndex=z.preview)}designerSelectionChanged(e){if(this._tabControl.selectedIndex===z.split){let t=this.instanceServiceContainer.selectionService.primarySelection;t&&this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(t),this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null)}}designerContentChanged(){if(this.onContentChanged.emit({source:this._contentChangeSource}),!this._disableChangeNotificationEditor){if(this._disableChangeNotificationDesigner=!0,this._tabControl.selectedIndex===z.code||this._tabControl.selectedIndex===z.split){let e=this.instanceServiceContainer.selectionService.primarySelection;this._content=this.designerView.getDesignerHTML(),this.codeView.update(this._content,this.designerView.instanceServiceContainer),e&&this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(e),this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null)}this._disableChangeNotificationDesigner=!1}}dispose(){this.codeView.dispose(),this.demoView.dispose()}executeCommand(e){this._tabControl.selectedIndex===z.designer||this._tabControl.selectedIndex===z.split?this.designerView.executeCommand(e):this._tabControl.selectedIndex===z.code?this.codeView.executeCommand(e):this._tabControl.selectedIndex===z.preview&&this.demoView.executeCommand(e)}canExecuteCommand(e){if(this._tabControl.selectedIndex===z.designer||this._tabControl.selectedIndex===z.split){if(this.designerView?.canExecuteCommand)return this.designerView.canExecuteCommand(e)}else if(this._tabControl.selectedIndex===z.code){if(this.codeView?.canExecuteCommand)return this.codeView.canExecuteCommand(e)}else if(this._tabControl.selectedIndex===z.preview&&this.demoView?.canExecuteCommand)return this.demoView.canExecuteCommand(e);return!1}async setContentAsync(e){this._content=e,this._tabControl&&(this._tabControl.selectedIndex===z.designer?await this.updateDesignerHtml():this._tabControl.selectedIndex===z.code?this.codeView.update(this._content,this.designerView.instanceServiceContainer):this._tabControl.selectedIndex===z.split||this._tabControl.selectedIndex===z.preview&&this.demoView.display(this._serviceContainer,this.designerView.instanceServiceContainer,this._content,this.additionalStyleString))}set content(e){this.setContentAsync(e)}get content(){return this._tabControl?(this._tabControl.selectedIndex===z.designer?this._content=this.designerView.getDesignerHTML():this._tabControl.selectedIndex===z.code&&(this._content=this.codeView.getText()),this._content):null}ready(){this._tabControl.onSelectedTabChanged.on(e=>{if(e.oldIndex===z.designer){let t=this.instanceServiceContainer.selectionService.primarySelection;this._content=this.designerView.getDesignerHTML(),this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(t))}else e.oldIndex===z.code?this._content=this.codeView.getText():e.oldIndex===z.split?(this._designerDiv.appendChild(this.designerView),this._codeDiv.appendChild(this.codeView)):e.oldIndex===z.preview&&this.demoView?.stopDisplay&&this.demoView.stopDisplay();(e.newIndex===z.designer||e.newIndex===z.split)&&this.updateDesignerHtml(),(e.newIndex===z.code||e.newIndex===z.split)&&(this.codeView.update(this._content,this.designerView.instanceServiceContainer),this._selectionPosition&&(this.codeView.setSelection(this._selectionPosition),lt(20).then(t=>{this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null})),e.changedViaClick&&this.codeView.focusEditor()),e.newIndex===z.split&&(this._splitDiv.appendChild(this.designerView),this._splitDiv.appendChild(this.codeView)),e.newIndex===z.preview&&this.demoView.display(this._serviceContainer,this.designerView.instanceServiceContainer,this._content,this.additionalStyleString),this._content&&(this._firstLoad=!1),this.onTabChanged.emit({oldTab:z[e.oldIndex],newTab:z[e.newIndex]})}),this._content&&(this.content=this._content,this._firstLoad=!1)}async updateDesignerHtml(){if(this._firstLoad)return this.designerView.parseDesignerHTML(this._content,this._firstLoad);if(this.designerView.getDesignerHTML()!=this._content){this._contentChangeSource="code",await this.designerView.parseDesignerHTML(this._content,this._firstLoad),this._contentChangeSource="designer";return}else this.instanceServiceContainer.undoService.clearTransactionstackIfNotEmpty(),this.designerView.designerCanvas.overlayLayer.removeAllOverlays(),this.designerView.designerCanvas.extensionManager.reapplyAllAppliedExtentions(null,[w.Permanent,w.Selection,w.PrimarySelection,w.PrimarySelectionContainer,w.OnlyOneItemSelected,w.MultipleItemsSelected])}get instanceServiceContainer(){return this.designerView.instanceServiceContainer}};customElements.define("node-projects-document-container",vh)});var tl=p(()=>{"use strict";Ot();kh();eo();Ro();Ne();zn();Wc();te();zo();Oe();jc();Dn();Uc();Xo();at();Pe();vr();Va();dd();be();Ua();q();Xc();ke();Z();md();ud();gd();Zc();vd();Gt();rl();el();nl();il();Ql();ll();_d();Gc();wd();cc();rc();qs();Cd();sl();lc();Ad();Kc();Yc();Vi();kd();yl();Dd();vl();Md();Ei();Yo();Nd();hl();Rd();oa();re();Gl();ve();ta();Zo();$o();ra();qo();zd();Qo();Jo();ea();na();Bl();zl();ge();Lt();Ll();rs();aa();Mc();Rt();$c();Vl();ns();Vd();To();ha();pc();Mo();Oo();Do();ye();so();Rl();Hl();Gd();ie();Xe();jd();Kd();ql();Jc();Qc();Zl();$l();Lo();No();Hc();He();Fo();Uo();eh();th();Vo();qi();ih();Io();$d();uo();qd();vo();lh();oh();ip();Te();Il();El();Ml();Al();Dl();Pl();sc();Bc();Di();kl();Cl();Tl();nc();yo();We();yo();$e();hc();Pa();ul();fl();gl();Wa();Fa();ja();Aa();Ga();Ka();Ra();zc();Vc();Le();X();De();J();Za();$a();xa();_a();Pc();kc();gc();sh();Ul();cs();Ya();Xa();Ol();Nl();qa();_n();Sa();Ca();oc();ac();uc();fc();hh();np();ba();wa();ma();ua();Ma();Oa();Na();La();ka();Ia();ya();va();Wl();jl();Oc();Nc();bc();wc();xc();_c();ec();tc();pl();Ii();Ic();Dc();Cc();Ec();yc();vc();ic();Xl();Yl();ml();bt();dl();ur();Ac();dc();Rc();pn();ol();Sc();za();Ja();Fc();Ha();_l();xl();Wn();Sl();Ba();wl();bl();Jl();Tc();Lc();dh();ph();op();lp();cp();Po();uh();hp();dp();ko();mp();ee();Ea();Qe();$()});tl();eo();export{oo as AbsolutePlacementService,ut as AbstractBaseToolPopup,Qt as AbstractCssPropertiesService,Ae as AbstractDesignViewConfigButton,_o as AbstractDesignerPointerExtension,N as AbstractExtension,Bn as AbstractHtmlWriterService,Fe as AbstractPolymerLikePropertiesService,Y as AbstractPropertiesService,lo as AbstractStylesheetService,js as AlignItemsContextMenu,gn as AltToEnterContainerExtension,yn as AltToEnterContainerExtensionProvider,yd as AlwaysAbsolutePlacementService,ti as ApplyFirstMachingExtensionProvider,es as AttachedPropertiesService,fi as AttributeChangeAction,Li as AttributesPropertiesService,Tr as BaseCustomWebComponentPropertiesService,fd as BaseCustomWebcomponentBindingsService,Sd as BaseCustomWebcomponentDesignItemService,Q as BasePropertyEditor,Nt as BaseServiceContainer,Ce as BasicStackedToolbarExtension,Us as BasicWebcomponentPropertiesService,pd as BindableObjectType,Gi as BindingMode,M as BindingTarget,Wd as BindingsRefactorService,Ls as BlockToolbarExtension,Rs as BlockToolbarExtensionProvider,Er as BooleanPropertyEditor,et as ButtonSeperatorProvider,ps as ChangeGroup,It as ChildContextMenu,$s as ChildrenContextMenu,mi as CodeViewSimple,_r as ColorPropertyEditor,S as CommandType,Ie as CommonPropertiesService,it as ConditionExtensionProvider,ao as ContentAndIdPropertiesService,gs as ContentService,he as ContextMenu,xd as CopyPasteAsJsonService,an as CopyPasteContextMenu,Tn as CopyPasteService,cr as CssAttributeParser,qt as CssCombiner,Jt as CssCurrentPropertiesService,ei as CssCustomPropertiesService,lr as CssEntry,Se as CssPropertiesService,Ft as CssStyleChangeAction,bo as CursorLinePointerExtension,sp as CursorLinePointerExtensionProvider,br as DatePropertyEditor,mh as DebugView,ch as DefaultConfiguredDesignerView,Dr as DefaultEditorTypesService,ht as DefaultHtmlParserService,xr as DefaultInstanceService,Mn as DefaultModelCommandService,Ve as DefaultPlacementService,Qs as DeleteAction,Js as DeletionService,di as DemoView,T as DesignItem,xs as DesignItemDocumentPositionService,ni as DesignItemService,ci as DesignerCanvas,Ye as DesignerTabControl,Ui as DesignerToolbar,se as DesignerToolbarButton,Dt as DesignerView,On as DisplayGridExtension,kt as DisplayGridExtensionProvider,vh as DocumentContainer,K as DomConverter,Ss as DragDropService,Es as DrawElementTool,Rn as DrawEllipsisTool,Fn as DrawLineTool,Zr as DrawPathTool,Ln as DrawRectTool,$n as DrawToolButtonProvider,Mi as DrawToolPopup,vs as EditGridColumnRowSizesExtension,zi as EditGridColumnRowSizesExtensionProvider,Xt as EditTextExtension,Pn as EditTextExtensionProvider,Sn as ElementAtPointService,_e as ElementDisplayType,Fr as ElementDragTitleExtension,zr as ElementDragTitleExtensionProvider,x as EventNames,fe as EventsService,go as ExtensionManager,w as ExtensionType,An as ExternalDragDropService,Cn as FlexBoxPlacementService,Os as FlexToolbarExtension,Ns as FlexToolbarExtensionProvider,ls as FlexboxExtension,hs as FlexboxExtensionDesignViewConfigButtons,Fi as FlexboxExtensionProvider,Xs as ForceCssContextMenu,Id as FormatingHtmlWriterService,Jn as GrayOutDragOverContainerExtension,Ni as GrayOutDragOverContainerExtensionProvider,un as GrayOutExtension,fn as GrayOutExtensionProvider,ts as GridAssignedRowColumnPropertyEditor,Gs as GridChildResizeExtension,Ws as GridChildResizeExtensionProvider,Fs as GridChildToolbarExtension,zs as GridChildToolbarExtensionProvider,Nn as GridExtensionDesignViewConfigButtons,wn as GridPlacementService,Ts as GridToolbarExtension,Ms as GridToolbarExtensionProvider,Kr as HighlightElementExtension,Yr as HighlightElementExtensionProvider,Vn as HtmlWriterService,bd as IframeDemoProviderService,Pr as ImageButtonListPropertyEditor,hr as IndentedTextWriter,oe as InsertAction,ot as InsertChildAction,mo as InstanceServiceContainer,vn as InvisibleElementExtension,ds as InvisibleElementExtensionDesignViewConfigButtons,xn as InvisibleElementExtensionProvider,bn as ItemsBelowContextMenu,Ed as JsonFileElementsService,wr as JsonPropertyEditor,Fd as JsonPropertyPopupEditor,ys as JumpToElementContextMenu,Bd as ListPropertiesService,Rr as Lit2PropertiesService,sr as LitElementPropertiesService,Td as LitTsElementWriterService,hn as MagicWandSelectorTool,Gr as MarginExtension,Wr as MarginExtensionProvider,ii as MarginTool,Ps as MathMLElementsPropertiesService,is as MetricsPropertyEditor,Ld as MultiplayerService,cn as MultipleItemsSelectedContextMenu,bs as MultipleSelectionRectExtension,ws as MultipleSelectionRectExtensionProvider,U as NamedTools,or as NativeElementsPropertiesService,E as NodeType,hd as NpmPackageLoader,Sr as NumberPropertyEditor,to as ObservedCustomElementsRegistry,Zs as OptionsContextMenuButton,k as OverlayLayer,li as OverlayLayerView,Vs as PaddingExtension,Hs as PaddingExtensionProvider,ri as PaddingTool,Ki as PaletteElements,fh as PaletteView,on as PanTool,Gn as PathContextMenu,xo as PathExtension,rp as PathExtensionProvider,dn as PickColorTool,os as PlacementExtension,as as PlacementExtensionProvider,Ao as PlainScrollbar,le as PointerActionType,Xr as PointerTool,Xn as PointerToolButtonProvider,Ti as PointerToolPopup,nr as PolymerPropertiesService,jr as PositionExtension,Ur as PositionExtensionProvider,ro as PreDefinedElementsService,Ks as PreviousElementSelectExtension,Ys as PreviousElementSelectExtensionProvider,R as PropertiesHelper,gr as PropertyChangeAction,rh as PropertyGrid,Ee as PropertyGridPropertyList,nh as PropertyGridWithHeader,ss as PropertyGroupsService,y as PropertyType,Hn as RectContextMenu,Ai as RectangleSelectorTool,So as RefactorView,G as RefreshMode,en as ResizeExtension,tn as ResizeExtensionProvider,rn as RotateExtension,nn as RotateExtensionProvider,Kn as RotateLeftAndRight,As as RoundPixelsDesignViewConfigButton,ar as SVGElementsPropertiesService,si as Screenshot,Yn as SelectAllChildrenContextMenu,wi as SelectPropertyEditor,$r as SelectionDefaultExtension,qr as SelectionDefaultExtensionProvider,fs as SelectionService,Oi as SelectionToolPopup,Qn as SelectorToolButtonProvider,we as SeperatorContextMenu,je as SeperatorToolProvider,er as ServiceContainer,ho as SetDesignItemsAction,Cs as SimpleDemoProviderService,Hi as SimpleToolButtonProvider,En as SnaplinesProviderService,co as StylesheetChangedAction,pr as StylesheetServiceDesignViewConfigButtons,Is as SvgElementExtension,Ds as SvgElementExtensionProvider,fr as TextContentChangeAction,Cr as TextPropertyEditor,Ud as TextRefactorService,mn as TextTool,qn as TextToolButtonProvider,Ir as ThicknessPropertyEditor,Bs as ToolbarExtensionsDesignViewConfigButtons,io as TouchGestureHelper,Vr as TransformOriginExtension,Hr as TransformOriginExtensionProvider,_s as TransformToolButtonProvider,Bi as TransformToolPopup,gh as TreeView,ms as UndoService,Hd as UnkownElementsPropertiesService,V as ValueType,no as WebcomponentManifestElementsService,Pd as WebcomponentManifestEventsService,Od as WebcomponentManifestParserService,oi as WebcomponentManifestPropertiesService,ln as ZMoveContextMenu,Un as ZoomToElementContextMenu,sn as ZoomTool,Zn as ZoomToolButtonProvider,kg as arraysEqual,v as assetsPath,Ue as basicStackedToolbarExtensionOverlayOptionName,Vh as calculateAlpha,Be as calculateNormLegth,rr as calculateOuterRect,qc as calculateSpecificity,xb as copyTextToClipboard,Pi as copyToClipboard,ad as createDefaultServiceContainer,Me as createPathD,Go as dataURItoBlob,Lh as deepValue,Ct as dragDropFormatNameBindingObject,Ar as dragDropFormatNameElementDefinition,ia as dragDropFormatNamePropertyGrid,mr as enableStylesheetService,Ho as exportData,ne as filterChildPlaceItems,ca as filterNonElementItems,Kl as flexboxExtensionShowOverlayOptionName,gi as forceActiveAttributeName,vi as forceFocusAttributeName,_i as forceFocusVisibleAttributeName,xi as forceFocusWithinAttributeName,ct as forceHoverAttributeName,yi as forceVisitedAttributeName,Tf as getActiveElement,W as getBoundingClientRectAlsoForDisplayContents,Mh as getContentBoxContentOffsets,Nr as getDesignItemCurrentPos,Th as getElementDisplaytype,Mf as getElementOffsetParent,Of as getElementOffsetsInContainer,Nf as getElementsWindowOffsetWithoutSelfAndParentTransformations,In as getFromClipboard,Dh as getParentElementIncludingSlots,kn as getTextFromClipboard,ki as gridExtensionShowOverlayOptionName,j as hasCommandKey,zt as hideAtDesignTimeAttributeName,Bt as hideAtRunTimeAttributeName,Df as inDesigner,st as instanceOf,ui as instanceOfAny,Qa as invisibleElementExtensionShowOverlayOptionName,Nh as isAppleDevice,ir as isEmptyTextNode,yr as isFirefox,xt as isInline,_t as isInlineAfter,St as lockAtDesignTimeAttributeName,Hh as moveSVGPath,tr as newElementFromString,Jr as normalizeToAbsolutePosition,Lr as placeDesignItem,Wo as pointInRect,Jh as positionsJsonMime,Pm as provideSnaplinesWithDistance,km as provideSnaplinesWithDistanceDistance,de as removeLeading,wt as removeTrailing,Pg as requestAnimationFramePromise,O as roundValue,jo as setDeepValue,qh as shadowrootGetSelection,lt as sleep,Ze as straightenLine,Zh as switchContainer,bi as w3color,Qh as wrapSelectionInSpans};
// @license
