var vd=Object.defineProperty;var u=(s,e)=>()=>(s&&(e=s(s=0)),e);var xd=(s,e)=>{for(var t in e)vd(s,t,{get:e[t],enumerable:!0})};import{TypedEvent as kd}from"@node-projects/base-custom-webcomponent";var Ot,$i=u(()=>{"use strict";Ot=class{_services=new Map;servicesChanged=new kd;getLastService(e){let t=this._services.get(e);return t&&t.length?t[t.length-1]:null}getServices(e){return this._services.get(e)}register(e,t){this._services.has(e)||this._services.set(e,[]),this._services.get(e).push(t),this.servicesChanged.emit({serviceName:e})}registerLast(e,t){this._services.has(e)||this._services.set(e,[]),this._services.get(e).unshift(t),this.servicesChanged.emit({serviceName:e})}registerMultiple(e,t){for(let i of e)this._services.has(i)||this._services.set(i,[]),this._services.get(i).push(t),this.servicesChanged.emit({serviceName:i})}forSomeServicesTillResult(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r],o=t(n);if(o!=null)return o}return null}getLastServiceWhere(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r];if(t(n))return n}return null}getLastServiceResult(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r],o=t(n);if(o)return o}return null}async getLastServiceWhereAsync(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r];if(await t(n))return n}return null}}});import{BaseCustomWebComponentLazyAppend as Id,css as Dd}from"@node-projects/base-custom-webcomponent";var hi,wo=u(()=>{"use strict";hi=class extends Id{_placeholder;_loading;static style=Dd`
  ...
  span {
    ...
    font-size: 24px;
  }`;constructor(){super(),this._placeholder=document.createElement("div"),this._placeholder.id="placeholder",this._placeholder.style.transform="scale(1)",this.shadowRoot.appendChild(this._placeholder),this._loading=document.createElement("div"),this._loading.id="loading",this._loading.textContent="\u{1F6C0} Hold on, loading...",this.shadowRoot.appendChild(this._loading);let e=document.createElement("div");e.id="left";let t=document.createElement("span");t.innerText="PREVIEW",e.appendChild(t),this.shadowRoot.appendChild(e)}dispose(){}executeCommand;canExecuteCommand;async display(e,t,i,r){this._loading.hidden=!1,await e.demoProviderService.provideDemo(this._placeholder,e,t,i,r),this._loading.hidden=!0}};customElements.define("node-projects-demo-view",hi)});import{PropertyChangedArgs as qi,TypedEvent as di}from"@node-projects/base-custom-webcomponent";var Qi,ih=u(()=>{"use strict";Qi=class{_serviceContainer;_tool;_strokeColor="black";_strokeThickness="3";_fillBrush="transparent";constructor(e){this._serviceContainer=e}set tool(e){if(this._tool!==e){let t=this._tool;t&&t.dispose(),this._tool=e;let i=null;for(let r of this._serviceContainer.designerTools)r[1]==e&&(i=r[0]);this.onToolChanged.emit(new qi({name:i,tool:e},{name:null,tool:t})),this._tool&&this._tool.activated(this._serviceContainer)}}get tool(){return this._tool}onToolChanged=new di;finishedWithTool=()=>this.tool=null;set strokeColor(e){if(this._strokeColor!==e){let t=this._strokeColor;this._strokeColor=e,this.onStrokeColorChanged.emit(new qi(e,t))}}get strokeColor(){return this._strokeColor}onStrokeColorChanged=new di;set strokeThickness(e){if(this._strokeThickness!==e){let t=this._strokeThickness;this._strokeThickness=e,this.onStrokeThicknessChanged.emit(new qi(e,t))}}get strokeThickness(){return this._strokeThickness}onStrokeThicknessChanged=new di;set fillBrush(e){if(this._fillBrush=e,this._fillBrush!==e){let t=this._fillBrush;this._fillBrush=e,this.onFillBrushChanged.emit(new qi(e,t))}}get fillBrush(){return this._fillBrush}onFillBrushChanged=new di;showConfigClicked=new di}});import{BaseCustomWebComponentConstructorAppend as Td,css as Md,html as Od,TypedEvent as Nd}from"@node-projects/base-custom-webcomponent";var pi,So=u(()=>{"use strict";pi=class extends Td{dispose(){}canvasElement;elementsToPackages;onTextChanged=new Nd;_text;static style=Md`
    :host {
      display: block;
      height: 100%;
      width: 100%;
...
`}levelRaise(){}levelShrink(){}write(e){this._textHolder+=e}writeLine(e){this._textHolder+=e}writeIndent(){}writeNewline(){}getString(){return this._textHolder}}});var K,Te=u(()=>{"use strict";Oo();oh();K=class{static normalizeAttributeValue(e,t=!1){return typeof e=="number"&&(e=e.toString()),e?t?e.replaceAll("&","&amp;").replaceAll("'","&#39;").replaceAll("<","&lt;").replaceAll(">","&gt;"):e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;").replaceAll(">","&gt;"):e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}static normalizeContentValue(e){return e&&e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll("\xA0","&nbsp;")}static IsSelfClosingElement(e){return e==="area"||e==="base"||e==="br"||e==="col"||e==="embed"||e==="hr"||e==="img"||e==="input"||e==="keygen"||e==="link"||e==="meta"||e==="param"||e==="source"||e==="track"||e==="wbr"}static ConvertToString(e,t,i=!1){let r=t!==!1?new cr:new hr;return e[0].serviceContainer.htmlWriterService.write(r,e,!0,i),r.getString()}}});import{css as Fd}from"@node-projects/base-custom-webcomponent";var he,No,at=u(()=>{"use strict";he=class s{static _contextMenuCss=Fd`
  ...
  `;_input;constructor(e){super(e);let t=s.template.content.cloneNode(!0);this._input=t.getElementById("input"),e.readonly&&(this._input.readOnly=!0),this._input.onchange=i=>this._valueChanged(this._input.value),this.element=t}refreshValue(e,t){this._input.value=t}}});var wr,Yo=u(()=>{"use strict";ve();wr=class extends Q{constructor(e){super(e);let t=document.createElement("input");t.type="number",e.readonly&&(t.readOnly=!0),t.min=e.min,t.max=e.max,t.step=e.step,t.onchange=i=>this._valueChanged(t.value==""?null:t.valueAsNumber),this.element=t}refreshValue(e,t){this.element.value=t===void 0?null:t}}});var bi,Xo=u(()=>{"use strict";ve();bi=class extends Q{elementSelect;elementInput;constructor(e){super(e);let t=document.createElement("div"),i=document.createElement("select");if(e.type=="enum")for(let n of e.enumValues){let o=document.createElement("option");o.value=n[1],o.text=n[0],i.appendChild(o)}else for(let n of e.values){let o=document.createElement("option");o.value=n,o.text=n,i.appendChild(o)}e.readonly&&(i.disabled=!0),i.onchange=n=>this._valueChanged(i.value);let r=document.createElement("input");r.style.display="none",r.onchange=n=>this._valueChanged(r.value),this.elementSelect=i,this.elementInput=r,t.appendChild(this.elementSelect),t.appendChild(this.elementInput),this.element=t}refreshValue(e,t){this.elementSelect.style.display="block",this.elementInput.style.display="none",this.elementSelect.value=t,this.elementSelect.value!=t&&t&&(this.elementInput.value=t,this.elementSelect.style.display="none",this.elementInput.style.display="block")}}});var Sr,Zo=u(()=>{"use strict";ve();Sr=class extends Q{constructor(e){super(e);let t=document.createElement("input");t.type="text",e.readonly&&(t.readOnly=!0),t.onchange=i=>this._valueChanged(t.value),t.onfocus=i=>{t.selectionStart=0,t.selectionEnd=t.value?.length},this.element=t}refreshValue(e,t){t==null?this.element.value="":this.element.value=t}}});var Cr,$o=u(()=>{"use strict";ve();Cr=class extends Q{constructor(e){super(e);let t=document.createElement("input");t.type="checkbox",e.readonly&&(t.readOnly=!0),t.onchange=i=>this._valueChanged(t.checked),this.element=t}refreshValue(e,t){this.element.checked=t}}});import{BaseCustomWebComponentConstructorAppend as Hd,css as Gd,html as Wd}from"@node-projects/base-custom-webcomponent";var wi,hh=u(()=>{"use strict";wi=class extends Hd{static style=Gd`
    div {
      font-size: 10px;
      color: white;
    }
  ...
  `;static svgDefs=`
    ...
    `;static template=Ap`<div id="div"><img id="img"></div>`;tools;popup;currentToolOnButton;_img;_div;_longPress;constructor(e,t){super(),this.tools=t,this._img=this._getDomElement("img"),this._div=this._getDomElement("div"),this._div.onpointerdown=()=>{this.currentToolOnButton?(this.getRootNode().host.setTool(this.currentToolOnButton),setTimeout(()=>{e.clickOverlay.focus()},50),this.popup&&(this._longPress=setTimeout(()=>{this._longPress=null,this.getRootNode().host.showPopup(this)},200))):this.popup&&this.getRootNode().host.showPopup(this)},this._div.onpointerup=()=>{this._longPress&&(clearTimeout(this._longPress),this._longPress=null)},this.showTool(Object.getOwnPropertyNames(t)[0])}showTool(e){let t=this.tools[e];t&&(this._img.title=e,this._img.src=t.icon,this.currentToolOnButton=e)}setActiveTool(e){this.showTool(e),this.tools[e]?this._div.style.backgroundColor="lightgreen":this._div.style.backgroundColor=""}};customElements.define("node-projects-designer-toolbar-button",se)});import{BaseCustomWebComponentConstructorAppend as Pp,css as kp}from"@node-projects/base-custom-webcomponent";var ut,Ii=u(()=>{"use strict";ut=class extends Pp{static style=kp`
      ...
      .tools {
          ...
          margin-bottom: 5px;
          gap: 3px;
      }`;constructor(){super();for(let e of[...this.shadowRoot.querySelectorAll("div.tool")]){let t=e;t.onclick=()=>this.getRootNode().host.setTool(t.dataset.commandParameter)}}}});import{html as Ip}from"@node-projects/base-custom-webcomponent";var Di,vl=u(()=>{"use strict";$();Ii();Di=class extends ut{static template=Ip`
        <div class="container">
        ...
        </div>`};customElements.define("node-projects-designer-pointer-tool-popup",Di)});var Yn,xl=u(()=>{"use strict";We();$();vl();Yn=class{provideButton(e){let t=new se(e,{Pointer:{icon:v+"images/tools/PointerTool.svg"}});return t.popup=Di,t}}});var je,_l=u(()=>{"use strict";je=class{constructor(e){this.distance=e}distance;provideButton(e){let t=document.createElement("div");return t.style.marginTop=this.distance+"px",t}}});var Xn,bl=u(()=>{"use strict";We();$();Xn=class{provideButton(e){return new se(e,{Zoom:{icon:v+"images/tools/ZoomTool.svg"}})}}});import{html as Dp,css as Tp}from"@node-projects/base-custom-webcomponent";var Ti,wl=u(()=>{"use strict";$();Ii();Ti=class extends ut{static style=[super.style,Tp`
      .container {
          width: 220px;
          min-height: 300px;
      }
...
`}else r.displayHtml?a.innerHTML=r.displayHtml:a.innerText=r.name?r.name:r.tag;a.draggable=!0,a.ondragstart=c=>{if(c.dataTransfer.setData(Er,JSON.stringify(r)),c.currentTarget.style.outline="dashed",r.ghostElement)if(typeof r.ghostElement=="string"){let h=document.createRange();h.selectNode(document.body);let p=h.createContextualFragment(r.ghostElement).firstChild;p.style.position="absolute",p.style.top="-1000px",document.body.appendChild(p),c.dataTransfer.setDragImage(p,0,0),requestAnimationFrame(()=>document.body.removeChild(p))}else c.dataTransfer.setDragImage(r.ghostElement,0,0);else if(!r.import)try{let h=document.createElement(r.tag);if(r.defaultContent&&(h.innerHTML=r.defaultContent),r.defaultWidth&&(h.style.width=r.defaultWidth),r.defaultHeight&&(h.style.height=r.defaultHeight),r.defaultAttributes)for(let p in r.defaultAttributes)h.setAttribute(p,r.defaultAttributes[p]);if(r.defaultStyles)for(let p in r.defaultStyles)h.style[p]=r.defaultStyles[p];h.style.position="absolute",r.defaultWidth?h.style.top="-"+(parseInt(r.defaultHeight)+500)+"px":h.style.top="-500px",r.defaultWidth?h.style.left="-"+(parseInt(r.defaultWidth)+500)+"px":h.style.left="-500px",document.body.appendChild(h);let d=h.getBoundingClientRect();d.width>0&&d.height>0&&c.dataTransfer.setDragImage(h,0,0),requestAnimationFrame(()=>document.body.removeChild(h))}catch(h){console.warn("error creating gost elment",h)}},a.ondragend=c=>{r.import=null,c.currentTarget.style.outline="none"},a.ontouchstart=c=>{c.preventDefault()},a.onclick=c=>{let h=e.designerTools.get(r.tool??U.DrawElementTool);typeof h=="function"&&(h=new h(r)),e.globalContext.tool=h},o.appendChild(a),n.appendChild(o);let l=document.createElement("td");l.innerText=r.description??"",n.appendChild(l),this._table.appendChild(n)}}};customElements.define("node-projects-palette-elements",Ui);import{BaseCustomWebComponentLazyAppend as Gm,css as Wm}from"@node-projects/base-custom-webcomponent";var Wc=class extends Gm{selected="native";_designerTabControl;static style=Wm`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
      height: 100%;
    }`;constructor(){super(),this._restoreCachedInititalValues(),this._designerTabControl=new Ye,this._designerTabControl.selectedIndex=0,this.shadowRoot.appendChild(this._designerTabControl)}async loadControls(e,t){this._designerTabControl.innerHTML="";for(let i of t)try{let r=await i.getElements(),n=new Ui;n.title=i.name,this._designerTabControl.appendChild(n),n.loadElements(e,r)}catch(r){console.warn("Error loading elements",r)}this._designerTabControl.refreshItems()}};customElements.define("node-projects-palette-view",Wc);q();import{BaseCustomWebComponentLazyAppend as jm,css as Um}from"@node-projects/base-custom-webcomponent";var jc=class extends jm{_items;_index;_previouslySelected;_treeDiv;_instanceServiceContainer;_selectionChangedHandler;_contentChangedHandler;_mapElementTreeitem;_rootItem;static style=Um`
    :host {
      --horz-margin: 20px;
      --vert-margin: 0px;
    ...
    </div>`;static properties={orientation:String};orientation="vertical";constructor(){super()}ready(){this._parseAttributesToProperties(),this.setAttribute("orientation",this.orientation);let e=this._getDomElement("split"),t=this._getDomElement("splitter"),i=null;t.addEventListener("pointerdown",r=>{t.setPointerCapture(r.pointerId),i=!0}),t.addEventListener("pointerup",r=>{t.releasePointerCapture(r.pointerId),i=null}),t.addEventListener("pointermove",r=>{if(i!==null){let n=parseFloat(e.style.getPropertyValue("--split"));this.orientation==="horizontal"?n+=r.movementX*100/e.clientWidth:n+=r.movementY*100/e.clientHeight,isNaN(n)||e.style.setProperty("--split",n)}})}};customElements.define("node-projects-simple-split-view",Ki);Pe();De();var z;(function(s){s[s.designer=0]="designer",s[s.code=1]="code",s[s.split=2]="split",s[s.preview=3]="preview"})(z||(z={}));var Kc=class extends Zm{designerView;codeView;demoView;additionalData;_firstLoad=!0;_stylesheetChangedEventRegistered;_additionalStyle;set additionalStyleString(e){this._additionalStyle=e,this.designerView.additionalStyles=[qm(e)]}get additionalStyleString(){return this._additionalStyle}_additionalStyles;set additionalStyles(e){this._additionalStyles=e,this.designerView.additionalStyles=this._additionalStyles}get additionalStyles(){return this._additionalStyles}_additionalStylesheets;set additionalStylesheets(e){this._additionalStylesheets=e,this.designerView.instanceServiceContainer.stylesheetService&&(this.designerView.instanceServiceContainer.stylesheetService.setStylesheets(e),this._stylesheetChangedEventRegistered||(this._stylesheetChangedEventRegistered=!0,this.designerView.instanceServiceContainer.stylesheetService.stylesheetChanged.on(t=>this.additionalStylesheetChanged.emit({name:t.name,newStyle:t.newStyle,oldStyle:t.oldStyle,changeSource:t.changeSource}))))}get additionalStylesheets(){return this._additionalStylesheets}additionalStylesheetChanged=new Uc;onContentChanged=new Uc;onTabChanged=new Uc;_contentChangeSource="designer";_serviceContainer;_content="";_tabControl;_selectionPosition;_splitDiv;_designerDiv;_codeDiv;refreshInSplitViewDebounced;_disableChangeNotificationDesigner;_disableChangeNotificationEditor;static get style(){return $m`
      div {
        height: 100%;
        display: flex;
        flex-direction: column;
