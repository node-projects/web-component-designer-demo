var wd=Object.defineProperty;var u=(s,e)=>()=>(s&&(e=s(s=0)),e);var Sd=(s,e)=>{for(var t in e)wd(s,t,{get:e[t],enumerable:!0})};import{TypedEvent as Md}from"@node-projects/base-custom-webcomponent";var Nt,Qi=u(()=>{"use strict";Nt=class{_services=new Map;servicesChanged=new Md;getLastService(e){let t=this._services.get(e);return t&&t.length?t[t.length-1]:null}getServices(e){return this._services.get(e)}register(e,t){this._services.has(e)||this._services.set(e,[]),this._services.get(e).push(t),this.servicesChanged.emit({serviceName:e})}registerLast(e,t){this._services.has(e)||this._services.set(e,[]),this._services.get(e).unshift(t),this.servicesChanged.emit({serviceName:e})}registerMultiple(e,t){for(let i of e)this._services.has(i)||this._services.set(i,[]),this._services.get(i).push(t),this.servicesChanged.emit({serviceName:i})}forSomeServicesTillResult(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r],o=t(n);if(o!=null)return o}return null}getLastServiceWhere(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r];if(t(n))return n}return null}getLastServiceResult(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r],o=t(n);if(o)return o}return null}async getLastServiceWhereAsync(e,t){let i=this.getServices(e);if(i==null)return null;for(let r=i.length-1;r>=0;r--){let n=i[r];if(await t(n))return n}return null}}});import{BaseCustomWebComponentLazyAppend as Nd,css as Od}from"@node-projects/base-custom-webcomponent";var pi,Co=u(()=>{"use strict";pi=class extends Nd{_placeholder;_loading;static style=Od`
  ...
  span {
    ...
    font-size: 24px;
  }`;constructor(){super(),this._placeholder=document.createElement("div"),this._placeholder.id="placeholder",this._placeholder.style.transform="scale(1)",this.shadowRoot.appendChild(this._placeholder),this._loading=document.createElement("div"),this._loading.id="loading",this._loading.textContent="\u{1F6C0} Hold on, loading...",this.shadowRoot.appendChild(this._loading);let e=document.createElement("div");e.id="left";let t=document.createElement("span");t.innerText="PREVIEW",e.appendChild(t),this.shadowRoot.appendChild(e)}dispose(){}executeCommand;canExecuteCommand;async display(e,t,i,r){this._loading.hidden=!1,await e.demoProviderService.provideDemo(this._placeholder,e,t,i,r),this._loading.hidden=!0}};customElements.define("node-projects-demo-view",pi)});import{PropertyChangedArgs as Ji,TypedEvent as mi}from"@node-projects/base-custom-webcomponent";var er,sh=u(()=>{"use strict";er=class{_serviceContainer;_tool;_strokeColor="black";_strokeThickness="3";_fillBrush="transparent";constructor(e){this._serviceContainer=e}set tool(e){if(this._tool!==e){let t=this._tool;t&&t.dispose(),this._tool=e;let i=null;for(let r of this._serviceContainer.designerTools)r[1]==e&&(i=r[0]);this.onToolChanged.emit(new Ji({name:i,tool:e},{name:null,tool:t})),this._tool&&this._tool.activated(this._serviceContainer)}}get tool(){return this._tool}onToolChanged=new mi;finishedWithTool=()=>this.tool=null;set strokeColor(e){if(this._strokeColor!==e){let t=this._strokeColor;this._strokeColor=e,this.onStrokeColorChanged.emit(new Ji(e,t))}}get strokeColor(){return this._strokeColor}onStrokeColorChanged=new mi;set strokeThickness(e){if(this._strokeThickness!==e){let t=this._strokeThickness;this._strokeThickness=e,this.onStrokeThicknessChanged.emit(new Ji(e,t))}}get strokeThickness(){return this._strokeThickness}onStrokeThicknessChanged=new mi;set fillBrush(e){if(this._fillBrush=e,this._fillBrush!==e){let t=this._fillBrush;this._fillBrush=e,this.onFillBrushChanged.emit(new Ji(e,t))}}get fillBrush(){return this._fillBrush}onFillBrushChanged=new mi;showConfigClicked=new mi}});import{BaseCustomWebComponentConstructorAppend as Ld,css as Rd,html as Fd,TypedEvent as zd}from"@node-projects/base-custom-webcomponent";var ui,Eo=u(()=>{"use strict";ui=class extends Ld{dispose(){}canvasElement;elementsToPackages;onTextChanged=new zd;_text;static style=Rd`
    :host {
      display: block;
      height: 100%;
      width: 100%;
  ...
  `;static svgDefs=`
    ...
    `;static template=Dp`<div id="div"><img id="img"></div>`;tools;popup;currentToolOnButton;_img;_div;_longPress;constructor(e,t){super(),this.tools=t,this._img=this._getDomElement("img"),this._div=this._getDomElement("div"),this._div.onpointerdown=()=>{this.currentToolOnButton?(this.getRootNode().host.setTool(this.currentToolOnButton),setTimeout(()=>{e.clickOverlay.focus()},50),this.popup&&(this._longPress=setTimeout(()=>{this._longPress=null,this.getRootNode().host.showPopup(this)},200))):this.popup&&this.getRootNode().host.showPopup(this)},this._div.onpointerup=()=>{this._longPress&&(clearTimeout(this._longPress),this._longPress=null)},this.showTool(Object.getOwnPropertyNames(t)[0])}showTool(e){let t=this.tools[e];t&&(this._img.title=e,this._img.src=t.icon,this.currentToolOnButton=e)}setActiveTool(e){this.showTool(e),this.tools[e]?this._div.style.backgroundColor="lightgreen":this._div.style.backgroundColor=""}};customElements.define("node-projects-designer-toolbar-button",se)});import{BaseCustomWebComponentConstructorAppend as Tp,css as Mp}from"@node-projects/base-custom-webcomponent";var ut,Ti=u(()=>{"use strict";ut=class extends Tp{static style=Mp`
      ...
      .tools {
          ...
          margin-bottom: 5px;
          gap: 3px;
      }`;constructor(){super();for(let e of[...this.shadowRoot.querySelectorAll("div.tool")]){let t=e;t.onclick=()=>this.getRootNode().host.setTool(t.dataset.commandParameter)}}}});import{html as Np}from"@node-projects/base-custom-webcomponent";var Mi,bl=u(()=>{"use strict";q();Ti();Mi=class extends ut{static template=Np`
        <div class="container">
        ...
        </div>`};customElements.define("node-projects-designer-pointer-tool-popup",Mi)});var Zn,wl=u(()=>{"use strict";We();q();bl();Zn=class{provideButton(e){let t=new se(e,{Pointer:{icon:v+"images/tools/PointerTool.svg"}});return t.popup=Mi,t}}});var je,Sl=u(()=>{"use strict";je=class{constructor(e){this.distance=e}distance;provideButton(e){let t=document.createElement("div");return t.style.marginTop=this.distance+"px",t}}});var $n,Cl=u(()=>{"use strict";We();q();$n=class{provideButton(e){return new se(e,{Zoom:{icon:v+"images/tools/ZoomTool.svg"}})}}});import{html as Op,css as Lp}from"@node-projects/base-custom-webcomponent";var Ni,El=u(()=>{"use strict";q();Ti();Ni=class extends ut{static style=[super.style,Lp`
      .container {
          width: 220px;
          min-height: 300px;
      }
...
span {
  ...
  `;property;unsetValue;_borderDiv;_elementDiv;constructor(){super(),this._restoreCachedInititalValues(),this._borderDiv=this._getDomElement("border"),this._elementDiv=this._getDomElement("element")}ready(){this._parseAttributesToProperties(),this._assignEvents()}onDoubleClick(e){let t=e.target;t.setAttribute("contentEditable","");let i=document.createRange(),r=window.getSelection();i.setStart(t.firstChild,0),i.setEndAfter(t.lastChild),r.removeAllRanges(),r.addRange(i)}onKeyDown(e){let t=e.target;if(e.key=="Enter"){t.removeAttribute("contentEditable");let i=t.innerHTML,r=new CustomEvent("value-changed",{detail:{style:t.dataset.style,value:i}});this.dispatchEvent(r)}}refresh(e){this._elementDiv.classList.remove("box"),this._borderDiv.classList.remove("box"),e&&(getComputedStyle(e).boxSizing=="content-box"?this._elementDiv.classList.add("box"):this._borderDiv.classList.add("box"))}};customElements.define("node-projects-metrics-editor",Fi)});var rs,Rl=u(()=>{"use strict";fe();Mh();rs=class extends X{constructor(e){super(e);let t=new Fi;t.property=e.name,this.element=t}refreshValue(e,t){this.element.refresh(this.designItems?.[0]?.element)}}});var Jt,ns=u(()=>{"use strict";Lt();re();ue();Jt=class extends ke{getRefreshMode(e){return G.none}async previewValue(e,t,i){let r=t.propertyName??t.name;r.startsWith("--")||(r=N.camelToDashCase(r));for(let n of e)n.element.style.setProperty(r,i)}async removePreviewValue(e,t){let i=t.propertyName??t.name;i.startsWith("--")||(i=N.camelToDashCase(i));for(let r of e)r.hasStyle(i)?r.element.style.setProperty(i,r.getStyle(i)):r.element.style.setProperty(i,"")}constructor(){super(!1)}}});var Se,ss=u(()=>{"use strict";Ie();ie();re();ue();Ll();Rl();Ol();ns();Se=class extends Jt{getRefreshMode(e){return G.none}layout={common:["display","color","background-color","box-sizing","border","box-shadow","opacity","position","align-content"],font:["font-family","font-size","font-weight"],layout:["inset","margin","border","padding","overflow","metrics"]};grid=["display","position","grid-template-columns","grid-template-rows","gap","column-gap","row-gap","align-content","justify-content","align-items","justify-items"];gridChild=["grid-row","grid-column","assigned-row-column","align-self","justify-self"];flex=["display","position","flex-direction","flex-wrap","align-content","justify-content","align-items","gap"];flexChild=["align-self","justify-self"];svg=["fill","fill-rule","fill-opacity","stroke","stroke-width","stroke-dasharray","stroke-dashoffset","stroke-opacity"];constructor(e){super(),this.name=e}isHandledElement(e){return!0}async getProperty(e,t){return this._getPropertyDef(t)}async getProperties(e){let t=this[this.name];if(Array.isArray(t))return t.map(r=>this._getPropertyDef(r));{let i=[];for(let r in t){let n={name:r,properties:t[r].map(o=>this._getPropertyDef(o))};i.push(n)}return i}}_getPropertyDef(e){let t=N.dashToCamelCase(e);switch(t){case"assignedRowColumn":return{name:e,service:this,propertyType:y.complex,createEditor:i=>new is(i)};case"metrics":return{name:e,service:this,propertyType:y.complex,createEditor:i=>new rs(i)};default:return{name:e,type:tt[t]?.type??"string",values:tt[t]?.values?[...tt[t]?.values,"initial","inherit","unset"]:["initial","inherit","unset"],service:this,propertyType:y.cssValue}}}getPropertyTarget(e,t){return M.css}}});var Gp,ei,Fl=u(()=>{"use strict";ie();re();Xe();$();Ol();Ie();ue();ve();ss();Gp="&lt;local&gt;",ei=class extends Se{getRefreshMode(e){return G.fullOnValueChange}constructor(){super(null),this.name="styles"}isHandledElement(e){return!0}async getProperty(e,t){return{name:t,type:"string",service:this,propertyType:y.cssValue}}getPropertyNameSuggestions(e){return Object.keys(tt).map(t=>N.camelToDashCase(t))}async getProperties(e){if(!e||e.nodeType!=E.Element)return[];let t=e.getAllStyles().reverse().sort((o,a)=>o.specificity==null?-1:a.specificity==null?1:o.specificity.A>a.specificity.A||o.specificity.A===a.specificity.A&&o.specificity.B>a.specificity.B||o.specificity.A===a.specificity.A&&o.specificity.B===a.specificity.B&&o.specificity.C>a.specificity.C?-1:o.specificity.A===a.specificity.A&&o.specificity.B===a.specificity.B&&o.specificity.C===a.specificity.C?0:1),i=Y.getOrBuildCachedBindings(e),r=t.find(o=>o.selector===null);for(let o of i)o.target===M.css&&(r.declarations.find(a=>a.name==o.targetName)||r.declarations.push({name:o.targetName,value:null,important:!1,parent:null}));return t.map(o=>({name:(o.selector??Gp)+(o.specificity?" ("+o.specificity.A+"-"+o.specificity.B+"-"+o.specificity.C+")":""),description:o.stylesheetName??"",properties:[...o.declarations.map(a=>{let l=N.dashToCamelCase(a.name);return{name:a.name,renamable:!0,type:tt[l]?.type??"string",values:tt[l]?.values?[...tt[l]?.values,"initial","inherit","unset"]:["initial","inherit","unset"],service:this,propertyType:y.cssValue,styleRule:o,styleDeclaration:a}}),{name:"",type:"addNew",service:this,propertyType:y.complex,styleRule:o}]}))}async setValue(e,t,i){if(t.styleRule?.selector!==null&&t.styleDeclaration){e[0].instanceServiceContainer.stylesheetService.updateDeclarationValue(t.styleDeclaration,i,!1),this._notifyChangedProperty(e[0],t,i);return}if(t.styleRule?.selector!==null&&!t.styleDeclaration){e[0].instanceServiceContainer.stylesheetService.insertDeclarationIntoRule(t.styleRule,t.name,i,!1),this._notifyChangedProperty(e[0],t,i);return}for(let r of e)r.setStyle(t.name,i),r.element.setAttribute("style",r.element.getAttribute("style"))}clearValue(e,t,i){if(t.styleRule?.selector!==null&&t.styleDeclaration){e[0].instanceServiceContainer.stylesheetService.removeDeclarationFromRule(t.styleRule,t.styleDeclaration.name);return}super.clearValue(e,t,i)}getValue(e,t){return t.styleRule?.selector&&t.styleDeclaration?t.styleDeclaration.value:super.getValue(e,t)}getUnsetValue(e,t){return t.styleRule?.selector&&t.styleDeclaration?t.styleDeclaration.value:super.getUnsetValue(e,t)}isSet(e,t){return t.styleRule?.selector&&t.styleDeclaration?e[0].hasStyle(t.name)?B.none:B.fromStylesheet:super.isSet(e,t)}getPropertyTarget(e,t){return t.name.startsWith("--")?M.cssvar:M.css}}});var ti,zl=u(()=>{"use strict";ie();re();Xe();Ie();ns();ti=class extends Jt{removeInheritedCustomProperties;constructor(e=!0){super(),this.name="customProperties",this.removeInheritedCustomProperties=e}getRefreshMode(e){return G.fullOnValueChange}isHandledElement(e){return!0}async getProperty(e,t){return{name:t,type:"string",service:this,propertyType:y.cssValue}}async getProperties(e){if(!e?.element?.computedStyleMap)return null;let t=Array.from(e.instanceServiceContainer.designerCanvas.computedStyleMap()).map(n=>n[0]).filter(n=>n.startsWith("--")),i=Array.from(e.element.computedStyleMap()).map(n=>n[0]).filter(n=>n.startsWith("--"));return this.removeInheritedCustomProperties&&(i=i.filter(n=>!t.includes(n))),i.map(n=>({name:n,service:this,propertyType:y.cssValue}))}clearValue(e,t,i){super.clearValue(e,t,i)}getValue(e,t){let i=e[0].getStyle(t.name);return i||getComputedStyle(e[0].element).getPropertyValue(t.name)}getUnsetValue(e,t){return e?.[0].element?.computedStyleMap?e[0].element.computedStyleMap().get(t.name)?.[0]:null}isSet(e,t){return super.isSet(e,t)==B.bound?B.bound:e[0].hasStyle(t.name)?B.all:B.none}getPropertyTarget(e,t){return M.cssvar}}});var os,Vl=u(()=>{"use strict";$();Ml();Nl();Lt();Fl();zl();ss();os=class{_attachedPropertiesService=new ts;_rootPgList=[{name:"styles",propertiesService:new ei},{name:"css vars",propertiesService:new ti},{name:"layout",propertiesService:new Se("layout")}];_pgList=[{name:"properties",propertiesService:null},{name:"attached",propertiesService:this._attachedPropertiesService},{name:"attributes",propertiesService:new Ri},{name:"common",propertiesService:new ke},{name:"styles",propertiesService:new ei},{name:"css vars",propertiesService:new ti},{name:"layout",propertiesService:new Se("layout")}];_svgPgList=[{name:"properties",propertiesService:null},{name:"attached",propertiesService:this._attachedPropertiesService},{name:"attributes",propertiesService:new Ri},{name:"common",propertiesService:new ke},{name:"styles",propertiesService:new ei},{name:"css vars",propertiesService:new ti},{name:"layout",propertiesService:new Se("layout")},{name:"svg",propertiesService:new Se("svg")}];_gridChild=[{name:"gridChild",propertiesService:new Se("gridChild")}];_grid=[{name:"grid",propertiesService:new Se("grid")}];_flexChild=[{name:"flexChild",propertiesService:new Se("flexChild")}];_flex=[{name:"flex",propertiesService:new Se("flex")}];getPropertygroups(e){if(e==null||e.length==0)return[];if(e[0].nodeType==E.TextNode||e[0].nodeType==E.Comment)return[];if(e[0].isRootItem){let r=e[0].getComputedStyle(),n=this._rootPgList;return r.display.includes("grid")?n=[...n,...this._grid]:r.display.includes("flex")&&(n=[...n,...this._flex]),n}this._pgList[0].propertiesService=e[0].serviceContainer.getLastServiceWhere("propertyService",r=>r.isHandledElement(e[0])),this._svgPgList[0].propertiesService=e[0].serviceContainer.getLastServiceWhere("propertyService",r=>r.isHandledElement(e[0]));let t=this._pgList;e[0].element instanceof e[0].window.SVGElement&&(t=this._svgPgList);let i=e[0].getComputedStyle();if(i.display.includes("grid")?t=[...t,...this._grid]:i.display.includes("flex")&&(t=[...t,...this._flex]),e[0].parent){let r=e[0].parent.getComputedStyle();r.display.includes("grid")?t=[...t,...this._gridChild]:r.display.includes("flex")&&(t=[...t,...this._flexChild])}return t}}});var as,Bl=u(()=>{"use strict";J();as=class extends L{_rect;constructor(e,t,i){super(e,t,i)}extend(){this.refresh()}refresh(){let e=this.designerCanvas.getNormalizedElementCoordinates(this.extendedItem.element),t=getComputedStyle(this.extendedItem.element),i=Number.parseFloat(t.marginLeft.replace("px","")),r=Number.parseFloat(t.marginTop.replace("px","")),n=Number.parseFloat(t.marginRight.replace("px","")),o=Number.parseFloat(t.marginBottom.replace("px",""));this._rect=this._drawRect(e.x-i,e.y-r,i+e.width+n,r+e.height+o,"svg-placement",this._rect)}dispose(){this._removeAllOverlays()}}});import{css as Wp}from"@node-projects/base-custom-webcomponent";var ls,Hl=u(()=>{"use strict";Bl();ls=class{shouldExtend(e,t,i){return!0}getExtension(e,t,i){return new as(e,t,i)}static style=Wp`
  ...
  `;constructor(e,t,i){super(e,t,i),this._size.width=625}extend(e,t){super.extend(e,t),this._addFlexDirectionButton(),this._addStyleButton("flex-wrap"),this._addStyleButton("align-content"),this._addStyleButton("justify-content"),this._addStyleButton("align-items"),this.refresh(e,t)}_addFlexDirectionButton(){let e=getComputedStyle(this.extendedItem.element),t=this._toolbar.getById("flex-direction");t.addEventListener("value-changed",async()=>{await this.extendedItem.updateStyleInSheetOrLocalAsync("flex-direction",t.value),this.rotateImagesAcordingFlexDirection(t.value)}),t.value=e["flex-direction"],this.rotateImagesAcordingFlexDirection(t.value)}rotateImagesAcordingFlexDirection(e){let t=0;(e=="column"||e=="column-reverse")&&(t=-90),this._toolbar.getById("flex-wrap").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("align-content").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("justify-content").querySelectorAll("img").forEach(i=>i.style.rotate=t+"deg"),this._toolbar.getById("align-items").querySelectorAll("img:nth-child(-n+4)").forEach(i=>i.style.rotate=t+"deg")}}});var Ls,yc=u(()=>{"use strict";gc();$();Le();Ls=class{shouldExtend(e,t,i){if(i.nodeType===E.Element){let r=getComputedStyle(i.element).display;if(r==="flex"||r==="inline-flex")return t.instanceServiceContainer.designContext.extensionOptions[Ue]!==!1}return!1}getExtension(e,t,i){return new Os(e,t,i)}}});import{html as im}from"@node-projects/base-custom-webcomponent";var Rs,vc=u(()=>{"use strict";Le();Rs=class extends Ce{static template=im`
    ...
    </div>`;constructor(e,t,i){super(e,t,i),this._size.width=250}extend(e,t){super.extend(e,t);let i=getComputedStyle(this.extendedItem.element),r=this._toolbar.getById("gridColumn");r&&(r.value=i.gridColumn,r.onkeyup=async o=>{o.key==="Enter"&&await this.extendedItem.updateStyleInSheetOrLocalAsync("gridColumn",r.value)});let n=this._toolbar.getById("gridRow");n&&(n.value=i.gridColumn,n.onkeyup=async o=>{o.key==="Enter"&&await this.extendedItem.updateStyleInSheetOrLocalAsync("gridRow",n.value)}),this._addStyleButton("align-self"),this._addStyleButton("justify-self"),this.refresh(e,t)}}});var Vs,wc=u(()=>{"use strict";$();bc();Le();Vs=class{shouldExtend(e,t,i){if(i.nodeType===E.Element&&i.parent){let r=i.parent?.getComputedStyle();if(r!=null&&(r.display==="grid"||r.display==="inline-grid"))return t.instanceServiceContainer.designContext.extensionOptions[Ue]!==!1}return!1}getExtension(e,t,i){return new zs(e,t,i)}}});var Bs,Sc=u(()=>{"use strict";Le();bt();Bs=class extends Ae{constructor(){super(Ue,"T","show Toolbars")}}});var Hs,Cc=u(()=>{"use strict";J();Z();Hs=class extends L{constructor(e,t,i){super(e,t,i)}_path;_path2;extend(e,t){this.refresh(e,t)}refresh(e,t){let i=getComputedStyle(this.extendedItem.element);if(i.padding!=="0px"){let r=Number.parseFloat(i.paddingLeft.replace("px","")),n=Number.parseFloat(i.paddingTop.replace("px","")),o=Number.parseFloat(i.paddingRight.replace("px","")),a=Number.parseFloat(i.paddingBottom.replace("px",""));if(r+=Number.parseFloat(i.borderLeftWidth.replace("px","")),n+=Number.parseFloat(i.borderTopWidth.replace("px","")),o+=Number.parseFloat(i.borderRightWidth.replace("px","")),a+=Number.parseFloat(i.borderBottomWidth.replace("px","")),!isNaN(r)&&!isNaN(n)&&!isNaN(o)&&!isNaN(a)){let l=this.extendedItem.element.getBoxQuads({box:"border",relativeTo:this.designerCanvas.canvas})[0];if(!isNaN(l.p1.x)&&this._valuesHaveChanges(r,n,o,a,l.p1.x,l.p1.y,l.p2.x,l.p2.y,l.p3.x,l.p3.y,l.p4.x,l.p4.y)){let c=this.extendedItem.element.getBoxQuads({box:"content",relativeTo:this.designerCanvas.canvas})[0],h="M"+[l.p1,l.p2,l.p3,l.p4].map(d=>d.x+","+d.y).join(" ")+"Z ";h+="M"+[c.p1,c.p2,c.p3,c.p4].map(d=>d.x+","+d.y).join(" ")+"Z ",this._path=this._drawPath(h,"svg-padding-fill",this._path,I.Background),this._path2=this._drawPath(h,"svg-padding",this._path2,I.Background)}}}}dispose(){this._removeAllOverlays()}}});import{css as Rh}from"@node-projects/base-custom-webcomponent";var Gs,Ec=u(()=>{"use strict";$();Cc();Gs=class{shouldExtend(e,t,i){return i.nodeType==E.Element}getExtension(e,t,i){return new Hs(e,t,i)}static style=Rh`
  ...
  `}});var Zs,Mc=u(()=>{"use strict";$();Zs=class{shouldProvideContextmenu(e,t,i,r){return i!=null&&i.nodeType==E.Element}provideContextMenuItems(e,t,i){return[{title:":hover",action:()=>{i.cssForceHover=!i.cssForceHover},checked:i.cssForceHover},{title:":active",action:()=>{i.cssForceActive=!i.cssForceActive},checked:i.cssForceActive},{title:":visited",action:()=>{i.cssForceVisited=!i.cssForceVisited},checked:i.cssForceVisited},{title:":focus",action:()=>{i.cssForceFocus=!i.cssForceFocus},checked:i.cssForceFocus},{title:":focus-within",action:()=>{i.cssForceFocusWithin=!i.cssForceFocusWithin},checked:i.cssForceFocusWithin},{title:":focus-visible",action:()=>{i.cssForceFocusVisible=!i.cssForceFocusVisible},checked:i.cssForceFocusVisible}]}}});var $s,Nc=u(()=>{"use strict";at();$s=class{constructor(){}provideButtons(e,t){let i=document.createElement("div");return i.innerHTML="O",i.title="options",i.className="toolbar-control",i.onclick=r=>{this.showCtxMenu(r,t)},i.oncontextmenu=r=>{r.preventDefault(),this.showCtxMenu(r,t)},[i]}prepareContextMenu(e,t){return[{title:"simulate hover on hover",checked:t.instanceServiceContainer.designContext.extensionOptions.simulateHoverOnHover,action:()=>{t.instanceServiceContainer.designContext.extensionOptions.simulateHoverOnHover=!t.instanceServiceContainer.designContext.extensionOptions.simulateHoverOnHover}},{title:"select unhitable elements",checked:t.instanceServiceContainer.designContext.extensionOptions.selectUnhitableElements,action:()=>{t.instanceServiceContainer.designContext.extensionOptions.selectUnhitableElements=!t.instanceServiceContainer.designContext.extensionOptions.selectUnhitableElements}},{title:"pause animations",checked:t.pauseAnimations,action:()=>{t.pauseAnimations=!t.pauseAnimations}},{title:"hide overflowing content",checked:t.instanceServiceContainer.designContext.extensionOptions.hideOverflowingContent,action:()=>{if(t.instanceServiceContainer.designContext.extensionOptions.hideOverflowingContent=!t.instanceServiceContainer.designContext.extensionOptions.hideOverflowingContent,t.instanceServiceContainer.designContext.extensionOptions.hideOverflowingContent)for(let r of t.rootDesignItem.children(!0))r.element instanceof HTMLElement&&(r.element.style.overflow="hidden",r.element.style.whiteSpace="nowrap");else for(let r of t.rootDesignItem.children(!0))r.element instanceof HTMLElement&&(r.element.style.overflow=r.hasStyle("overflow")?r.getStyle("overflow"):"",r.element.style.whiteSpace=r.hasStyle("white-space")?r.getStyle("white-space"):"")}}]}showCtxMenu(e,t){he.show(this.prepareContextMenu(e,t),e)}}});var qs,Oc=u(()=>{"use strict";Q();qs=class{shouldProvideContextmenu(e,t,i,r){return r=="designer"}provideContextMenuItems(e,t,i){if(i){let r=[...i.element.children];if(r.length>0)return[{title:"children",children:[...r.map(n=>({title:"select: "+n.localName+(n.id?" (#"+n.id+")":""),action:()=>this._select(t,n)}))]}]}return[]}_select(e,t){let i=T.GetOrCreateDesignItem(t,t,e.serviceContainer,e.instanceServiceContainer);e.instanceServiceContainer.selectionService.setSelectedElements([i])}}});var ri,Lc=u(()=>{"use strict";ee();$e();ri=class{cursor="pointer";_changeGroup;pointerEventHandler(e,t,i){e.serviceContainer.designerTools.get(U.Pointer).pointerEventHandler(e,t,i)}keyboardEventHandler(e,t,i){t.preventDefault();let r=e.instanceServiceContainer.selectionService.primarySelection,n=getComputedStyle(r.element),o="";switch(t.key){case"ArrowLeft":o="margin-left";break;case"ArrowRight":o="margin-right";break;case"ArrowUp":o="margin-top";break;case"ArrowDown":o="margin-bottom";break}o&&(t.type==x.KeyDown&&!this._changeGroup&&(this._changeGroup=r.openGroup("change margin")),this._changeGroup&&(r.setStyleAsync(o,parseFloat(n[o])+(t.altKey?-1:1)+"px"),t.type==x.KeyUp&&(this._changeGroup.commit(),this._changeGroup=null)))}activated(e){}dispose(){this._changeGroup&&(this._changeGroup.abort(),this._changeGroup=null)}}});var Gi,Rc=u(()=>{"use strict";We();Gi=class{_name;_icon;constructor(e,t){this._name=e,this._icon=t}provideButton(e){let t={};return t[this._name]={icon:this._icon},new se(e,t)}}});var ni,Fc=u(()=>{"use strict";ee();$e();ni=class{cursor="pointer";_changeGroup;pointerEventHandler(e,t,i){e.serviceContainer.designerTools.get(U.Pointer).pointerEventHandler(e,t,i)}keyboardEventHandler(e,t,i){t.preventDefault();let r=e.instanceServiceContainer.selectionService.primarySelection,n=getComputedStyle(r.element),o="";switch(t.key){case"ArrowLeft":o="padding-left";break;case"ArrowRight":o="padding-right";break;case"ArrowUp":o="padding-top";break;case"ArrowDown":o="padding-bottom";break}o&&(t.type==x.KeyDown&&!this._changeGroup&&(this._changeGroup=r.openGroup("change padding")),this._changeGroup&&(r.setStyleAsync(o,parseFloat(n[o])+(t.altKey?-1:1)+"px"),t.type==x.KeyUp&&(this._changeGroup.commit(),this._changeGroup=null)))}activated(e){}dispose(){this._changeGroup&&(this._changeGroup.abort(),this._changeGroup=null)}}});var si,Qs=u(()=>{"use strict";Q();si=class{createDesignItem(e,t,i,r){return new T(e,t,i,r)}handleSpecialAttributes(e,t){e==Ft?(t.element instanceof(t.node.ownerDocument.defaultView??window).HTMLElement||t.element instanceof(t.node.ownerDocument.defaultView??window).SVGElement)&&(t.hasAttribute(Ft)?t.element.style.display="none":t.element.style.display=t.getStyle("display")??""):e==zt?(t.element instanceof(t.node.ownerDocument.defaultView??window).HTMLElement||t.element instanceof(t.node.ownerDocument.defaultView??window).SVGElement)&&(t.hasAttribute(zt)?t.element.style.opacity="0.3":t.element.style.opacity=t.getStyle("opacity")??""):e==St&&(t.element instanceof(t.node.ownerDocument.defaultView??window).HTMLElement||t.element instanceof(t.node.ownerDocument.defaultView??window).SVGElement)&&(t.hasAttribute(St)?t.element.style.pointerEvents="none":requestAnimationFrame(()=>t.element.style.pointerEvents="auto"))}}});import{DomHelper as om}from"@node-projects/base-custom-webcomponent";var Js,zc=u(()=>{"use strict";Js=class{constructor(e){this.title="Delete Items",this.deletedItems=e}title;get affectedItems(){return this.deletedItems}undo(){for(let e=0;e<this.deletedItems.length;e++)this._parentItems[e]._insertChildInternal(this.deletedItems[e],this._parentIndexes[e]);this.affectedItems[0].instanceServiceContainer.contentService.onContentChanged.emit({changeType:"added",designItems:this.deletedItems})}do(){this._parentItems=[],this._parentIndexes=[];for(let e=0;e<this.deletedItems.length;e++)this._parentItems.push(this.deletedItems[e].parent),this._parentIndexes.push(om.nodeIndex(this.deletedItems[e].element));for(let e=0;e<this.deletedItems.length;e++)this.deletedItems[e].parent._removeChildInternal(this.deletedItems[e]);this.affectedItems[0].instanceServiceContainer.contentService.onContentChanged.emit({changeType:"removed",designItems:this.deletedItems})}deletedItems;_parentItems;_parentIndexes;mergeWith(e){return!1}}});var eo,Vc=u(()=>{"use strict";zc();eo=class{removeItems(e){e[0].instanceServiceContainer.undoService.execute(new Js(e))}}});var Vh={};Sd(Vh,{createDefaultServiceContainer:()=>Fh,default:()=>zh});function Fh(){let s=new tr,e=new Be;return s.register("containerService",e),s.register("containerService",new Sn(e)),s.register("containerService",new En(e)),s.register("propertyService",new Ks),s.register("propertyService",new sr),s.register("propertyService",new or),s.register("propertyService",new ar),s.register("propertyService",new lr),s.register("propertyService",new Is),s.register("propertyService",new Fr),s.register("propertyService",new Mr),s.register("propertyGroupsService",new os),s.register("instanceService",new _r),s.register("editorTypesService",new Tr),s.register("htmlWriterService",new Hn),s.register("snaplinesProviderService",new An),s.register("htmlParserService",new ht),s.register("elementAtPointService",new Cn),s.register("externalDragDropService",new Pn),s.register("dragDropService",new Cs),s.register("copyPasteService",new Mn),s.register("modelCommandService",new Nn),s.register("demoProviderService",new Es),s.register("eventsService",new ye),s.register("designItemService",new si),s.register("deletionService",new eo),s.register("undoService",t=>new us(t)),s.register("selectionService",t=>new gs(t,!1)),s.register("contentService",t=>new ys(t.rootDesignItem)),s.register("designItemDocumentPositionService",t=>new _s(t)),s.designerExtensions.set(w.Permanent,[new _n]),s.designerExtensions.set(w.PrimarySelection,[new it(new Ss,t=>!(t.node instanceof t.window.SVGElement)||t.node instanceof t.window.SVGSVGElement)]),s.designerExtensions.set(w.Selection,[new it(new Qr,t=>!(t.node instanceof t.window.SVGElement)||t.node instanceof t.window.SVGSVGElement)]),s.designerExtensions.set(w.OnlyOneItemSelected,[new it(new Vr,t=>!(t.node instanceof t.window.SVGElement)||t.node instanceof t.window.SVGSVGElement),new it(new Xs,t=>!(t.node instanceof t.window.SVGElement)||t.node instanceof t.window.SVGSVGElement),new it(new jr,(t,i)=>i.activeTool instanceof ri||i.activeTool instanceof ni,!0),new it(new Gs,(t,i)=>i.activeTool instanceof ri||i.activeTool instanceof ni,!0),new Kr,new Ts,new ii(new js,new rn(!0)),new Gr(!0),new sn]),s.designerExtensions.set(w.PrimarySelectionRefreshed,[new Vs,new Ns,new Ls,new Fs]),s.designerExtensions.set(w.PrimarySelectionAndCanBeEntered,[new It,new Vi,new zi]),s.designerExtensions.set(w.PrimarySelectionContainerAndCanBeEntered,[new It("lightgray","#8080802b"),new Vi,new zi]),s.designerExtensions.set(w.MouseOver,[new Xr]),s.designerExtensions.set(w.Placement,[new ls]),s.designerExtensions.set(w.ContainerDrag,[new gn]),s.designerExtensions.set(w.ContainerDragOverAndCanBeEntered,[new ii(new It,new Li),new vn]),s.designerExtensions.set(w.ContainerExternalDragOverAndCanBeEntered,[new ii(new It,new Li)]),s.designerExtensions.set(w.Doubleclick,[new In]),s.designerPointerExtensions.push(),s.designerTools.set(U.Pointer,new Zr),s.designerTools.set(U.DrawSelection,new Pi),s.designerTools.set(U.DrawPath,new $r),s.designerTools.set(U.DrawRect,new Rn),s.designerTools.set(U.DrawEllipsis,new Fn),s.designerTools.set(U.DrawLine,new zn),s.designerTools.set(U.Zoom,new on),s.designerTools.set(U.Pan,new an),s.designerTools.set(U.RectangleSelector,new Pi),s.designerTools.set(U.MagicWandSelector,new dn),s.designerTools.set(U.PickColor,new pn),s.designerTools.set(U.Text,new un),s.designerTools.set(U.DrawElementTool,As),s.designerTools.set(U.Margin,new ri),s.designerTools.set(U.Padding,new ni),s.designViewConfigButtons.push(new et(20),new Ln,new ds,new et(10),new ps,new et(10),new mr,new et(10),new Bs,new et(30),new Ps,new et(30),new $s),s.designViewToolbarButtons.push(new Zn,new je(22),new Jn,new je(22),new Gi("Margin",v+"images/tools/Margin.svg"),new je(22),new Gi("Padding",v+"images/tools/Padding.svg"),new je(22),new $n,new je(22),new qn,new je(22),new Qn,new je(22),new bs),s.designerContextMenuExtensions=[new kt("edit",new ln),new we,new kt("modify",new Yn,new we,new cn,new we,new Us),new we,new kt("view",new vs,new Kn),new we,new kt("force",new Zs),new we,new hn,new Wn,new Gn,new we,new Xn,new we,new wn,new qs],s}var zh,to=u(()=>{"use strict";Ao();Po();Io();ko();Do();Uo();na();sa();Wt();Ai();la();De();pa();ga();va();_a();wa();$e();Ca();Ea();Pa();Ta();Na();Oa();La();Ra();Fa();Va();Ba();Ha();Ga();ja();Ka();Xa();bn();qa();Qa();Ja();el();tl();il();rl();sl();al();ll();hl();dl();pl();ml();fl();gl();yl();jn();vl();xl();_l();wl();Sl();Cl();Al();Pl();kl();Tl();Vl();Hl();hs();jl();Ul();Yl();Xl();Zl();fr();$l();Ql();Di();Jl();ec();ic();nc();sc();Hi();oc();ac();lc();cc();pc();mc();fc();yc();xc();_c();wc();Sc();Ec();Pc();Ic();kc();Tc();Mc();Nc();Oc();Lc();Rc();q();Fc();Qs();Vc();zh=Fh});import{BaseCustomWebComponentLazyAppend as Cd,css as Ed,TypedEvent as Ad,DomHelper as rh}from"@node-projects/base-custom-webcomponent";var Ye=class extends Cd{_selectedIndex=-1;_panels;_headerDiv;_moreDiv;_moreContainer;_elementMap=new WeakMap;_firstConnect=!0;static style=Ed`
        :host {
            height: 100%;
        }
        .outer {
...
`}else r.displayHtml?a.innerHTML=r.displayHtml:a.innerText=r.name?r.name:r.tag;a.draggable=!0,a.ondragstart=c=>{if(c.dataTransfer.setData(Bt,JSON.stringify(r)),c.currentTarget.style.outline="dashed",r.ghostElement)if(typeof r.ghostElement=="string"){let h=document.createRange();h.selectNode(document.body);let p=h.createContextualFragment(r.ghostElement).firstChild;p.style.position="absolute",p.style.top="-1000px",document.body.appendChild(p),c.dataTransfer.setDragImage(p,0,0),requestAnimationFrame(()=>document.body.removeChild(p))}else c.dataTransfer.setDragImage(r.ghostElement,0,0);else if(!r.import)try{let h=document.createElement(r.tag);if(r.defaultContent&&(h.innerHTML=r.defaultContent),r.defaultWidth&&(h.style.width=r.defaultWidth),r.defaultHeight&&(h.style.height=r.defaultHeight),r.defaultAttributes)for(let p in r.defaultAttributes)h.setAttribute(p,r.defaultAttributes[p]);if(r.defaultStyles)for(let p in r.defaultStyles)h.style[p]=r.defaultStyles[p];h.style.position="absolute",r.defaultWidth?h.style.top="-"+(parseInt(r.defaultHeight)+500)+"px":h.style.top="-500px",r.defaultWidth?h.style.left="-"+(parseInt(r.defaultWidth)+500)+"px":h.style.left="-500px",document.body.appendChild(h);let d=h.getBoundingClientRect();d.width>0&&d.height>0&&c.dataTransfer.setDragImage(h,0,0),requestAnimationFrame(()=>document.body.removeChild(h))}catch(h){console.warn("error creating gost elment",h)}},a.ondragend=c=>{r.import=null,c.currentTarget.style.outline="none"},a.ontouchstart=c=>{c.preventDefault()},a.onclick=c=>{let h=e.designerTools.get(r.tool??U.DrawElementTool);typeof h=="function"&&(h=new h(r)),e.globalContext.tool=h},o.appendChild(a),n.appendChild(o);let l=document.createElement("td");l.innerText=r.description??"",n.appendChild(l),this._table.appendChild(n)}}};customElements.define("node-projects-palette-elements",Yi);import{BaseCustomWebComponentLazyAppend as Km,css as Ym}from"@node-projects/base-custom-webcomponent";var Kc=class extends Km{selected="native";_designerTabControl;static style=Ym`
    :host {
      display: flex;
      flex-direction: column;
      flex: 1;
      height: 100%;
    }`;constructor(){super(),this._restoreCachedInititalValues(),this._designerTabControl=new Ye,this._designerTabControl.selectedIndex=0,this.shadowRoot.appendChild(this._designerTabControl)}async loadControls(e,t){this._designerTabControl.innerHTML="";for(let i of t)try{let r=await i.getElements(),n=new Yi;n.title=i.name,this._designerTabControl.appendChild(n),n.loadElements(e,r)}catch(r){console.warn("Error loading elements",r)}this._designerTabControl.refreshItems()}};customElements.define("node-projects-palette-view",Kc);Q();import{BaseCustomWebComponentLazyAppend as Xm,css as Zm}from"@node-projects/base-custom-webcomponent";var Yc=class extends Xm{_items;_index;_previouslySelected;_treeDiv;_instanceServiceContainer;_selectionChangedHandler;_contentChangedHandler;_mapElementTreeitem;_rootItem;static style=Zm`
    :host {
      --horz-margin: 20px;
      --vert-margin: 0px;
    ...
    <div id="split" style="--split: 50;">
    ...
    </div>`;static properties={orientation:String};orientation="vertical";constructor(){super()}ready(){this._parseAttributesToProperties(),this.setAttribute("orientation",this.orientation);let e=this._getDomElement("split"),t=this._getDomElement("splitter"),i=null;t.addEventListener("pointerdown",r=>{t.setPointerCapture(r.pointerId),i=!0}),t.addEventListener("pointerup",r=>{t.releasePointerCapture(r.pointerId),i=null}),t.addEventListener("pointermove",r=>{if(i!==null){let n=parseFloat(e.style.getPropertyValue("--split"));this.orientation==="horizontal"?n+=r.movementX*100/e.clientWidth:n+=r.movementY*100/e.clientHeight,isNaN(n)||e.style.setProperty("--split",n)}})}};customElements.define("node-projects-simple-split-view",Xi);Pe();De();var z;(function(s){s[s.designer=0]="designer",s[s.code=1]="code",s[s.split=2]="split",s[s.preview=3]="preview"})(z||(z={}));var Zc=class extends Jm{designerView;codeView;demoView;additionalData;_firstLoad=!0;_stylesheetChangedEventRegistered;_additionalStyle;set additionalStyleString(e){this._additionalStyle=e,this.designerView.additionalStyles=[tu(e)]}get additionalStyleString(){return this._additionalStyle}_additionalStyles;set additionalStyles(e){this._additionalStyles=e,this.designerView.additionalStyles=this._additionalStyles}get additionalStyles(){return this._additionalStyles}_additionalStylesheets;set additionalStylesheets(e){this._additionalStylesheets=e,this.designerView.instanceServiceContainer.stylesheetService&&(this.designerView.instanceServiceContainer.stylesheetService.setStylesheets(e),this._stylesheetChangedEventRegistered||(this._stylesheetChangedEventRegistered=!0,this.designerView.instanceServiceContainer.stylesheetService.stylesheetChanged.on(t=>this.additionalStylesheetChanged.emit({name:t.name,newStyle:t.newStyle,oldStyle:t.oldStyle,changeSource:t.changeSource}))))}get additionalStylesheets(){return this._additionalStylesheets}additionalStylesheetChanged=new Xc;onContentChanged=new Xc;onTabChanged=new Xc;_contentChangeSource="designer";_serviceContainer;_content="";_tabControl;_selectionPosition;_splitDiv;_designerDiv;_codeDiv;refreshInSplitViewDebounced;_disableChangeNotificationDesigner;_disableChangeNotificationEditor;static get style(){return eu`
      div {
        height: 100%;
        display: flex;
        flex-direction: column;
      ...
      `}constructor(e,t,i=!1){super(),this.refreshInSplitViewDebounced=iu(this.refreshInSplitView,200),this._serviceContainer=e,t!=null&&(this._content=t);let r=document.createElement("div");this._tabControl=new Ye,r.appendChild(this._tabControl),this.designerView=new Dt(i),this.designerView.setAttribute("exportparts","canvas"),this.designerView.slot="top",this._designerDiv=document.createElement("div"),this._tabControl.appendChild(this._designerDiv),this._designerDiv.title="Designer",this._designerDiv.appendChild(this.designerView),this.designerView.initialize(this._serviceContainer),this.designerView.instanceServiceContainer.documentContainer=this,this.designerView.instanceServiceContainer.selectionService.onSelectionChanged.on(n=>this.designerSelectionChanged(n)),this.designerView.designerCanvas.onContentChanged.on(()=>this.designerContentChanged()),this.codeView=new e.config.codeViewWidget,this.codeView.slot="bottom",this.codeView.style.position="relative",this._codeDiv=document.createElement("div"),this._tabControl.appendChild(this._codeDiv),this._codeDiv.title="Code",this._codeDiv.style.position="relative",this._codeDiv.appendChild(this.codeView),this.codeView.onTextChanged.on(n=>{this._disableChangeNotificationDesigner||(this._tabControl.selectedIndex===z.code||this._tabControl.selectedIndex===z.split)&&(this._disableChangeNotificationEditor=!0,this._content=n,this.refreshInSplitViewDebounced())}),this._splitDiv=new Xi,this._splitDiv.style.height="100%",this._splitDiv.title="Split",this._tabControl.appendChild(this._splitDiv),e.config.demoViewWidget&&(this.demoView=new e.config.demoViewWidget,this.demoView.title="Preview",this._tabControl.appendChild(this.demoView)),queueMicrotask(()=>{this.shadowRoot.appendChild(r),this._tabControl.selectedIndex=z.designer})}async refreshInSplitView(){try{await this.updateDesignerHtml()}catch(e){console.error(e)}this._disableChangeNotificationEditor=!1}get currentView(){return this._tabControl.selectedIndex==z.designer?"designer":this._tabControl.selectedIndex==z.split?"split":this._tabControl.selectedIndex==z.code?"code":this._tabControl.selectedIndex==z.preview?"preview":null}set currentView(e){e=="designer"&&(this._tabControl.selectedIndex=z.designer),e=="split"&&(this._tabControl.selectedIndex=z.split),e=="code"&&(this._tabControl.selectedIndex=z.code),e=="preview"&&(this._tabControl.selectedIndex=z.preview)}designerSelectionChanged(e){if(this._tabControl.selectedIndex===z.split){let t=this.instanceServiceContainer.selectionService.primarySelection;t&&this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(t),this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null)}}designerContentChanged(){if(this.onContentChanged.emit({source:this._contentChangeSource}),!this._disableChangeNotificationEditor){if(this._disableChangeNotificationDesigner=!0,this._tabControl.selectedIndex===z.code||this._tabControl.selectedIndex===z.split){let e=this.instanceServiceContainer.selectionService.primarySelection;this._content=this.designerView.getDesignerHTML(),this.codeView.update(this._content,this.designerView.instanceServiceContainer),e&&this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(e),this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null)}this._disableChangeNotificationDesigner=!1}}dispose(){this.codeView.dispose(),this.demoView.dispose()}executeCommand(e){this._tabControl.selectedIndex===z.designer||this._tabControl.selectedIndex===z.split?this.designerView.executeCommand(e):this._tabControl.selectedIndex===z.code?this.codeView.executeCommand(e):this._tabControl.selectedIndex===z.preview&&this.demoView.executeCommand(e)}canExecuteCommand(e){if(this._tabControl.selectedIndex===z.designer||this._tabControl.selectedIndex===z.split){if(this.designerView?.canExecuteCommand)return this.designerView.canExecuteCommand(e)}else if(this._tabControl.selectedIndex===z.code){if(this.codeView?.canExecuteCommand)return this.codeView.canExecuteCommand(e)}else if(this._tabControl.selectedIndex===z.preview&&this.demoView?.canExecuteCommand)return this.demoView.canExecuteCommand(e);return!1}async setContentAsync(e){this._content=e,this._tabControl&&(this._tabControl.selectedIndex===z.designer?await this.updateDesignerHtml():this._tabControl.selectedIndex===z.code?this.codeView.update(this._content,this.designerView.instanceServiceContainer):this._tabControl.selectedIndex===z.split||this._tabControl.selectedIndex===z.preview&&this.demoView.display(this._serviceContainer,this.designerView.instanceServiceContainer,this._content,this.additionalStyleString))}set content(e){this.setContentAsync(e)}get content(){return this._tabControl?(this._tabControl.selectedIndex===z.designer?this._content=this.designerView.getDesignerHTML():this._tabControl.selectedIndex===z.code&&(this._content=this.codeView.getText()),this._content):null}ready(){this._tabControl.onSelectedTabChanged.on(e=>{if(e.oldIndex===z.designer){let t=this.instanceServiceContainer.selectionService.primarySelection;this._content=this.designerView.getDesignerHTML(),this.designerView.instanceServiceContainer.designItemDocumentPositionService&&(this._selectionPosition=this.designerView.instanceServiceContainer.designItemDocumentPositionService.getPosition(t))}else e.oldIndex===z.code?this._content=this.codeView.getText():e.oldIndex===z.split?(this._designerDiv.appendChild(this.designerView),this._codeDiv.appendChild(this.codeView)):e.oldIndex===z.preview&&this.demoView?.stopDisplay&&this.demoView.stopDisplay();(e.newIndex===z.designer||e.newIndex===z.split)&&this.updateDesignerHtml(),(e.newIndex===z.code||e.newIndex===z.split)&&(this.codeView.update(this._content,this.designerView.instanceServiceContainer),this._selectionPosition&&(this.codeView.setSelection(this._selectionPosition),lt(20).then(t=>{this._selectionPosition&&this.codeView.setSelection(this._selectionPosition),this._selectionPosition=null})),e.changedViaClick&&this.codeView.focusEditor()),e.newIndex===z.split&&(this._splitDiv.appendChild(this.designerView),this._splitDiv.appendChild(this.codeView)),e.newIndex===z.preview&&this.demoView.display(this._serviceContainer,this.designerView.instanceServiceContainer,this._content,this.additionalStyleString),this._content&&(this._firstLoad=!1),this.onTabChanged.emit({oldTab:z[e.oldIndex],newTab:z[e.newIndex]})}),this._content&&(this.content=this._content,this._firstLoad=!1)}async updateDesignerHtml(){if(this._firstLoad)return this.designerView.parseDesignerHTML(this._content,this._firstLoad);if(this.designerView.getDesignerHTML()!=this._content){this._contentChangeSource="code",await this.designerView.parseDesignerHTML(this._content,this._firstLoad),this._contentChangeSource="designer";return}else this.instanceServiceContainer.undoService.clearTransactionstackIfNotEmpty(),this.designerView.designerCanvas.overlayLayer.removeAllOverlays(),this.designerView.designerCanvas.extensionManager.reapplyAllAppliedExtentions(null,[w.Permanent,w.Selection,w.PrimarySelection,w.PrimarySelectionContainer,w.OnlyOneItemSelected,w.MultipleItemsSelected])}get instanceServiceContainer(){return this.designerView.instanceServiceContainer}};customElements.define("node-projects-document-container",Zc);ee();Sa();Qe();q();to();export{oo as AbsolutePlacementService,ut as AbstractBaseToolPopup,Jt as AbstractCssPropertiesService,Ae as AbstractDesignViewConfigButton,yo as AbstractDesignerPointerExtension,L as AbstractExtension,Bn as AbstractHtmlWriterService,Fe as AbstractPolymerLikePropertiesService,Y as AbstractPropertiesService,lo as AbstractStylesheetService,Us as AlignItemsContextMenu,yn as AltToEnterContainerExtension,vn as AltToEnterContainerExtensionProvider,Wh as AlwaysAbsolutePlacementService,ii as ApplyFirstMachingExtensionProvider,ts as AttachedPropertiesService,yi as AttributeAndPropertyChangeAction,gi as AttributeChangeAction,Ri as AttributesPropertiesService,Mr as BaseCustomWebComponentPropertiesService,Gh as BaseCustomWebcomponentBindingsService,Kh as BaseCustomWebcomponentDesignItemService,X as BasePropertyEditor,Nt as BaseServiceContainer,Ce as BasicStackedToolbarExtension,Ks as BasicWebcomponentPropertiesService,Hh as BindableObjectType,Wi as BindingMode,M as BindingTarget,id as BindingsRefactorService,Rs as BlockToolbarExtension,Fs as BlockToolbarExtensionProvider,Ar as BooleanPropertyEditor,et as ButtonSeperatorProvider,ms as ChangeGroup,kt as ChildContextMenu,qs as ChildrenContextMenu,ui as CodeViewSimple,br as ColorPropertyEditor,S as CommandType,ke as CommonPropertiesService,it as ConditionExtensionProvider,ao as ContentAndIdPropertiesService,ys as ContentService,he as ContextMenu,jh as CopyPasteAsJsonService,ln as CopyPasteContextMenu,Mn as CopyPasteService,hr as CssAttributeParser,Qt as CssCombiner,ei as CssCurrentPropertiesService,ti as CssCustomPropertiesService,cr as CssEntry,Se as CssPropertiesService,Rt as CssStyleChangeAction,vo as CursorLinePointerExtension,cd as CursorLinePointerExtensionProvider,wr as DatePropertyEditor,Uc as DebugView,jc as DefaultConfiguredDesignerView,Tr as DefaultEditorTypesService,ht as DefaultHtmlParserService,_r as DefaultInstanceService,Nn as DefaultModelCommandService,Be as DefaultPlacementService,Js as DeleteAction,eo as DeletionService,pi as DemoView,T as DesignItem,_s as DesignItemDocumentPositionService,si as DesignItemService,hi as DesignerCanvas,Ye as DesignerTabControl,Ki as DesignerToolbar,se as DesignerToolbarButton,Dt as DesignerView,On as DisplayGridExtension,It as DisplayGridExtensionProvider,Zc as DocumentContainer,K as DomConverter,Cs as DragDropService,As as DrawElementTool,Fn as DrawEllipsisTool,zn as DrawLineTool,$r as DrawPathTool,Rn as DrawRectTool,qn as DrawToolButtonProvider,Ni as DrawToolPopup,xs as EditGridColumnRowSizesExtension,Vi as EditGridColumnRowSizesExtensionProvider,Zt as EditTextExtension,In as EditTextExtensionProvider,Cn as ElementAtPointService,_e as ElementDisplayType,zr as ElementDragTitleExtension,Vr as ElementDragTitleExtensionProvider,x as EventNames,ye as EventsService,fo as ExtensionManager,w as ExtensionType,Pn as ExternalDragDropService,En as FlexBoxPlacementService,Os as FlexToolbarExtension,Ls as FlexToolbarExtensionProvider,cs as FlexboxExtension,ds as FlexboxExtensionDesignViewConfigButtons,zi as FlexboxExtensionProvider,Zs as ForceCssContextMenu,Zh as FormatingHtmlWriterService,es as GrayOutDragOverContainerExtension,Li as GrayOutDragOverContainerExtensionProvider,fn as GrayOutExtension,gn as GrayOutExtensionProvider,is as GridAssignedRowColumnPropertyEditor,Ws as GridChildResizeExtension,js as GridChildResizeExtensionProvider,zs as GridChildToolbarExtension,Vs as GridChildToolbarExtensionProvider,Ln as GridExtensionDesignViewConfigButtons,Sn as GridPlacementService,Ms as GridToolbarExtension,Ns as GridToolbarExtensionProvider,Yr as HighlightElementExtension,Xr as HighlightElementExtensionProvider,Hn as HtmlWriterService,Uh as IframeDemoProviderService,Pr as ImageButtonListPropertyEditor,dr as IndentedTextWriter,oe as InsertAction,ot as InsertChildAction,mo as InstanceServiceContainer,xn as InvisibleElementExtension,ps as InvisibleElementExtensionDesignViewConfigButtons,_n as InvisibleElementExtensionProvider,wn as ItemsBelowContextMenu,Yh as JsonFileElementsService,Sr as JsonPropertyEditor,Jh as JsonPropertyPopupEditor,vs as JumpToElementContextMenu,ed as ListPropertiesService,Fr as Lit2PropertiesService,or as LitElementPropertiesService,$h as LitTsElementWriterService,dn as MagicWandSelectorTool,Wr as MarginExtension,jr as MarginExtensionProvider,ri as MarginTool,Is as MathMLElementsPropertiesService,rs as MetricsPropertyEditor,Qh as MultiplayerService,hn as MultipleItemsSelectedContextMenu,ws as MultipleSelectionRectExtension,Ss as MultipleSelectionRectExtensionProvider,U as NamedTools,ar as NativeElementsPropertiesService,E as NodeType,Bh as NpmPackageLoader,Cr as NumberPropertyEditor,io as ObservedCustomElementsRegistry,$s as OptionsContextMenuButton,I as OverlayLayer,ci as OverlayLayerView,Hs as PaddingExtension,Gs as PaddingExtensionProvider,ni as PaddingTool,Yi as PaletteElements,Kc as PaletteView,an as PanTool,Wn as PathContextMenu,go as PathExtension,ld as PathExtensionProvider,pn as PickColorTool,as as PlacementExtension,ls as PlacementExtensionProvider,So as PlainScrollbar,le as PointerActionType,Zr as PointerTool,Zn as PointerToolButtonProvider,Mi as PointerToolPopup,sr as PolymerPropertiesService,Ur as PositionExtension,Kr as PositionExtensionProvider,no as PreDefinedElementsService,Ys as PreviousElementSelectExtension,Xs as PreviousElementSelectExtensionProvider,N as PropertiesHelper,yr as PropertyChangeAction,Hc as PropertyGrid,Ee as PropertyGridPropertyList,Gc as PropertyGridWithHeader,os as PropertyGroupsService,y as PropertyType,Gn as RectContextMenu,Pi as RectangleSelectorTool,_o as RefactorView,G as RefreshMode,tn as ResizeExtension,rn as ResizeExtensionProvider,nn as RotateExtension,sn as RotateExtensionProvider,Yn as RotateLeftAndRight,Ps as RoundPixelsDesignViewConfigButton,lr as SVGElementsPropertiesService,oi as Screenshot,Xn as SelectAllChildrenContextMenu,Si as SelectPropertyEditor,qr as SelectionDefaultExtension,Qr as SelectionDefaultExtensionProvider,gs as SelectionService,Oi as SelectionToolPopup,Jn as SelectorToolButtonProvider,we as SeperatorContextMenu,je as SeperatorToolProvider,tr as ServiceContainer,ho as SetDesignItemsAction,Es as SimpleDemoProviderService,Gi as SimpleToolButtonProvider,An as SnaplinesProviderService,co as StylesheetChangedAction,mr as StylesheetServiceDesignViewConfigButtons,Ds as SvgElementExtension,Ts as SvgElementExtensionProvider,gr as TextContentChangeAction,Er as TextPropertyEditor,rd as TextRefactorService,un as TextTool,Qn as TextToolButtonProvider,kr as ThicknessPropertyEditor,Bs as ToolbarExtensionsDesignViewConfigButtons,ro as TouchGestureHelper,Hr as TransformOriginExtension,Gr as TransformOriginExtensionProvider,bs as TransformToolButtonProvider,Bi as TransformToolPopup,Yc as TreeView,us as UndoService,td as UnkownElementsPropertiesService,B as ValueType,so as WebcomponentManifestElementsService,Xh as WebcomponentManifestEventsService,qh as WebcomponentManifestParserService,ai as WebcomponentManifestPropertiesService,cn as ZMoveContextMenu,Kn as ZoomToElementContextMenu,on as ZoomTool,$n as ZoomToolButtonProvider,Ef as arraysEqual,v as assetsPath,Ue as basicStackedToolbarExtensionOverlayOptionName,yh as calculateAlpha,Ve as calculateNormLegth,nr as calculateOuterRect,Bc as calculateSpecificity,b_ as copyTextToClipboard,Ii as copyToClipboard,zh as createDefaultServiceContainer,Me as createPathD,Vo as dataURItoBlob,dh as deepValue,Ct as dragDropFormatNameBindingObject,Bt as dragDropFormatNameElementDefinition,ea as dragDropFormatNamePropertyGrid,ur as enableStylesheetService,zo as exportData,ne as filterChildPlaceItems,aa as filterNonElementItems,Wl as flexboxExtensionShowOverlayOptionName,vi as forceActiveAttributeName,_i as forceFocusAttributeName,wi as forceFocusVisibleAttributeName,bi as forceFocusWithinAttributeName,ct as forceHoverAttributeName,xi as forceVisitedAttributeName,Pu as getActiveElement,W as getBoundingClientRectAlsoForDisplayContents,lh as getContentBoxContentOffsets,Lr as getDesignItemCurrentPos,ah as getElementDisplaytype,Iu as getElementOffsetParent,ku as getElementOffsetsInContainer,Du as getElementsWindowOffsetWithoutSelfAndParentTransformations,Dn as getFromClipboard,oh as getParentElementIncludingSlots,kn as getTextFromClipboard,ki as gridExtensionShowOverlayOptionName,j as hasCommandKey,Ft as hideAtDesignTimeAttributeName,zt as hideAtRunTimeAttributeName,Au as inDesigner,st as instanceOf,fi as instanceOfAny,$a as invisibleElementExtensionShowOverlayOptionName,hh as isAppleDevice,rr as isEmptyTextNode,vr as isFirefox,xt as isInline,_t as isInlineAfter,St as lockAtDesignTimeAttributeName,vh as moveSVGPath,ir as newElementFromString,en as normalizeToAbsolutePosition,Rr as placeDesignItem,Bo as pointInRect,Dh as positionsJsonMime,Cp as provideSnaplinesWithDistance,Ep as provideSnaplinesWithDistanceDistance,de as removeLeading,wt as removeTrailing,Cf as requestAnimationFramePromise,O as roundValue,Ho as setDeepValue,Ih as shadowrootGetSelection,lt as sleep,Ze as straightenLine,Ah as switchContainer,Vt as w3color,kh as wrapSelectionInSpans};
// @license
