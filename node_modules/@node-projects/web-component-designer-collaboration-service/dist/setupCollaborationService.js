import { ExtensionType, SeperatorContextMenu } from "@node-projects/web-component-designer";
...
export function setupCollaborationService(serviceContainer) {
    serviceContainer.register("collaborationService", (designerCanvas) => new DefaultCollaborationService(designerCanvas));
