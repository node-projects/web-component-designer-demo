import { getCollaborationNodeIndex } from '@node-projects/web-component-designer';
...
export class CollaborationCommentsContextMenu {
    ...
    createCommentMenuItem(comment, collaborationService, designItem) {
        return {
