...
function cssColorToColorRef(color) {
...
export class EMFWriter {
    ...
    createFont(height, escapement, faceName, bold, italic) {
        ...
        this.records.writeRecord(EMR.EXTCREATEFONTINDIRECTW, concat(uint32Array(handle), logFont));
        return handle;
    }
    selectObject(handle) {
