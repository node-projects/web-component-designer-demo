...
function buildStackingNode(element, includeInvisible, parentOpacity, parentClipBounds, coordinateTransform, walkIframes, parentClipQuads) {
    ...
    if (walkIframes && isHTMLIFrameElement(element)) {
        ...
        if (iframeRoot && iframeViewport) {
            ...
            if (includeInvisible || isVisible(iframeRootStyle)) {
                ...
                node.children.push(buildStackingNode(iframeRoot, includeInvisible, effectiveOpacity, intersectClipBounds(childClipBounds, iframeViewport.clipBounds), iframeViewport.transform, walkIframes, iframeClipQuads));
            }
        }
    }
    return node;
