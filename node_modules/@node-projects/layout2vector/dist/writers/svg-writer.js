...
export class SVGWriter {
    ...
    async drawPolyline(points, closed, style, source) {
        ...
        const element = this.buildLayeredShape((attrs) => `<path d="${d}"${style.fillRule === "evenodd" ? ' fill-rule="evenodd"' : ""}${attrs}/>`, canFillPath ? fill : null, stroke, style, gradientIds, undefined, opacity);
