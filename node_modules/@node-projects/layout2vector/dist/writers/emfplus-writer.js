...
export class EMFPlusWriter {
    ...
    buildImageObject(image) {
        const bitmapData = concatBytes(uint32Array(image.width, image.height), int32Array(image.stride), uint32Array(image.pixelFormat, image.compressed ? BITMAP_DATA_TYPE_COMPRESSED : BITMAP_DATA_TYPE_PIXEL), image.data);
