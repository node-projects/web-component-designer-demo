...
export class ImageResult {
    ...
    pendingImages;
    /** @internal */
    constructor(canvas, ctx, pendingImages) {
        this.canvas = canvas;
        this.ctx = ctx;
...
export class ImageWriter {
    ...
    drawTextDecoration(ctx, style, textX, baselineY, textWidth, fontSize, color) {
