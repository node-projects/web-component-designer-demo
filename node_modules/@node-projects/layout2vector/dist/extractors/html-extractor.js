...
function clipTextToParent(textNode, text, parentEl, textQuad, parentStyle) {
    ...
    if (availableWidth <= 0)
        return null;
    return clipTextToWidth(text, parentEl, textQuad, parentStyle, availableWidth, parentStyle.textOverflow === "ellipsis" ? "overflow" : "none");
}
function clipTextToWidth(text, parentEl, textQuad, parentStyle, availableWidth, ellipsisMode) {
    if (availableWidth <= 0)
        return null;
    const cs = getComputedStyle(parentEl);
