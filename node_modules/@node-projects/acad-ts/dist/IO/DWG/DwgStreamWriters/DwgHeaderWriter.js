...
export class DwgHeaderWriter extends DwgSectionIO {
    ...
    write() {
        ...
        this._writer.handleReferenceTyped(DwgReferenceType.HardPointer, this._header.currentMLineStyleName);
        //R2000+ Only:
        if (this.R2000Plus) {
            //BD: PSVPSCALE
        ...
        //3BD: UCSORG(PSPACE)
        this._writer.write3BitDouble(this._header.paperSpaceUcs);
        //3BD: UCSXDIR(PSPACE)
