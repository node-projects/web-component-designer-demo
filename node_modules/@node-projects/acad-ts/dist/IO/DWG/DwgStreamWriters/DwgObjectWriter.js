...
export class DwgObjectWriter extends DwgSectionIO {
    ...
    constructor(stream, document, encoding, writeXRecords = true, writeXData = true, writeShapes = true, writeDynamicBlockData = false) {
    ...
    _skipEntry(entry) {
        ...
        if (!this.writeDynamicBlockData && (entry instanceof EvaluationGraph ||
