...
export class DwgWriter extends CadWriterBase {
    ...
    _writeObjects() {
        const stream = new Uint8Array(0);
        const writer = new DwgObjectWriter(stream, this._document, this._encoding, this.configuration.writeXRecords, this.configuration.writeXData, this.configuration.writeShapes, this.configuration.writeDynamicBlockData);
        writer.onNotification = (sender, e) => this.triggerNotification(sender, e);
        writer.write();
