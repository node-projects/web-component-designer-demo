export class DwgLZ77AC21Decompressor {
    static m_sourceOffset = 0;
    static m_length = 0;
    static m_sourceIndex = 0;
    static m_opCode = 0;
    static decompress(source, initialOffset, length, buffer) {
        ...
        let destIndex = 0;
        const endIndex = DwgLZ77AC21Decompressor.m_sourceIndex + length;
    ...
    static nextIndex(source, dest, index) {
    ...
    static copyDecompressedChunks(src, endIndex, dst, destIndex) {
        DwgLZ77AC21Decompressor.m_length = 0;
    ...
    static readInstructions(buffer) {
    ...
    static copyBytes(dst, dstIndex, length, srcOffset) {
    ...
    static copyRaw(src, srcIndex, dst, dstIndex, length) {
