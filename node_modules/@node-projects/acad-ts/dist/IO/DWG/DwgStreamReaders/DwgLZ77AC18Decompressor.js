export class DwgLZ77AC18Decompressor {
    ...
    static copy(count, src, srcPos, dst, dstPos, tempBuf) {
    ...
    static literalCount(code, src, ref) {
    ...
    static readCompressedBytes(opcode1, validBits, compressed, ref) {
    ...
    static twoByteOffset(offset, addedValue, stream, srcPos) {
