...
export class DxfObjectsSectionWriter extends DxfSectionWriterBase {
    ...
    _writeBlockRepresentationData(data) {
    ...
    _writeEvaluationGraph(graph) {
        ...
        for (let i = 0; i < graph.nodes.length; i++) {
            ...
            if (node.expression)
                this.holder.objects.push(node.expression);
        }
    ...
    _writeWipeoutVariables(variables) {
    ...
    _isObjectSupported(co) {
        ...
        if (!this.configuration.writeDynamicBlockData && (co instanceof EvaluationGraph ||
    ...
    _writeAnnotScaleObjectContextData(contextData) {
