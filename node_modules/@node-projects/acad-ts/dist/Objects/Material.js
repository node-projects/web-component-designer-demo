...
export var MaterialChannelFlags;
(function (MaterialChannelFlags) {
    MaterialChannelFlags[MaterialChannelFlags["None"] = 0] = "None";
    MaterialChannelFlags[MaterialChannelFlags["UseDiffuse"] = 1] = "UseDiffuse";
    MaterialChannelFlags[MaterialChannelFlags["UseSpecular"] = 2] = "UseSpecular";
    MaterialChannelFlags[MaterialChannelFlags["UseReflection"] = 4] = "UseReflection";
    MaterialChannelFlags[MaterialChannelFlags["UseOpacity"] = 8] = "UseOpacity";
    MaterialChannelFlags[MaterialChannelFlags["UseBump"] = 16] = "UseBump";
    MaterialChannelFlags[MaterialChannelFlags["UseRefraction"] = 32] = "UseRefraction";
    MaterialChannelFlags[MaterialChannelFlags["UseNormalMap"] = 64] = "UseNormalMap";
    MaterialChannelFlags[MaterialChannelFlags["UseAll"] = 127] = "UseAll";
})(MaterialChannelFlags || (MaterialChannelFlags = {}));
export var MaterialIlluminationModel;
(function (MaterialIlluminationModel) {
    MaterialIlluminationModel[MaterialIlluminationModel["BlinnShader"] = 0] = "BlinnShader";
    MaterialIlluminationModel[MaterialIlluminationModel["MetalShader"] = 1] = "MetalShader";
})(MaterialIlluminationModel || (MaterialIlluminationModel = {}));
export var MaterialMode;
(function (MaterialMode) {
    MaterialMode[MaterialMode["Realistic"] = 0] = "Realistic";
    MaterialMode[MaterialMode["Advanced"] = 1] = "Advanced";
...
export class Material extends NonGraphicalObject {
    ...
    illuminationModel = MaterialIlluminationModel.BlinnShader;
    mode = MaterialMode.Realistic;
