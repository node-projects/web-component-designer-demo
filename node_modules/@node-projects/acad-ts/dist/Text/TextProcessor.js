export class TextProcessor {
    ...
    static jump(text, start) {
        let end = text.indexOf(';', start);
        end += 1;
        return end;
    }
    static processColor(text, start) {
        let end = text.indexOf(';', start);
        end += 1;
        return end;
    }
    static processHeight(text, start) {
        let end = text.indexOf(';', start);
        end += 1;
        return end;
    }
    static processJustification(text, start) {
        let end = text.indexOf(';', start);
        end += 1;
        return end;
    }
