...
export class DimensionStyle extends TableEntry {
    ...
    clone() {
        ...
        clone._style = this.style?.clone();
        clone._leaderArrow = this.leaderArrow?.clone() ?? null;
        clone._dimArrowBlock = this.arrowBlock?.clone() ?? null;
        clone._dimArrow1 = this.dimArrow1?.clone() ?? null;
        clone._dimArrow2 = this.dimArrow2?.clone() ?? null;
        clone._lineType = this.lineType?.clone() ?? null;
        clone._lineTypeExt1 = this.lineTypeExt1?.clone() ?? null;
        clone._lineTypeExt2 = this.lineTypeExt2?.clone() ?? null;
        return clone;
    }
    /** @internal */
    assignDocument(doc) {
    ...
    unassignDocument() {
        ...
        this._lineTypeExt1 = this._lineTypeExt1?.clone() ?? null;
        this._lineTypeExt2 = this._lineTypeExt2?.clone() ?? null;
        this._leaderArrow = this._leaderArrow?.clone() ?? null;
        this._dimArrow1 = this._dimArrow1?.clone() ?? null;
        this._dimArrow2 = this._dimArrow2?.clone() ?? null;
        this._dimArrowBlock = this._dimArrowBlock?.clone() ?? null;
    }
