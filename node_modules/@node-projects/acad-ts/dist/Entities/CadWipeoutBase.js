...
export class CadWipeoutBase extends Entity {
    ...
    set definition(value /* ImageDefinition */) {
    ...
    getBoundingBox() {
        ...
        const min = new XYZ(minX + this.insertPoint.x, minY + this.insertPoint.y, this.insertPoint.z);
        const max = new XYZ(maxX + this.insertPoint.x, maxY + this.insertPoint.y, this.insertPoint.z);
        return { min, max };
    }
    /** @internal */
    assignDocument(doc) {
    ...
    imageDefinitionsOnRemove(sender, e) {
