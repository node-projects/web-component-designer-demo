...
import { when } from '/web-component-designer-demo/node_modules/@spectrum-web-components/base/src/directives.js';
...
import dashStyles from '/web-component-designer-demo/node_modules/@spectrum-web-components/icon/src/spectrum-icon-dash.css.js';
const dashIcon = {
    xs: () => html `
        <sp-icon-dash75
            slot="icon"
...
export class Swatch extends SizedMixin(Focusable, {
    ...
    toggle(force) {
        this.selected = force !== null && force !== void 0 ? force : !this.selected;
    }
    handleClick() {
...
], Swatch.prototype, "border", void 0);
__decorate([
    property()
], Swatch.prototype, "color", void 0);
__decorate([
    property()
], Swatch.prototype, "label", void 0);
__decorate([
    property({ type: Boolean, reflect: true, attribute: 'mixed-value' })
], Swatch.prototype, "mixedValue", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], Swatch.prototype, "nothing", void 0);
__decorate([
    property({ reflect: true })
], Swatch.prototype, "role", void 0);
__decorate([
    property({ reflect: true })
], Swatch.prototype, "rounding", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], Swatch.prototype, "selected", void 0);
__decorate([
    property({ reflect: true })
], Swatch.prototype, "shape", void 0);
__decorate([
    property()
], Swatch.prototype, "value", null);
