...
import fs from 'fs';
import glob from '/web-component-designer-demo/node_modules/glob/glob.js';
...
glob(`${rootDir}/node_modules/${iconsPath}/**.svg`, (error, icons) => {
    ...
    let manifestImports = `import {
        html,
        TemplateResult
    } from '/web-component-designer-demo/node_modules/@spectrum-web-components/base/./src/index.js';\r\n`;
    ...
    `;
        ...
        import {
            IconBase
        } from '/web-component-designer-demo/node_modules/@spectrum-web-components/icon/./src/index.js';
