...
)}@media (forced-colors:active){:host([dir]){--spectrum-statuslight-m-info-text-color:CanvasText;--spectrum-statuslight-m-neutral-text-color:CanvasText;--spectrum-statuslight-m-info-text-color-disabled:GrayText;--spectrum-statuslight-m-info-dot-color-disabled:GrayText;forced-color-adjust:none}:host:before{border:1px solid ButtonText}}
`;
export default styles;
//# sourceMappingURL=spectrum-status-light.css.js.map