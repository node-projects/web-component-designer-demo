...
const menu = ({ onFirstItem, onSecondItem, onThirdItem, }) => html `
...
export const moreCtaOpen = (options = {}) => {
    return html `
        <div>
...
export const morePrimary = (options = {}) => {
    return html `
        <div>
...
export const moreSecondary = (options = {}) => {
    return html `
        <div>
