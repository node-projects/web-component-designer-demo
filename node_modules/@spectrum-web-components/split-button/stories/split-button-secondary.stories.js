...
export const field = (props, options = {}) => renderSplitButtonSet(props, options);
export const more = (props, options = {}) => renderSplitButtonSet(props, options);
more.args = {
    type: 'more',
};
//# sourceMappingURL=split-button-secondary.stories.js.map