...
import fieldDefaults, { m as field, } from '../stories/split-button-accent-field.stories.js';
import moreDefaults, { m as more, } from '../stories/split-button-accent-more.stories.js';
...
export function runSplitButtonTests(wrapInDiv, deprecatedMenu) {
    it('loads [type="field"] splitbutton accessibly', async () => {
        const test = await fixture(wrapInDiv(field(Object.assign(Object.assign({}, fieldDefaults.args), field.args))));
    ...
    it('loads [type="more"] splitbutton accessibly', async () => {
        const test = await fixture(wrapInDiv(more(Object.assign(Object.assign({}, moreDefaults.args), more.args))));
        const el1 = test.querySelector('sp-split-button');
        const el2 = test.querySelector('sp-split-button[left]');
        await elementUpdated(el1);
        await elementUpdated(el2);
    ...
    it('[type="field"] manages `selectedItem`', async () => {
        ...
        const el = test.querySelector('sp-split-button');
        await elementUpdated(el);
        expect((_a = el.selectedItem) === null || _a === void 0 ? void 0 : _a.itemText).to.equal('Option 1');
        expect(el.open).to.be.false;
        const item3 = el.querySelector('sp-menu-item:nth-child(3)');
        const root = el.shadowRoot ? el.shadowRoot : el;
        const toggleButton = root.querySelector('.trigger');
        ...
        await closed;
        await elementUpdated(el);
        expect((_b = el.selectedItem) === null || _b === void 0 ? void 0 : _b.itemText).to.equal('Short');
        expect(el.open).to.be.false;
    ...
    it('[type="more"] manages `selectedItem.itemText`', async () => {
        ...
        await elementUpdated(el);
        expect(el.open).to.be.false;
        expect((_b = el.selectedItem) === null || _b === void 0 ? void 0 : _b.itemText).to.equal('Option 1');
    });
    it('passes click events as [type="field"]', async () => {
        ...
        const test = await fixture(wrapInDiv(field(Object.assign(Object.assign(Object.assign({}, fieldDefaults.args), field.args), { firstItemHandler: () => firstItemSpy(), secondItemHandler: () => secondItemSpy(), thirdItemHandler: () => thirdItemSpy() }))));
        const el = test.querySelector('sp-split-button');
        await elementUpdated(el);
        expect((_a = el.selectedItem) === null || _a === void 0 ? void 0 : _a.itemText).to.equal('Option 1');
        expect(el.open).to.be.false;
        ...
        await elementUpdated(el);
        expect(el.open).to.be.false;
        expect((_c = el.selectedItem) === null || _c === void 0 ? void 0 : _c.itemText).to.equal('Option Really Extended');
        ...
        main.click();
        await elementUpdated(el);
        expect((_d = el.selectedItem) === null || _d === void 0 ? void 0 : _d.itemText).to.equal('Option 1');
    ...
    it('passes click events as [type="more"]', async () => {
        ...
        const secondItemSpy = spy();
        const thirdItemSpy = spy();
        const test = await fixture(wrapInDiv(more(Object.assign(Object.assign(Object.assign({}, moreDefaults.args), more.args), { firstItemHandler: () => firstItemSpy(), secondItemHandler: () => secondItemSpy(), thirdItemHandler: () => thirdItemSpy() }))));
        const el = test.querySelector('sp-split-button');
        await elementUpdated(el);
        expect((_a = el.selectedItem) === null || _a === void 0 ? void 0 : _a.itemText).to.equal('Option 1');
        expect(el.open).to.be.false;
        ...
        const item3 = el.querySelector('sp-menu-item:nth-child(3)');
        const root = el.shadowRoot ? el.shadowRoot : el;
        const main = root.querySelector('#button');
        main.click();
        await elementUpdated(el);
        ...
        await elementUpdated(el);
        expect(el.open).to.be.false;
        expect((_c = el.selectedItem) === null || _c === void 0 ? void 0 : _c.itemText).to.equal('Option 1');
