...
import checkmarkSmallStyles from '/web-component-designer-demo/node_modules/@spectrum-web-components/icon/src/spectrum-icon-checkmark.css.js';
import dashSmallStyles from '/web-component-designer-demo/node_modules/@spectrum-web-components/icon/src/spectrum-icon-dash.css.js';
const checkmarkIcon = {
    s: html `
        <sp-icon-checkmark75
            id="checkmark"
