...
export class Focusable extends FocusVisiblePolyfillMixin(SpectrumElement) {
  ...
  get tabIndex() {
    ...
    const tabIndexAttribute = parseFloat(this.hasAttribute('tabindex') ? this.getAttribute('tabindex') || '0' : '0'); // When `disabled` tabindex is -1.
...
__decorate([property({
  type: Number
})], Focusable.prototype, "tabIndex", null); //# sourceMappingURL=focusable.js.map