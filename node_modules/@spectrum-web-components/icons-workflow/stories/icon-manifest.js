...
import '../icons/sp-icon-abc.js';
import '../icons/sp-icon-actions.js';
import '../icons/sp-icon-add.js';
import '../icons/sp-icon-add-circle.js';
import '../icons/sp-icon-display-advert.js';
import '../icons/sp-icon-add-to.js';
import '../icons/sp-icon-add-to-selection.js';
import '../icons/sp-icon-print-advert.js';
import '../icons/sp-icon-aemscreens.js';
import '../icons/sp-icon-airplane.js';
import '../icons/sp-icon-alert.js';
import '../icons/sp-icon-alert-add.js';
import '../icons/sp-icon-alert-check.js';
import '../icons/sp-icon-alert-circle.js';
import '../icons/sp-icon-alert-circle-filled.js';
import '../icons/sp-icon-algorithm.js';
import '../icons/sp-icon-alias.js';
import '../icons/sp-icon-align-bottom.js';
import '../icons/sp-icon-align-center.js';
import '../icons/sp-icon-align-left.js';
import '../icons/sp-icon-align-middle.js';
import '../icons/sp-icon-align-right.js';
import '../icons/sp-icon-align-top.js';
import '../icons/sp-icon-amusementpark.js';
import '../icons/sp-icon-anchor.js';
import '../icons/sp-icon-anchor-select.js';
import '../icons/sp-icon-annotate.js';
import '../icons/sp-icon-annotate-pen.js';
import '../icons/sp-icon-answer.js';
import '../icons/sp-icon-answer-favorite.js';
import '../icons/sp-icon-app.js';
import '../icons/sp-icon-apple-files.js';
import '../icons/sp-icon-application-delivery.js';
import '../icons/sp-icon-app-refresh.js';
import '../icons/sp-icon-approve-reject.js';
import '../icons/sp-icon-apps.js';
import '../icons/sp-icon-archive.js';
import '../icons/sp-icon-archive-remove.js';
import '../icons/sp-icon-arrow-down.js';
import '../icons/sp-icon-arrow-left.js';
import '../icons/sp-icon-arrow-right.js';
import '../icons/sp-icon-arrow-up.js';
import '../icons/sp-icon-arrow-up-right.js';
import '../icons/sp-icon-artboard.js';
import '../icons/sp-icon-article.js';
import '../icons/sp-icon-asset.js';
import '../icons/sp-icon-asset-check.js';
import '../icons/sp-icon-assets-added.js';
import '../icons/sp-icon-assets-downloaded.js';
import '../icons/sp-icon-assets-expired.js';
import '../icons/sp-icon-assets-linked-published.js';
import '../icons/sp-icon-assets-modified.js';
import '../icons/sp-icon-assets-published.js';
import '../icons/sp-icon-asterisk.js';
import '../icons/sp-icon-at.js';
import '../icons/sp-icon-attach.js';
import '../icons/sp-icon-attachment-exclude.js';
import '../icons/sp-icon-attributes.js';
import '../icons/sp-icon-audio.js';
import '../icons/sp-icon-automated-segment.js';
import '../icons/sp-icon-back.js';
import '../icons/sp-icon-back30-seconds.js';
import '../icons/sp-icon-back-android.js';
import '../icons/sp-icon-beaker.js';
import '../icons/sp-icon-beaker-check.js';
import '../icons/sp-icon-beaker-share.js';
import '../icons/sp-icon-bell.js';
import '../icons/sp-icon-bid-rule.js';
import '../icons/sp-icon-bid-rule-add.js';
import '../icons/sp-icon-blower.js';
import '../icons/sp-icon-blur.js';
import '../icons/sp-icon-book.js';
import '../icons/sp-icon-bookmark.js';
import '../icons/sp-icon-bookmark-single.js';
import '../icons/sp-icon-bookmark-single-outline.js';
import '../icons/sp-icon-bookmark-small.js';
import '../icons/sp-icon-bookmark-small-outline.js';
import '../icons/sp-icon-boolean.js';
import '../icons/sp-icon-border.js';
import '../icons/sp-icon-box.js';
import '../icons/sp-icon-box-add.js';
import '../icons/sp-icon-box-export.js';
import '../icons/sp-icon-box-import.js';
import '../icons/sp-icon-brackets.js';
import '../icons/sp-icon-brackets-square.js';
import '../icons/sp-icon-branch1.js';
import '../icons/sp-icon-branch2.js';
import '../icons/sp-icon-branch3.js';
import '../icons/sp-icon-branch-circle.js';
import '../icons/sp-icon-breadcrumb-navigation.js';
import '../icons/sp-icon-breakdown.js';
import '../icons/sp-icon-breakdown-add.js';
import '../icons/sp-icon-briefcase.js';
import '../icons/sp-icon-browse.js';
import '../icons/sp-icon-brush.js';
import '../icons/sp-icon-bug.js';
import '../icons/sp-icon-building.js';
import '../icons/sp-icon-bulk-edit-users.js';
import '../icons/sp-icon-button.js';
import '../icons/sp-icon-calculator.js';
import '../icons/sp-icon-calendar.js';
import '../icons/sp-icon-calendar-add.js';
import '../icons/sp-icon-calendar-locked.js';
import '../icons/sp-icon-calendar-unlocked.js';
import '../icons/sp-icon-call-center.js';
import '../icons/sp-icon-camera.js';
import '../icons/sp-icon-camera-flip.js';
import '../icons/sp-icon-camera-refresh.js';
import '../icons/sp-icon-campaign.js';
import '../icons/sp-icon-campaign-add.js';
import '../icons/sp-icon-campaign-close.js';
import '../icons/sp-icon-campaign-delete.js';
import '../icons/sp-icon-campaign-edit.js';
import '../icons/sp-icon-cancel.js';
import '../icons/sp-icon-capitals.js';
import '../icons/sp-icon-captcha.js';
import '../icons/sp-icon-car.js';
import '../icons/sp-icon-card.js';
import '../icons/sp-icon-cclibrary.js';
import '../icons/sp-icon-channel.js';
import '../icons/sp-icon-chat.js';
import '../icons/sp-icon-chat-add.js';
import '../icons/sp-icon-checkmark.js';
import '../icons/sp-icon-checkmark-circle.js';
import '../icons/sp-icon-checkmark-circle-outline.js';
import '../icons/sp-icon-check-pause.js';
import '../icons/sp-icon-chevron-double-left.js';
import '../icons/sp-icon-chevron-double-right.js';
import '../icons/sp-icon-chevron-down.js';
import '../icons/sp-icon-chevron-left.js';
import '../icons/sp-icon-chevron-right.js';
import '../icons/sp-icon-chevron-up.js';
import '../icons/sp-icon-chevron-up-down.js';
import '../icons/sp-icon-circle.js';
import '../icons/sp-icon-classic-grid-view.js';
import '../icons/sp-icon-clock.js';
import '../icons/sp-icon-clock-check.js';
import '../icons/sp-icon-clone-stamp.js';
import '../icons/sp-icon-close.js';
import '../icons/sp-icon-close-captions.js';
import '../icons/sp-icon-close-circle.js';
import '../icons/sp-icon-cloud.js';
import '../icons/sp-icon-cloud-disconnected.js';
import '../icons/sp-icon-cloud-error.js';
import '../icons/sp-icon-cloud-outline.js';
import '../icons/sp-icon-code.js';
import '../icons/sp-icon-collection.js';
import '../icons/sp-icon-collection-add.js';
import '../icons/sp-icon-collection-add-to.js';
import '../icons/sp-icon-collection-check.js';
import '../icons/sp-icon-collection-edit.js';
import '../icons/sp-icon-collection-exclude.js';
import '../icons/sp-icon-collection-link.js';
import '../icons/sp-icon-color-fill.js';
import '../icons/sp-icon-color-palette.js';
import '../icons/sp-icon-color-wheel.js';
import '../icons/sp-icon-column-settings.js';
import '../icons/sp-icon-column-two-a.js';
import '../icons/sp-icon-column-two-b.js';
import '../icons/sp-icon-column-two-c.js';
import '../icons/sp-icon-comment.js';
import '../icons/sp-icon-compare.js';
import '../icons/sp-icon-compass.js';
import '../icons/sp-icon-condition.js';
import '../icons/sp-icon-confidence-four.js';
import '../icons/sp-icon-confidence-one.js';
import '../icons/sp-icon-confidence-three.js';
import '../icons/sp-icon-confidence-two.js';
import '../icons/sp-icon-contrast.js';
import '../icons/sp-icon-conversion-funnel.js';
import '../icons/sp-icon-copy.js';
import '../icons/sp-icon-cover-image.js';
import '../icons/sp-icon-credit-card.js';
import '../icons/sp-icon-crop.js';
import '../icons/sp-icon-crop-lightning.js';
import '../icons/sp-icon-crop-rotate.js';
import '../icons/sp-icon-crosshairs.js';
import '../icons/sp-icon-curate.js';
import '../icons/sp-icon-cut.js';
import '../icons/sp-icon-dashboard.js';
import '../icons/sp-icon-data.js';
import '../icons/sp-icon-data-add.js';
import '../icons/sp-icon-data-book.js';
import '../icons/sp-icon-data-check.js';
import '../icons/sp-icon-data-correlated.js';
import '../icons/sp-icon-data-download.js';
import '../icons/sp-icon-data-edit.js';
import '../icons/sp-icon-data-mapping.js';
import '../icons/sp-icon-data-refresh.js';
import '../icons/sp-icon-data-remove.js';
import '../icons/sp-icon-data-settings.js';
import '../icons/sp-icon-data-unavailable.js';
import '../icons/sp-icon-data-upload.js';
import '../icons/sp-icon-data-user.js';
import '../icons/sp-icon-date.js';
import '../icons/sp-icon-date-input.js';
import '../icons/sp-icon-deduplication.js';
import '../icons/sp-icon-delegate.js';
import '../icons/sp-icon-delete.js';
import '../icons/sp-icon-delete-outline.js';
import '../icons/sp-icon-demographic.js';
import '../icons/sp-icon-deselect.js';
import '../icons/sp-icon-deselect-circular.js';
import '../icons/sp-icon-desktop-and-mobile.js';
import '../icons/sp-icon-device-desktop.js';
import '../icons/sp-icon-device-laptop.js';
import '../icons/sp-icon-device-phone.js';
import '../icons/sp-icon-device-phone-refresh.js';
import '../icons/sp-icon-device-preview.js';
import '../icons/sp-icon-device-rotate-landscape.js';
import '../icons/sp-icon-device-rotate-portrait.js';
import '../icons/sp-icon-devices.js';
import '../icons/sp-icon-device-tablet.js';
import '../icons/sp-icon-device-t-v.js';
import '../icons/sp-icon-distribute-bottom-edge.js';
import '../icons/sp-icon-distribute-horizontal-center.js';
import '../icons/sp-icon-distribute-horizontally.js';
import '../icons/sp-icon-distribute-left-edge.js';
import '../icons/sp-icon-distribute-right-edge.js';
import '../icons/sp-icon-distribute-space-horiz.js';
import '../icons/sp-icon-distribute-space-vert.js';
import '../icons/sp-icon-distribute-top-edge.js';
import '../icons/sp-icon-distribute-vertical-center.js';
import '../icons/sp-icon-distribute-vertically.js';
import '../icons/sp-icon-divide.js';
import '../icons/sp-icon-divide-path.js';
import '../icons/sp-icon-document.js';
import '../icons/sp-icon-document-fragment.js';
import '../icons/sp-icon-document-fragment-group.js';
import '../icons/sp-icon-document-outline.js';
import '../icons/sp-icon-document-refresh.js';
import '../icons/sp-icon-dolly.js';
import '../icons/sp-icon-download.js';
import '../icons/sp-icon-download-from-cloud.js';
import '../icons/sp-icon-download-from-cloud-outline.js';
import '../icons/sp-icon-draft.js';
import '../icons/sp-icon-drag-handle.js';
import '../icons/sp-icon-draw.js';
import '../icons/sp-icon-dropdown.js';
import '../icons/sp-icon-duplicate.js';
import '../icons/sp-icon-edit.js';
import '../icons/sp-icon-edit-circle.js';
import '../icons/sp-icon-edit-exclude.js';
import '../icons/sp-icon-edit-in.js';
import '../icons/sp-icon-edit-in-light.js';
import '../icons/sp-icon-education.js';
import '../icons/sp-icon-effects.js';
import '../icons/sp-icon-efficient.js';
import '../icons/sp-icon-ellipse.js';
import '../icons/sp-icon-email.js';
import '../icons/sp-icon-email-cancel.js';
import '../icons/sp-icon-email-check.js';
import '../icons/sp-icon-email-exclude.js';
import '../icons/sp-icon-email-exclude-outline.js';
import '../icons/sp-icon-email-gear.js';
import '../icons/sp-icon-email-gear-outline.js';
import '../icons/sp-icon-email-key.js';
import '../icons/sp-icon-email-key-outline.js';
import '../icons/sp-icon-email-lightning.js';
import '../icons/sp-icon-email-notification.js';
import '../icons/sp-icon-email-outline.js';
import '../icons/sp-icon-email-refresh.js';
import '../icons/sp-icon-email-schedule.js';
import '../icons/sp-icon-engagement.js';
import '../icons/sp-icon-erase.js';
import '../icons/sp-icon-event.js';
import '../icons/sp-icon-event-exclude.js';
import '../icons/sp-icon-events.js';
import '../icons/sp-icon-event-share.js';
import '../icons/sp-icon-exclude-overlap.js';
import '../icons/sp-icon-experience.js';
import '../icons/sp-icon-experience-add.js';
import '../icons/sp-icon-experience-add-to.js';
import '../icons/sp-icon-experience-export.js';
import '../icons/sp-icon-experience-import.js';
import '../icons/sp-icon-export.js';
import '../icons/sp-icon-export-original.js';
import '../icons/sp-icon-exposure.js';
import '../icons/sp-icon-extension.js';
import '../icons/sp-icon-facebook-cover-image.js';
import '../icons/sp-icon-fast.js';
import '../icons/sp-icon-fast-forward.js';
import '../icons/sp-icon-fast-forward-circle.js';
import '../icons/sp-icon-feature.js';
import '../icons/sp-icon-feed.js';
import '../icons/sp-icon-feed-add.js';
import '../icons/sp-icon-feedback.js';
import '../icons/sp-icon-feed-management.js';
import '../icons/sp-icon-file-add.js';
import '../icons/sp-icon-file-campaign.js';
import '../icons/sp-icon-file-chart.js';
import '../icons/sp-icon-file-checked-out.js';
import '../icons/sp-icon-file-code.js';
import '../icons/sp-icon-file-cs-v.js';
import '../icons/sp-icon-file-data.js';
import '../icons/sp-icon-file-email.js';
import '../icons/sp-icon-file-excel.js';
import '../icons/sp-icon-file-folder.js';
import '../icons/sp-icon-file-gear.js';
import '../icons/sp-icon-file-globe.js';
import '../icons/sp-icon-file-htm-l.js';
import '../icons/sp-icon-file-important.js';
import '../icons/sp-icon-file-json.js';
import '../icons/sp-icon-file-key.js';
import '../icons/sp-icon-file-mobile.js';
import '../icons/sp-icon-file-pd-f.js';
import '../icons/sp-icon-file-share.js';
import '../icons/sp-icon-file-single-web-page.js';
import '../icons/sp-icon-file-space.js';
import '../icons/sp-icon-file-template.js';
import '../icons/sp-icon-file-txt.js';
import '../icons/sp-icon-file-user.js';
import '../icons/sp-icon-file-word.js';
import '../icons/sp-icon-file-workflow.js';
import '../icons/sp-icon-file-xm-l.js';
import '../icons/sp-icon-file-zip.js';
import '../icons/sp-icon-filing-cabinet.js';
import '../icons/sp-icon-filmroll.js';
import '../icons/sp-icon-filmroll-auto-add.js';
import '../icons/sp-icon-filter.js';
import '../icons/sp-icon-filter-add.js';
import '../icons/sp-icon-filter-check.js';
import '../icons/sp-icon-filter-delete.js';
import '../icons/sp-icon-filter-edit.js';
import '../icons/sp-icon-filter-heart.js';
import '../icons/sp-icon-filter-remove.js';
import '../icons/sp-icon-filter-star.js';
import '../icons/sp-icon-find-and-replace.js';
import '../icons/sp-icon-flag.js';
import '../icons/sp-icon-flag-exclude.js';
import '../icons/sp-icon-flash-auto.js';
import '../icons/sp-icon-flashlight.js';
import '../icons/sp-icon-flashlight-off.js';
import '../icons/sp-icon-flashlight-on.js';
import '../icons/sp-icon-flash-off.js';
import '../icons/sp-icon-flash-on.js';
import '../icons/sp-icon-flip-horizontal.js';
import '../icons/sp-icon-flip-vertical.js';
import '../icons/sp-icon-folder.js';
import '../icons/sp-icon-folder2-color.js';
import '../icons/sp-icon-folder-add.js';
import '../icons/sp-icon-folder-add-to.js';
import '../icons/sp-icon-folder-archive.js';
import '../icons/sp-icon-folder-delete.js';
import '../icons/sp-icon-folder-gear.js';
import '../icons/sp-icon-folder-locked.js';
import '../icons/sp-icon-folder-open.js';
import '../icons/sp-icon-folder-open-outline.js';
import '../icons/sp-icon-folder-outline.js';
import '../icons/sp-icon-folder-remove.js';
import '../icons/sp-icon-folder-search.js';
import '../icons/sp-icon-folder-user.js';
import '../icons/sp-icon-follow.js';
import '../icons/sp-icon-follow-off.js';
import '../icons/sp-icon-forecast.js';
import '../icons/sp-icon-form.js';
import '../icons/sp-icon-for-placement-only.js';
import '../icons/sp-icon-forward.js';
import '../icons/sp-icon-full-screen.js';
import '../icons/sp-icon-full-screen-exit.js';
import '../icons/sp-icon-function.js';
import '../icons/sp-icon-game.js';
import '../icons/sp-icon-gauge1.js';
import '../icons/sp-icon-gauge2.js';
import '../icons/sp-icon-gauge3.js';
import '../icons/sp-icon-gauge4.js';
import '../icons/sp-icon-gauge5.js';
import '../icons/sp-icon-gears.js';
import '../icons/sp-icon-gears-add.js';
import '../icons/sp-icon-gears-delete.js';
import '../icons/sp-icon-gears-edit.js';
import '../icons/sp-icon-gender-female.js';
import '../icons/sp-icon-gender-male.js';
import '../icons/sp-icon-gift.js';
import '../icons/sp-icon-globe.js';
import '../icons/sp-icon-globe-check.js';
import '../icons/sp-icon-globe-clock.js';
import '../icons/sp-icon-globe-enter.js';
import '../icons/sp-icon-globe-exit.js';
import '../icons/sp-icon-globe-grid.js';
import '../icons/sp-icon-globe-outline.js';
import '../icons/sp-icon-globe-remove.js';
import '../icons/sp-icon-globe-search.js';
import '../icons/sp-icon-globe-strike.js';
import '../icons/sp-icon-globe-strike-clock.js';
import '../icons/sp-icon-gradient.js';
import '../icons/sp-icon-graph-area.js';
import '../icons/sp-icon-graph-area-stacked.js';
import '../icons/sp-icon-graph-bar-horizontal.js';
import '../icons/sp-icon-graph-bar-horizontal-add.js';
import '../icons/sp-icon-graph-bar-horizontal-stacked.js';
import '../icons/sp-icon-graph-bar-vertical.js';
import '../icons/sp-icon-graph-bar-vertical-add.js';
import '../icons/sp-icon-graph-bar-vertical-stacked.js';
import '../icons/sp-icon-graph-bubble.js';
import '../icons/sp-icon-graph-bullet.js';
import '../icons/sp-icon-graph-confidence-bands.js';
import '../icons/sp-icon-graph-donut.js';
import '../icons/sp-icon-graph-donut-add.js';
import '../icons/sp-icon-graph-gantt.js';
import '../icons/sp-icon-graph-histogram.js';
import '../icons/sp-icon-graphic.js';
import '../icons/sp-icon-graph-pathing.js';
import '../icons/sp-icon-graph-pie.js';
import '../icons/sp-icon-graph-profit-curve.js';
import '../icons/sp-icon-graph-scatter.js';
import '../icons/sp-icon-graph-stream.js';
import '../icons/sp-icon-graph-stream-ranked.js';
import '../icons/sp-icon-graph-stream-ranked-add.js';
import '../icons/sp-icon-graph-sunburst.js';
import '../icons/sp-icon-graph-tree.js';
import '../icons/sp-icon-graph-trend.js';
import '../icons/sp-icon-graph-trend-add.js';
import '../icons/sp-icon-graph-trend-alert.js';
import '../icons/sp-icon-group.js';
import '../icons/sp-icon-hammer.js';
import '../icons/sp-icon-hand.js';
import '../icons/sp-icon-hand0.js';
import '../icons/sp-icon-hand1.js';
import '../icons/sp-icon-hand2.js';
import '../icons/sp-icon-hand3.js';
import '../icons/sp-icon-hand4.js';
import '../icons/sp-icon-heal.js';
import '../icons/sp-icon-heart.js';
import '../icons/sp-icon-help.js';
import '../icons/sp-icon-help-outline.js';
import '../icons/sp-icon-histogram.js';
import '../icons/sp-icon-history.js';
import '../icons/sp-icon-home.js';
import '../icons/sp-icon-homepage.js';
import '../icons/sp-icon-hotel-bed.js';
import '../icons/sp-icon-hot-fixes.js';
import '../icons/sp-icon-identity-service.js';
import '../icons/sp-icon-image.js';
import '../icons/sp-icon-image-add.js';
import '../icons/sp-icon-image-album.js';
import '../icons/sp-icon-image-auto-mode.js';
import '../icons/sp-icon-image-carousel.js';
import '../icons/sp-icon-image-check.js';
import '../icons/sp-icon-image-checked-out.js';
import '../icons/sp-icon-image-map-circle.js';
import '../icons/sp-icon-image-map-polygon.js';
import '../icons/sp-icon-image-map-rectangle.js';
import '../icons/sp-icon-image-next.js';
import '../icons/sp-icon-image-profile.js';
import '../icons/sp-icon-images.js';
import '../icons/sp-icon-image-search.js';
import '../icons/sp-icon-image-text.js';
import '../icons/sp-icon-import.js';
import '../icons/sp-icon-inbox.js';
import '../icons/sp-icon-individual.js';
import '../icons/sp-icon-info.js';
import '../icons/sp-icon-info-outline.js';
import '../icons/sp-icon-intersect-overlap.js';
import '../icons/sp-icon-invert-adj.js';
import '../icons/sp-icon-journey.js';
import '../icons/sp-icon-journey-action.js';
import '../icons/sp-icon-journey-data.js';
import '../icons/sp-icon-journey-event.js';
import '../icons/sp-icon-journey-event2.js';
import '../icons/sp-icon-journey-reports.js';
import '../icons/sp-icon-journey-voyager.js';
import '../icons/sp-icon-jump-to-top.js';
import '../icons/sp-icon-key.js';
import '../icons/sp-icon-keyboard.js';
import '../icons/sp-icon-key-clock.js';
import '../icons/sp-icon-key-exclude.js';
import '../icons/sp-icon-label.js';
import '../icons/sp-icon-label-exclude.js';
import '../icons/sp-icon-labels.js';
import '../icons/sp-icon-landscape.js';
import '../icons/sp-icon-launch.js';
import '../icons/sp-icon-layers.js';
import '../icons/sp-icon-layers-backward.js';
import '../icons/sp-icon-layers-bring-to-front.js';
import '../icons/sp-icon-layers-forward.js';
import '../icons/sp-icon-layers-send-to-back.js';
import '../icons/sp-icon-light.js';
import '../icons/sp-icon-line.js';
import '../icons/sp-icon-linear-gradient.js';
import '../icons/sp-icon-line-height.js';
import '../icons/sp-icon-link.js';
import '../icons/sp-icon-link-check.js';
import '../icons/sp-icon-link-globe.js';
import '../icons/sp-icon-link-nav.js';
import '../icons/sp-icon-link-off.js';
import '../icons/sp-icon-link-out.js';
import '../icons/sp-icon-link-out-light.js';
import '../icons/sp-icon-link-page.js';
import '../icons/sp-icon-link-user.js';
import '../icons/sp-icon-location.js';
import '../icons/sp-icon-location-based-date.js';
import '../icons/sp-icon-location-based-event.js';
import '../icons/sp-icon-location-contribution.js';
import '../icons/sp-icon-lock-closed.js';
import '../icons/sp-icon-lock-open.js';
import '../icons/sp-icon-login.js';
import '../icons/sp-icon-log-out.js';
import '../icons/sp-icon-looks.js';
import '../icons/sp-icon-loupe-view.js';
import '../icons/sp-icon-magic-wand.js';
import '../icons/sp-icon-magnify.js';
import '../icons/sp-icon-mailbox.js';
import '../icons/sp-icon-map-view.js';
import '../icons/sp-icon-margin-bottom.js';
import '../icons/sp-icon-margin-left.js';
import '../icons/sp-icon-margin-right.js';
import '../icons/sp-icon-margin-top.js';
import '../icons/sp-icon-marketing-activities.js';
import '../icons/sp-icon-maximize.js';
import '../icons/sp-icon-mbox.js';
import '../icons/sp-icon-measure.js';
import '../icons/sp-icon-menu.js';
import '../icons/sp-icon-merge.js';
import '../icons/sp-icon-merge-layers.js';
import '../icons/sp-icon-messenger.js';
import '../icons/sp-icon-minimize.js';
import '../icons/sp-icon-mobile-services.js';
import '../icons/sp-icon-modern-grid-view.js';
import '../icons/sp-icon-money.js';
import '../icons/sp-icon-monitoring.js';
import '../icons/sp-icon-moon.js';
import '../icons/sp-icon-more.js';
import '../icons/sp-icon-more-circle.js';
import '../icons/sp-icon-more-small.js';
import '../icons/sp-icon-more-small-list.js';
import '../icons/sp-icon-more-small-list-vert.js';
import '../icons/sp-icon-more-vertical.js';
import '../icons/sp-icon-move.js';
import '../icons/sp-icon-move-left-right.js';
import '../icons/sp-icon-move-to.js';
import '../icons/sp-icon-move-up-down.js';
import '../icons/sp-icon-movie-camera.js';
import '../icons/sp-icon-multiple.js';
import '../icons/sp-icon-multiple-add.js';
import '../icons/sp-icon-multiple-check.js';
import '../icons/sp-icon-multiple-exclude.js';
import '../icons/sp-icon-naming-order.js';
import '../icons/sp-icon-new-item.js';
import '../icons/sp-icon-news.js';
import '../icons/sp-icon-news-add.js';
import '../icons/sp-icon-no-edit.js';
import '../icons/sp-icon-note.js';
import '../icons/sp-icon-note-add.js';
import '../icons/sp-icon-offer.js';
import '../icons/sp-icon-offer-delete.js';
import '../icons/sp-icon-on-air.js';
import '../icons/sp-icon-open-in.js';
import '../icons/sp-icon-open-in-light.js';
import '../icons/sp-icon-open-recent.js';
import '../icons/sp-icon-open-recent-outline.js';
import '../icons/sp-icon-orbit.js';
import '../icons/sp-icon-organisations.js';
import '../icons/sp-icon-organize.js';
import '../icons/sp-icon-os.js';
import '../icons/sp-icon-outline-path.js';
import '../icons/sp-icon-padding-bottom.js';
import '../icons/sp-icon-padding-left.js';
import '../icons/sp-icon-padding-right.js';
import '../icons/sp-icon-padding-top.js';
import '../icons/sp-icon-page-break.js';
import '../icons/sp-icon-page-exclude.js';
import '../icons/sp-icon-page-gear.js';
import '../icons/sp-icon-page-rule.js';
import '../icons/sp-icon-pages-exclude.js';
import '../icons/sp-icon-page-share.js';
import '../icons/sp-icon-page-tag.js';
import '../icons/sp-icon-pan.js';
import '../icons/sp-icon-panel.js';
import '../icons/sp-icon-paste.js';
import '../icons/sp-icon-paste-htm-l.js';
import '../icons/sp-icon-paste-list.js';
import '../icons/sp-icon-paste-text.js';
import '../icons/sp-icon-pattern.js';
import '../icons/sp-icon-pause.js';
import '../icons/sp-icon-pause-circle.js';
import '../icons/sp-icon-pawn.js';
import '../icons/sp-icon-pending.js';
import '../icons/sp-icon-people-group.js';
import '../icons/sp-icon-personalization-field.js';
import '../icons/sp-icon-perspective.js';
import '../icons/sp-icon-pin-off.js';
import '../icons/sp-icon-pin-on.js';
import '../icons/sp-icon-pivot.js';
import '../icons/sp-icon-platform-data-mapping.js';
import '../icons/sp-icon-play.js';
import '../icons/sp-icon-play-circle.js';
import '../icons/sp-icon-plug.js';
import '../icons/sp-icon-polygon.js';
import '../icons/sp-icon-polygon-select.js';
import '../icons/sp-icon-pop-in.js';
import '../icons/sp-icon-portrait.js';
import '../icons/sp-icon-preset.js';
import '../icons/sp-icon-preview.js';
import '../icons/sp-icon-print.js';
import '../icons/sp-icon-print-preview.js';
import '../icons/sp-icon-project.js';
import '../icons/sp-icon-project-add.js';
import '../icons/sp-icon-project-edit.js';
import '../icons/sp-icon-project-name-edit.js';
import '../icons/sp-icon-promote.js';
import '../icons/sp-icon-properties.js';
import '../icons/sp-icon-properties-copy.js';
import '../icons/sp-icon-publish-check.js';
import '../icons/sp-icon-publish-pending.js';
import '../icons/sp-icon-publish-reject.js';
import '../icons/sp-icon-publish-remove.js';
import '../icons/sp-icon-publish-schedule.js';
import '../icons/sp-icon-push-notification.js';
import '../icons/sp-icon-question.js';
import '../icons/sp-icon-quick-select.js';
import '../icons/sp-icon-radial-gradient.js';
import '../icons/sp-icon-rail.js';
import '../icons/sp-icon-rail-bottom.js';
import '../icons/sp-icon-rail-left.js';
import '../icons/sp-icon-rail-right.js';
import '../icons/sp-icon-rail-right-close.js';
import '../icons/sp-icon-rail-right-open.js';
import '../icons/sp-icon-rail-top.js';
import '../icons/sp-icon-range-mask.js';
import '../icons/sp-icon-real-time-customer-profile.js';
import '../icons/sp-icon-rectangle.js';
import '../icons/sp-icon-rect-select.js';
import '../icons/sp-icon-redo.js';
import '../icons/sp-icon-refresh.js';
import '../icons/sp-icon-region-select.js';
import '../icons/sp-icon-relevance.js';
import '../icons/sp-icon-remove.js';
import '../icons/sp-icon-remove-circle.js';
import '../icons/sp-icon-rename.js';
import '../icons/sp-icon-reorder.js';
import '../icons/sp-icon-replay.js';
import '../icons/sp-icon-replies.js';
import '../icons/sp-icon-reply.js';
import '../icons/sp-icon-reply-all.js';
import '../icons/sp-icon-report.js';
import '../icons/sp-icon-report-add.js';
import '../icons/sp-icon-resize.js';
import '../icons/sp-icon-retweet.js';
import '../icons/sp-icon-reuse.js';
import '../icons/sp-icon-revenue.js';
import '../icons/sp-icon-revert.js';
import '../icons/sp-icon-rewind.js';
import '../icons/sp-icon-rewind-circle.js';
import '../icons/sp-icon-ribbon.js';
import '../icons/sp-icon-rotate-cc-w.js';
import '../icons/sp-icon-rotate-ccw-bold.js';
import '../icons/sp-icon-rotate-c-w.js';
import '../icons/sp-icon-rotate-cw-bold.js';
import '../icons/sp-icon-rotate-left.js';
import '../icons/sp-icon-rotate-left-outline.js';
import '../icons/sp-icon-rotate-right.js';
import '../icons/sp-icon-rotate-right-outline.js';
import '../icons/sp-icon-rss.js';
import '../icons/sp-icon-sampler.js';
import '../icons/sp-icon-sandbox.js';
import '../icons/sp-icon-save-as-floppy.js';
import '../icons/sp-icon-save-floppy.js';
import '../icons/sp-icon-save-to.js';
import '../icons/sp-icon-save-to-light.js';
import '../icons/sp-icon-scribble.js';
import '../icons/sp-icon-search.js';
import '../icons/sp-icon-seat.js';
import '../icons/sp-icon-seat-add.js';
import '../icons/sp-icon-segmentation.js';
import '../icons/sp-icon-segments.js';
import '../icons/sp-icon-select.js';
import '../icons/sp-icon-select-add.js';
import '../icons/sp-icon-select-box.js';
import '../icons/sp-icon-select-box-all.js';
import '../icons/sp-icon-select-circular.js';
import '../icons/sp-icon-select-container.js';
import '../icons/sp-icon-select-gear.js';
import '../icons/sp-icon-select-intersect.js';
import '../icons/sp-icon-selection.js';
import '../icons/sp-icon-selection-checked.js';
import '../icons/sp-icon-selection-move.js';
import '../icons/sp-icon-select-substract.js';
import '../icons/sp-icon-select-subtract.js';
import '../icons/sp-icon-send.js';
import '../icons/sp-icon-sentiment-negative.js';
import '../icons/sp-icon-sentiment-neutral.js';
import '../icons/sp-icon-sentiment-positive.js';
import '../icons/sp-icon-separator.js';
import '../icons/sp-icon-servers.js';
import '../icons/sp-icon-settings.js';
import '../icons/sp-icon-shapes.js';
import '../icons/sp-icon-share.js';
import '../icons/sp-icon-share-android.js';
import '../icons/sp-icon-share-check.js';
import '../icons/sp-icon-share-light.js';
import '../icons/sp-icon-share-windows.js';
import '../icons/sp-icon-sharpen.js';
import '../icons/sp-icon-shield.js';
import '../icons/sp-icon-ship.js';
import '../icons/sp-icon-shop.js';
import '../icons/sp-icon-shopping-cart.js';
import '../icons/sp-icon-show-all-layers.js';
import '../icons/sp-icon-show-menu.js';
import '../icons/sp-icon-show-one-layer.js';
import '../icons/sp-icon-shuffle.js';
import '../icons/sp-icon-slice.js';
import '../icons/sp-icon-slow.js';
import '../icons/sp-icon-small-caps.js';
import '../icons/sp-icon-sms.js';
import '../icons/sp-icon-smskey.js';
import '../icons/sp-icon-smslightning.js';
import '../icons/sp-icon-smsrefresh.js';
import '../icons/sp-icon-snapshot.js';
import '../icons/sp-icon-social-network.js';
import '../icons/sp-icon-sort-order-down.js';
import '../icons/sp-icon-sort-order-up.js';
import '../icons/sp-icon-spam.js';
import '../icons/sp-icon-spellcheck.js';
import '../icons/sp-icon-spin.js';
import '../icons/sp-icon-split-view.js';
import '../icons/sp-icon-spot-heal.js';
import '../icons/sp-icon-sqlquery.js';
import '../icons/sp-icon-stadium.js';
import '../icons/sp-icon-stage.js';
import '../icons/sp-icon-stamp.js';
import '../icons/sp-icon-star.js';
import '../icons/sp-icon-starburst.js';
import '../icons/sp-icon-star-outline.js';
import '../icons/sp-icon-step-backward.js';
import '../icons/sp-icon-step-backward-circle.js';
import '../icons/sp-icon-step-forward.js';
import '../icons/sp-icon-step-forward-circle.js';
import '../icons/sp-icon-stop.js';
import '../icons/sp-icon-stop-circle.js';
import '../icons/sp-icon-stopwatch.js';
import '../icons/sp-icon-straighten.js';
import '../icons/sp-icon-straighten-outline.js';
import '../icons/sp-icon-stroke-width.js';
import '../icons/sp-icon-subscribe.js';
import '../icons/sp-icon-substract-back-path.js';
import '../icons/sp-icon-substract-from-selection.js';
import '../icons/sp-icon-subtract-back-path.js';
import '../icons/sp-icon-subtract-from-selection.js';
import '../icons/sp-icon-subtract-front-path.js';
import '../icons/sp-icon-success-metric.js';
import '../icons/sp-icon-summarize.js';
import '../icons/sp-icon-survey.js';
import '../icons/sp-icon-switch.js';
import '../icons/sp-icon-sync.js';
import '../icons/sp-icon-sync-remove.js';
import '../icons/sp-icon-table.js';
import '../icons/sp-icon-table-add.js';
import '../icons/sp-icon-table-and-chart.js';
import '../icons/sp-icon-tableau.js';
import '../icons/sp-icon-table-column-add-left.js';
import '../icons/sp-icon-table-column-add-right.js';
import '../icons/sp-icon-table-column-merge.js';
import '../icons/sp-icon-table-column-remove-center.js';
import '../icons/sp-icon-table-column-split.js';
import '../icons/sp-icon-table-edit.js';
import '../icons/sp-icon-table-histogram.js';
import '../icons/sp-icon-table-merge-cells.js';
import '../icons/sp-icon-table-row-add-bottom.js';
import '../icons/sp-icon-table-row-add-top.js';
import '../icons/sp-icon-table-row-merge.js';
import '../icons/sp-icon-table-row-remove-center.js';
import '../icons/sp-icon-table-row-split.js';
import '../icons/sp-icon-table-select-column.js';
import '../icons/sp-icon-table-select-row.js';
import '../icons/sp-icon-tag-bold.js';
import '../icons/sp-icon-tag-italic.js';
import '../icons/sp-icon-tag-underline.js';
import '../icons/sp-icon-target.js';
import '../icons/sp-icon-targeted.js';
import '../icons/sp-icon-task-list.js';
import '../icons/sp-icon-teapot.js';
import '../icons/sp-icon-temperature.js';
import '../icons/sp-icon-test-a-b.js';
import '../icons/sp-icon-test-ab-edit.js';
import '../icons/sp-icon-test-ab-gear.js';
import '../icons/sp-icon-test-ab-remove.js';
import '../icons/sp-icon-test-profile.js';
import '../icons/sp-icon-text.js';
import '../icons/sp-icon-text-add.js';
import '../icons/sp-icon-text-align-center.js';
import '../icons/sp-icon-text-align-justify.js';
import '../icons/sp-icon-text-align-left.js';
import '../icons/sp-icon-text-align-right.js';
import '../icons/sp-icon-text-baseline-shift.js';
import '../icons/sp-icon-text-bold.js';
import '../icons/sp-icon-text-bulleted.js';
import '../icons/sp-icon-text-bulleted-attach.js';
import '../icons/sp-icon-text-bulleted-hierarchy.js';
import '../icons/sp-icon-text-bulleted-hierarchy-exclude.js';
import '../icons/sp-icon-text-color.js';
import '../icons/sp-icon-text-decrease.js';
import '../icons/sp-icon-text-edit.js';
import '../icons/sp-icon-text-exclude.js';
import '../icons/sp-icon-text-increase.js';
import '../icons/sp-icon-text-indent-decrease.js';
import '../icons/sp-icon-text-indent-increase.js';
import '../icons/sp-icon-text-italic.js';
import '../icons/sp-icon-text-kerning.js';
import '../icons/sp-icon-text-lettered-lower-case.js';
import '../icons/sp-icon-text-lettered-upper-case.js';
import '../icons/sp-icon-text-numbered.js';
import '../icons/sp-icon-text-paragraph.js';
import '../icons/sp-icon-text-roman-lowercase.js';
import '../icons/sp-icon-text-roman-uppercase.js';
import '../icons/sp-icon-text-size.js';
import '../icons/sp-icon-text-size-add.js';
import '../icons/sp-icon-text-space-after.js';
import '../icons/sp-icon-text-space-before.js';
import '../icons/sp-icon-text-strikethrough.js';
import '../icons/sp-icon-text-stroke.js';
import '../icons/sp-icon-text-style.js';
import '../icons/sp-icon-text-subscript.js';
import '../icons/sp-icon-text-superscript.js';
import '../icons/sp-icon-text-tracking.js';
import '../icons/sp-icon-text-underline.js';
import '../icons/sp-icon-thumb-down.js';
import '../icons/sp-icon-thumb-down-outline.js';
import '../icons/sp-icon-thumb-up.js';
import '../icons/sp-icon-thumb-up-outline.js';
import '../icons/sp-icon-tips.js';
import '../icons/sp-icon-train.js';
import '../icons/sp-icon-transfer-to-platform.js';
import '../icons/sp-icon-transparency.js';
import '../icons/sp-icon-trap.js';
import '../icons/sp-icon-tree-collapse.js';
import '../icons/sp-icon-tree-collapse-all.js';
import '../icons/sp-icon-tree-expand.js';
import '../icons/sp-icon-tree-expand-all.js';
import '../icons/sp-icon-trend-inspect.js';
import '../icons/sp-icon-trim-path.js';
import '../icons/sp-icon-trophy.js';
import '../icons/sp-icon-type.js';
import '../icons/sp-icon-underline.js';
import '../icons/sp-icon-undo.js';
import '../icons/sp-icon-ungroup.js';
import '../icons/sp-icon-unlink.js';
import '../icons/sp-icon-unmerge.js';
import '../icons/sp-icon-upload-to-cloud.js';
import '../icons/sp-icon-upload-to-cloud-outline.js';
import '../icons/sp-icon-usa.js';
import '../icons/sp-icon-user.js';
import '../icons/sp-icon-user-activity.js';
import '../icons/sp-icon-user-add.js';
import '../icons/sp-icon-user-admin.js';
import '../icons/sp-icon-user-arrow.js';
import '../icons/sp-icon-user-checked-out.js';
import '../icons/sp-icon-user-developer.js';
import '../icons/sp-icon-user-edit.js';
import '../icons/sp-icon-user-exclude.js';
import '../icons/sp-icon-user-group.js';
import '../icons/sp-icon-user-lock.js';
import '../icons/sp-icon-users-add.js';
import '../icons/sp-icon-users-exclude.js';
import '../icons/sp-icon-user-share.js';
import '../icons/sp-icon-users-lock.js';
import '../icons/sp-icon-users-share.js';
import '../icons/sp-icon-variable.js';
import '../icons/sp-icon-vector-draw.js';
import '../icons/sp-icon-video-checked-out.js';
import '../icons/sp-icon-video-filled.js';
import '../icons/sp-icon-video-outline.js';
import '../icons/sp-icon-view-all-tags.js';
import '../icons/sp-icon-view-bi-week.js';
import '../icons/sp-icon-view-card.js';
import '../icons/sp-icon-view-column.js';
import '../icons/sp-icon-view-day.js';
import '../icons/sp-icon-view-detail.js';
import '../icons/sp-icon-viewed-mark-as.js';
import '../icons/sp-icon-view-grid.js';
import '../icons/sp-icon-view-list.js';
import '../icons/sp-icon-view-row.js';
import '../icons/sp-icon-view-single.js';
import '../icons/sp-icon-view-stack.js';
import '../icons/sp-icon-view-week.js';
import '../icons/sp-icon-vignette.js';
import '../icons/sp-icon-visibility.js';
import '../icons/sp-icon-visibility-off.js';
import '../icons/sp-icon-visit.js';
import '../icons/sp-icon-visit-share.js';
import '../icons/sp-icon-voice-over.js';
import '../icons/sp-icon-volume-mute.js';
import '../icons/sp-icon-volume-one.js';
import '../icons/sp-icon-volume-three.js';
import '../icons/sp-icon-volume-two.js';
import '../icons/sp-icon-watch.js';
import '../icons/sp-icon-web-page.js';
import '../icons/sp-icon-web-pages.js';
import '../icons/sp-icon-workflow.js';
import '../icons/sp-icon-workflow-add.js';
import '../icons/sp-icon-wrench.js';
import '../icons/sp-icon-zoom-in.js';
import '../icons/sp-icon-zoom-out.js';
export const iconManifest = [
    ...
    { name: 'Select substract', tag: '<sp-icon-select-substract>', story: (size) => html `<sp-icon-select-substract size=${size}></sp-icon-select-substract>` },
    ...
    { name: 'Substract back path', tag: '<sp-icon-substract-back-path>', story: (size) => html `<sp-icon-substract-back-path size=${size}></sp-icon-substract-back-path>` },
    { name: 'Substract from selection', tag: '<sp-icon-substract-from-selection>', story: (size) => html `<sp-icon-substract-from-selection size=${size}></sp-icon-substract-from-selection>` },
    ...
    { name: 'Tableau', tag: '<sp-icon-tableau>', story: (size) => html `<sp-icon-tableau size=${size}></sp-icon-tableau>` },
