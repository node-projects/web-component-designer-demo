...
export const RadialGradientIcon = ({ width = 24, height = 24, hidden = false, title = 'Radial Gradient', } = {}) => {
  ...
  >
    ...
    />
    <path
      d="M14.1 4H9.56A16.413 16.413 0 0 0 4 9.56v4.54A14.551 14.551 0 0 1 14.1 4ZM21.9 32h4.536A16.4 16.4 0 0 0 32 26.439V21.9A14.551 14.551 0 0 1 21.9 32ZM4 21.9v4.535A16.4 16.4 0 0 0 9.561 32H14.1A14.551 14.551 0 0 1 4 21.9ZM32 14.1V9.56A16.413 16.413 0 0 0 26.44 4H21.9A14.551 14.551 0 0 1 32 14.1Z"
    />
    <path
      d="M26.439 32H29.6a18.172 18.172 0 0 0 2.4-2.4v-3.161A16.4 16.4 0 0 1 26.439 32ZM9.56 4H6.4A18.172 18.172 0 0 0 4 6.4v3.16A16.413 16.413 0 0 1 9.56 4ZM4 26.439V29.6A18.172 18.172 0 0 0 6.4 32h3.161A16.4 16.4 0 0 1 4 26.439ZM32 9.56V6.4A18.172 18.172 0 0 0 29.6 4h-3.16A16.413 16.413 0 0 1 32 9.56Z"
    />
    <path
      d="M33 2H3a1 1 0 0 0-1 1v30a1 1 0 0 0 1 1h30a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Zm-1 27.6a18.172 18.172 0 0 1-2.4 2.4H6.4A18.172 18.172 0 0 1 4 29.6V6.4A18.172 18.172 0 0 1 6.4 4h23.2A18.172 18.172 0 0 1 32 6.4Z"
    />
  </svg>`;
};
