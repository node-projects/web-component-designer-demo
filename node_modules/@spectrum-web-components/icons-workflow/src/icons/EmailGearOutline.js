...
export const EmailGearOutlineIcon = ({ width = 24, height = 24, hidden = false, title = 'Email Gear Outline', } = {}) => {
  ...
  >
    ...
    />
    <path
      d="M17.259 30H2v-2.392l11.165-8.358 3.635 2.725a1.973 1.973 0 0 0 .735.326l-.231-.231a2.638 2.638 0 0 1-.621-2.682L2 8.38V6h32v2.334l-8.08 6.081h.741a2.617 2.617 0 0 1 1.7.661L34 10.835v6.779l.7.7a2.665 2.665 0 0 1 0 3.762l-.607.607h.838a2.626 2.626 0 0 1 1.069.232V5.167A1.147 1.147 0 0 0 34.875 4H1.125A1.147 1.147 0 0 0 0 5.167v25.666A1.147 1.147 0 0 0 1.125 32h15.439a2.62 2.62 0 0 1 .695-2ZM2 10.881 11.5 18 2 25.107Z"
    />
  </svg>`;
};
