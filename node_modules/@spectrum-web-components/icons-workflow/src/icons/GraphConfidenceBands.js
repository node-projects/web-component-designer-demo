...
export const GraphConfidenceBandsIcon = ({ width = 24, height = 24, hidden = false, title = 'Graph Confidence Bands', } = {}) => {
    return html `<svg
