...
export const GlobeClockIcon = ({ width = 24, height = 24, hidden = false, title = 'Globe Clock', } = {}) => {
    return html `<svg
  ...
  >
    ...
    />
    <path
      d="M27.905 26.533v-4.128a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v5.229l3.275 2.072a.5.5 0 0 0 .69-.155l.535-.845a.5.5 0 0 0-.155-.69Z"
    />
  </svg>`;
};
//# sourceMappingURL=GlobeClock.js.map