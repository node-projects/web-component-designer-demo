...
let WiredCard = class WiredCard extends WiredBase {
  ...
  draw(svg, size) {
    ...
    if (this.fill && this.fill.trim()) {
      const fillNode = hachureFill([[2, 2], [s.width - 4, 2], [s.width - 2, s.height - 4], [2, s.height - 4]], this.seed);
...
__decorate([property({
  type: String
}), __metadata("design:type", String)], WiredCard.prototype, "fill", void 0);

WiredCard = __decorate([customElement('wired-card'), __metadata("design:paramtypes", [])], WiredCard);
export { WiredCard };