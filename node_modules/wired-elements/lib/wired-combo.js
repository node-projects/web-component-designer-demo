...
let WiredCombo = class WiredCombo extends LitElement {
  ...
  updated(changed) {
    ...
    const poly = polygon(svg, [[dropx + 8, 5 + dropOffset], [dropx + 26, 5 + dropOffset], [dropx + 17, dropOffset + Math.min(textBounds.height, 18)]], this.seed);
...
__decorate([query('svg'), __metadata("design:type", SVGSVGElement)], WiredCombo.prototype, "svg", void 0);

__decorate([query('#card'), __metadata("design:type", HTMLDivElement)], WiredCombo.prototype, "card", void 0);
