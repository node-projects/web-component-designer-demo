...
(function (l) {
  ...
  var _ = function () {
    ...
    return a.prototype._createIgnoreDuplicateModulesMap = function () {
      ...
      for (var p, r = 0, e = this.sortedPathsRules.length; r < e; r++) if (p = this.sortedPathsRules[r], l.Utilities.startsWith(n, p.from)) {
...
(function (l) {
  var E = function () {
    ...
    return r.prototype.load = function (e, t, i, o) {
      var u = this;
      if (!this._scriptLoader) if (this._env.isWebWorker) this._scriptLoader = new _();else if (this._env.isElectronRenderer) {
  ...
  var p = function () {
    ...
    return r.prototype.reset = function () {
      ...
      for (c.push(e), o[e] = !0; c.length > 0;) {
        ...
        if (g) for (var u = 0, s = g.length; u < s; u++) {
          var y = g[u];
          o[y] || (c.push(y), o[y] = !0);
        }
      }
      ...
      for (f.push(i), o[e] = !0; f.length > 0;) {
        var c = f.shift(),
            d = c.dependencies;
        if (d) for (var u = 0, s = d.length; u < s; u++) {
          var v = d[u];
          if (v.id === t) return !0;
      ...
      if (!(this._modules2[e] || this._knownModules2[e])) {
        ...
        var s = -1,
            f = function (c) {
          if (s++, s >= o.length) t._onLoadError(e, c);else {
            var d = o[s],
                v = t.getRecorder();
...
`)), e.unresolvedDependenciesCount--;
      ...
      if (!e.isComplete()) {
        ...
        if (this._inverseDependencies2[e.id] = null, v) for (var s = 0, f = v.length; s < f; s++) {
          var g = v[s],
              y = this._modules2[g];
