...
!function (e) {
  ...
  var r = function () {
    ...
    return r.validateConfigurationOptions = function (r) {
      if ("string" != typeof (r = r || {}).baseUrl && (r.baseUrl = ""), "boolean" != typeof r.isBuild && (r.isBuild = !1), "object" != typeof r.paths && (r.paths = {}), "object" != typeof r.config && (r.config = {}), void 0 === r.catchError && (r.catchError = !1), void 0 === r.recordStats && (r.recordStats = !1), "string" != typeof r.urlArgs && (r.urlArgs = ""), "function" != typeof r.onError && (r.onError = function (e) {
        ...
        n.phase = "configuration", r.onError(n), r.nodeCachedData = void 0;
      }
  ...
  var n = function () {
    ...
    return t.prototype._createIgnoreDuplicateModulesMap = function () {
      ...
      if (!0 === this.nodeModulesMap[t] || this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(t)) return this.isBuild() ? ["empty:"] : ["node|" + t];
      var r,
          n = t;
  ...
  var t = function () {
    ...
    return e.prototype.load = function (e, t, i, s) {
      var a = this;
      if (!this._scriptLoader) if (this._env.isWebWorker) this._scriptLoader = new n();else if (this._env.isElectronRenderer) {
        var d = e.getConfig().getOptionsLiteral().preferScriptTags;
        this._scriptLoader = d ? new r() : new o(this._env);
      } else this._env.isNode ? this._scriptLoader = new o(this._env) : this._scriptLoader = new r();
      var u = {
        callback: i,
        errorback: s
      };
      this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(u) : (this._callbackMap[t] = [u], this._scriptLoader.load(e, t, function () {
    ...
    return t.prototype.attachListeners = function (e, t, r) {
      var n = function () {
      ...
      if (/^node\|/.test(r)) {
        var i = t.getConfig().getOptionsLiteral().nodeRequire || e.global.nodeRequire,
            s = r.split("|"),
            a = null;
        ...
        d.setAttribute("async", "async"), d.setAttribute("type", "text/javascript"), this.attachListeners(d, n, o), d.setAttribute("src", r);
        var u = t.getConfig().getOptionsLiteral().cspNonce;
        u && d.setAttribute("nonce", u), document.getElementsByTagName("head")[0].appendChild(d);
      }
    }, t;
  }(),
      n = function () {
    ...
    return t.prototype._init = function (e) {
      ...
      if (r && !this._didPatchNodeRequire) {
        ...
        o.prototype._compile = function (e, i) {
          ...
          return n._handleCachedData(h, a, u, !l.cachedData, t), n._verifyCachedData(h, a, u, s, t), v;
        };
      }
      ...
      if (/^node\|/.test(n)) {
        ...
        this._readSourceAndCachedData(f, g, l, function (e, n, a, d) {
          if (e) i(e);else {
            ...
            s._handleCachedData(h, l, g, _ && !a, r), s._verifyCachedData(h, l, g, d, r);
          }
        });
      }
      ...
      return c.amd = u.amd, d.call(e.global, t.getGlobalAMDRequireFunc(), c, n.filename, this._path.dirname(n.filename)), s.record(32, n.filename), l ? o() : i(new Error("Didn't receive define call in " + n.filename + "!")), a;
      ...
      var o = this,
        ...
        setTimeout(function () {
          ...
          0 === i.length || i.length === s || a >= 5 || (i.length < s ? u() : (s = i.length, o._fs.writeFile(r, Buffer.concat([d, i]), function (e) {
