...
const [parse, generate] = await Promise.all([
  import("/web-component-designer-demo/node_modules/@babel/parser/./lib/index.js").then(ns => ns.parse),
  import("/web-component-designer-demo/node_modules/@babel/generator/./lib/index.js").then(ns => ns.default.default),
]).catch(error =>
  Promise.reject(
    new Error(
