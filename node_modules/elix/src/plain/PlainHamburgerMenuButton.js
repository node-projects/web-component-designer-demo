...
class PlainHamburgerMenuButton extends HamburgerMenuButton {
  ...
  get [template]() {
    const result = super[template]; // Fill the menuButton slot with our icon.

    const menuButtonSlot = result.content.querySelector('slot[name="menuButton"]');

    if (menuButtonSlot) {
      menuButtonSlot.append(fragmentFrom.html`
          <slot name="menuIcon">
            <svg
              id="menuIcon"
              part="menu-icon"
