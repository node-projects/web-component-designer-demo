...
export default function PlainPlayControlsMixin(Base) {
  return class PlainPlayControls extends Base {
    ...
    /** @type {ChangedFlags} */
    changed) {
      super[render](changed); // Show playing icon if paused; paused icon if playing.
    ...
    get [template]() {
      ...
      const previousButton = result.content.querySelector('slot[name="previousButton"]');

      if (previousButton) {
        previousButton.append(fragmentFrom.html`
            <svg
              id="previousIcon"
      ...
      const playButton = result.content.querySelector('slot[name="playButton"]');

      if (playButton) {
        playButton.append(fragmentFrom.html`
            <svg
              id="playingIcon"
      ...
      const nextButton = result.content.querySelector('slot[name="nextButton"]');

      if (nextButton) {
        nextButton.append(fragmentFrom.html`
            <svg
              id="nextIcon"
