...
import PlainProgressSpinner from "./PlainProgressSpinner.js"; // Template for the default down arrow shown while pulling.
...
class PlainPullToRefresh extends PullToRefresh {
  ...
  get [template]() {
    const result = super[template]; // Use a default down arrow icon as the pull indicator.

    const pullIndicator = result.content.querySelector('[part~="pull-indicator"]');
