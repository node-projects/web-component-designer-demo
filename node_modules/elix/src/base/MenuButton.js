...
import { defaultState, ids, raiseChangeEvents, render, rendered, setState, shadowRoot, state, stateEffects, template } from "./internal.js";
...
class MenuButton extends Base {
  ...
  [stateEffects](state, changed) {
    const effects = super[stateEffects](state, changed); // When closing, clear menu selection.
  ...
  get [template]() {
    const result = super[template]; // Wrap default slot with a menu.
