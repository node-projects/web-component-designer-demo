...
import { defaultState, goDown, goUp, ids, inputDelegate, raiseChangeEvents, render, rendered, setState, shadowRoot, state, template } from "./internal.js";
import KeyboardDirectionMixin from "./KeyboardDirectionMixin.js";
import KeyboardMixin from "./KeyboardMixin.js";
const Base = DelegateFocusMixin(DelegateInputLabelMixin(DelegateInputSelectionMixin(DisabledMixin(FocusVisibleMixin(FormElementMixin(KeyboardDirectionMixin(KeyboardMixin(ReactiveElement))))))));
/**
...
export class SpinBox extends Base {
  ...
  [render](changed) {
    ...
    renderParts(this[shadowRoot], this[state], changed); // Wire up handlers on new buttons.
    ...
    const {
      disabled,
      value
    } = this[state]; // When disabled, disable inner elements.
  ...
  [rendered](changed) {
    super[rendered](changed); // If we changed the value as a result of stepDown/stepUp, put the cursor
