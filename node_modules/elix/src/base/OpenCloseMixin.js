...
import { defaultState, raiseChangeEvents, render, rendered, setState, startEffect, state, stateEffects } from "./internal.js";
/** @type {any} */
...
export default function OpenCloseMixin(Base) {
  ...
  class OpenClose extends Base {
    ...
    [render](changed) {
      super[render](changed); // Reflect opened state.
    ...
    [stateEffects](state, changed) {
      const effects = super[stateEffects] ? super[stateEffects](state, changed) : {}; // Update our notion of closeFinished to track the closed state for
