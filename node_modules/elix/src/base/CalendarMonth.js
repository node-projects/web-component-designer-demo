...
import { defaultState, ids, render, setState, shadowRoot, state, template } from "./internal.js";
...
class CalendarMonth extends Base {
  ...
  dayElementForDate(date) {
    ...
    return monthDays && "dayElementForDate" in monthDays && monthDays.dayElementForDate(date);
  }
  /**
  ...
  changed) {
    ...
    if (changed.dayPartType || changed.monthDaysPartType) {
      /** @type {any} */
      this[ids].monthDays.dayPartType = this[state].dayPartType;
    }

    if (changed.locale || changed.monthDaysPartType || changed.monthYearHeaderPartType || changed.dayNamesHeaderPartType) {
      const locale = this[state].locale;
      /** @type {any} */

      this[ids].monthDays.locale = locale;
      /** @type {any} */

      this[ids].monthYearHeader.locale = locale;
      /** @type {any} */

      this[ids].dayNamesHeader.locale = locale;
    }
    ...
    if (changed.date || changed.monthDaysPartType) {
      ...
      if (date) {
        ...
        this[ids].monthYearHeader.date = calendar.firstDateOfMonth(date);
      }
    }
    ...
    if (changed.daysOfWeekFormat || changed.dayNamesHeaderPartType) {
      ...
      this[ids].dayNamesHeader.format = daysOfWeekFormat;
    }
    ...
    if (changed.showCompleteWeeks || changed.monthDaysPartType) {
      ...
      this[ids].monthDays.showCompleteWeeks = showCompleteWeeks;
    }
    ...
    if (changed.showSelectedDay || changed.monthDaysPartType) {
      ...
      this[ids].monthDays.showSelectedDay = showSelectedDay;
    }
    ...
    if (changed.monthFormat || changed.monthYearHeaderPartType) {
      ...
      this[ids].monthYearHeader.monthFormat = monthFormat;
    }
    ...
    if (changed.yearFormat || changed.monthYearHeaderPartType) {
      ...
      this[ids].monthYearHeader.yearFormat = yearFormat;
    }
  }
