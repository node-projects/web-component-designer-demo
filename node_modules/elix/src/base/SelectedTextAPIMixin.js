...
import { defaultState, getItemText, setState, state, stateEffects } from "./internal.js";
/**
...
export default function SelectedTextAPIMixin(Base) {
  ...
  class SelectedTextAPI extends Base {
    ...
    [stateEffects](state, changed) {
      const effects = super[stateEffects] ? super[stateEffects](state, changed) : {}; // selectedText tracks text of selected item
      ...
      if (changed.items || changed.selectedIndex) {
        ...
        const selectedText = selectedItem ? this[getItemText](selectedItem) : "";
    ...
    set selectedText(selectedText) {
      ...
      const selectedIndex = items ? indexOfItemWithText(items, this[getItemText], String(selectedText)) : -1;
      this[setState]({
        selectedIndex
      });
    }
