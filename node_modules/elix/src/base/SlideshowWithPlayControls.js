...
import { firstRender, raiseChangeEvents, render, template } from "./internal.js";
...
const Base = AriaListMixin(DirectionCursorMixin(FocusVisibleMixin(KeyboardDirectionMixin(KeyboardMixin(LanguageDirectionMixin(PlayControlsMixin(SwipeDirectionMixin(TouchSwipeMixin(TrackpadSwipeMixin(Slideshow))))))))));
/**
...
class SlideshowWithPlayControls extends Base {
  ...
  changed) {
    ...
    if (this[firstRender]) {
      ...
      this.addEventListener("click", () => {
        this[raiseChangeEvents] = true; // @ts-ignore
  ...
  get [template]() {
    ...
    const crossfadeContainer = result.content.querySelector("#crossfadeContainer");
    /** @type {any} */
