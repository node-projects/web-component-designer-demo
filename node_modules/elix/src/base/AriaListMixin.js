...
import { defaultState, render, rendering, setState, state } from "./internal.js";
/**
...
export default function AriaListMixin(Base) {
  ...
  class AriaList extends Base {
    ...
    changed) {
      ...
      const items = this[state].items; // Give each item an ID.
      ...
      if (changed.items || changed.selectedIndex || changed.selectedItemFlags) {
        ...
        if (items) {
          items.forEach((item, index) => {
            const selected = selectedItemFlags ? selectedItemFlags[index] // Multi-select
      ...
      if (changed.items || changed.selectedIndex) {
        ...
        const selectedItem = selectedIndex >= 0 && items ? items[selectedIndex] : null;
