...
const Base = AriaListMixin(ComposedFocusMixin(CursorAPIMixin(CursorInViewMixin(DirectionCursorMixin(FocusVisibleMixin(ItemsAPIMixin(ItemsCursorMixin(ItemsMultiSelectMixin(ItemsTextMixin(KeyboardDirectionMixin(KeyboardMixin(KeyboardPagedCursorMixin(KeyboardPrefixCursorMixin(LanguageDirectionMixin(MultiSelectAPIMixin(MultiSelectToggleMixin(MultiSelectValueAPIMixin(SingleSelectAPIMixin(SlotItemsMixin(TapCursorMixin(ReactiveElement)))))))))))))))))))));
/**
...
class MultiSelectListBox extends Base {
  ...
  /** @type {ChangedFlags} */
  changed) {
    super[render](changed); // Apply `active` style to the current item only.
