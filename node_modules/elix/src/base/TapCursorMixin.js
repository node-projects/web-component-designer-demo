...
import { firstRender, raiseChangeEvents, render, setState, state, tap } from "./internal.js";
/**
...
export default function TapCursorMixin(Base) {
  ...
  return class TapCursor extends Base {
    ...
    event) {
      ...
      // path.
      // @ts-ignore
      const target = event.composedPath ? event.composedPath()[0] : event.target; // Find which item was clicked on and, if found, make it current. Ignore
