...
class CalendarDay extends Base {
  ...
  changed) {
    ...
    if (changed.date) {
      ...
      setInternalState(this, "alternate-month", Math.abs(date.getMonth() - today.getMonth()) % 2 === 1);
      ...
      setInternalState(this, "last-day-of-month", date.getMonth() !== nextDate.getMonth());
    ...
    if (changed.date || changed.locale) {
      ...
      const weekend = dayOfWeek === calendar.weekendStart(locale) || dayOfWeek === calendar.weekendEnd(locale);
