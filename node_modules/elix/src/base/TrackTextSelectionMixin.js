...
import { defaultState, firstRender, raiseChangeEvents, render, rendered, setState } from "./internal.js";
/**
...
export default function TrackTextSelectionMixin(Base) {
  ...
  class TrackTextSelection extends Base {
    ...
    [rendered](changed) {
      super[rendered](changed); // Setting value implies updating selection state as well.
