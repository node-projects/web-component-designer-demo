...
import { defaultState, firstRender, ids, raiseChangeEvents, render, setState, state, stateEffects } from "./internal.js";
...
class DateInput extends Base {
  ...
  [stateEffects](state, changed) {
    ...
    if (changed.date || changed.dateTimeFormat || changed.focused) {
      ...
      if (changed.date && !focused || blur && userChangedDate || changed.dateTimeFormat && datePriority) {
    ...
    if (changed.dateTimeFormat || changed.timeBias || changed.value) {
      ...
      if (dateTimeFormat && value && (changed.value || !datePriority && (changed.dateTimeFormat || changed.timeBias))) {
