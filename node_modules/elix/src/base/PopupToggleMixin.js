...
export default function PopupToggleMixin(Base) {
  ...
  class PopupToggle extends Base {
    ...
    changed) {
      ...
      renderParts(this[shadowRoot], this[state], changed); // Tell the toggle which direction it should point to depending on which
    ...
    get [template]() {
      const result = super[template]; // Append a toggle button to the source.
