...
import { defaultState, itemsDelegate, render, rendered, setState, state } from "./internal.js";
/** @type {any} */
    ...
    changed) {
      ...
      if (this[itemsDelegate] !== previousItemsDelegate) {
        if (previousItemsDelegate) {
          ...
          previousItemsDelegate.removeEventListener(this[itemsChangedListenerKey]);
          previousItemsDelegate.removeEventListener(this[currentIndexChangedListenerKey]);
        } // Start listening to events on new delegate.


        this[itemsDelegate].addEventListener("itemschange", this[itemsChangedListenerKey]);
        this[itemsDelegate].addEventListener("currentindexchange", this[currentIndexChangedListenerKey]);
