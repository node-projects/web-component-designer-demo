...
import { defaultState, firstRender, ids, raiseChangeEvents, render, rendered, setState, state, stateEffects, template } from "./internal.js";
import SlotContentMixin from "./SlotContentMixin.js";
import TrackTextSelectionMixin from "./TrackTextSelectionMixin.js";
import WrappedStandardElement from "./WrappedStandardElement.js";
const Base = FormElementMixin(SlotContentMixin(TrackTextSelectionMixin(WrappedStandardElement.wrap("textarea"))));
/**
...
class AutoSizeTextarea extends Base {
  ...
  [stateEffects](state, changed) {
    const effects = super[stateEffects](state, changed); // If the value is tracking content and content changes, update the value.

    if ((changed.content || changed.valueTracksContent) && state.valueTracksContent) {
      /** @type {Node[]} */
