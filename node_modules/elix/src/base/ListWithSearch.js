...
import { defaultState, goFirst, goLast, goNext, goPrevious, ids, inputDelegate, itemsDelegate, keydown, raiseChangeEvents, render, setState, shadowRoot, state, template } from "./internal.js";
import KeyboardMixin from "./KeyboardMixin.js";
import SingleSelectAPIMixin from "./SingleSelectAPIMixin.js";
const Base = ComposedFocusMixin(CursorAPIMixin(CursorSelectMixin(DelegateCursorMixin(DelegateFocusMixin(DelegateInputLabelMixin(DelegateInputSelectionMixin(DelegateItemsMixin(FocusVisibleMixin(KeyboardMixin(SingleSelectAPIMixin(ReactiveElement)))))))))));
/**
...
class ListWithSearch extends Base {
  ...
  changed) {
    ...
    if (changed.filter) {
      ...
      this[ids].input.value = filter;
      /** @type {any} */

      this[ids].list.filter = filter;
    }
