...
import { defaultState, defaultTabIndex, delegatesFocus, keydown, raiseChangeEvents, render, rendering, setState, state } from "./internal.js";
/**
  ...
  class Keyboard extends Base {
    constructor() {
      ...
      this.addEventListener("keydown", async event => {
        this[raiseChangeEvents] = true; // For use with FocusVisibleMixin.
