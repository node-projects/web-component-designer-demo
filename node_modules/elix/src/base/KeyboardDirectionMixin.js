...
import { defaultState, goDown, goEnd, goLeft, goRight, goStart, goUp, keydown, state } from "./internal.js";
/**
...
export default function KeyboardDirectionMixin(Base) {
  ...
  class KeyboardDirection extends Base {
    ...
    /** @type {KeyboardEvent} */
    event) {
      let handled = false; // Direction keys generally are low-priority keys: if a shadow element
