...
import { defaultState, goNext, goPrevious, ids, keydown, render, setState, shadowRoot, state } from "./internal.js";
...
export default function PlayControlsMixin(Base) {
  ...
  class PlayControls extends Base {
    ...
    [wrap](target) {
      ...
      `;
      renderParts(playControls, this[state]); // Wrap the target with the play controls.
...
function renderParts(root, state, changed) {
  if (!changed || changed.controlButtonPartType) {
    ...
    controlButtons.forEach(controlButton => transmute(controlButton, controlButtonPartType));
  }
}
