...
export default function CursorInViewMixin(Base) {
  ...
  class CursorInView extends Base {
    ...
    scrollCurrentItemIntoView() {
      ...
      const itemRect = currentItem.getBoundingClientRect(); // Determine how far the item is outside the viewport.
      ...
      const topDelta = itemRect.top - scrollTargetRect.top; // Scroll the target as necessary to bring the item into view.
