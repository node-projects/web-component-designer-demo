...
const Base = CursorAPIMixin(CursorSelectMixin(ItemsAPIMixin(ItemsCursorMixin(SingleSelectAPIMixin(SlotItemsMixin(ReactiveElement))))));
/**
...
class Modes extends Base {
  ...
  /** @type {ChangedFlags} */
  changed) {
    super[render](changed); // Show the selected item only. Also, apply `selected` attribute to the
    // selected item only.
