...
import { effectEndTarget, firstRender, render, rendered, setState, shadowRoot, startEffect, state } from "./internal.js";
/**
    ...
    changed) {
      ...
      if (this[firstRender]) {
        ...
        target.addEventListener("transitionend", event => {
          ...
          const effectTarget = this[state].effectEndTarget || this[effectEndTarget];
