...
import { contentSlot, defaultState, firstRender, raiseChangeEvents, rendered, setState, shadowRoot } from "./internal.js";
/**
      ...
      if (this[firstRender]) {
        ...
        if (slot) {
          slot.addEventListener("slotchange", async () => {
            ...
            this[raiseChangeEvents] = true; // The nodes assigned to the given component have changed.
