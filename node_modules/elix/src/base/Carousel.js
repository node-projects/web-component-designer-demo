...
import { defaultState, ids, render, setState, state, stateEffects, swipeTarget, template } from "./internal.js";
...
const Base = AriaListMixin(ArrowDirectionMixin(DirectionCursorMixin(FocusVisibleMixin(KeyboardDirectionMixin(KeyboardMixin(SwipeDirectionMixin(TouchSwipeMixin(TrackpadSwipeMixin(Explorer)))))))));
/**
...
class Carousel extends Base {
  ...
  get [defaultState]() {
    ...
    const showArrowButtons = mediaQueryList.media === pointerQuery ? mediaQueryList.matches : true;
  ...
  [stateEffects](state, changed) {
    const effects = super[stateEffects](state, changed); // When orientation changes, have swipe axis follow suit, and also
    // set the default proxy list position.

    if (changed.orientation) {
      const proxyListPosition = state.orientation === "horizontal" ? "bottom" : "right";
