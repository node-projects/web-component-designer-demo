...
element) {
  ...
  if (element.items && element.items.length > 0) {
    ...
    const timerTimeout = setTimeout(() => {
      element[goNext]();
    }, element.cursorTimerDuration); // Set the timer as state, also noting which slide we're currently on.
...
element) {
  ...
  if (element[state].playing && (!element[state].timerTimeout || element[state].currentIndex !== element[state].currentIndexForTimer)) {
