...
import { checkSize, defaultState, rendered, setState, state } from "./internal.js";
/** @type {any} */
...
export default function ResizeMixin(Base) {
  return class Resize extends Base {
    ...
    [checkSize]() {
      ...
      const sizeChanged = clientHeight !== this[state].clientHeight || clientWidth !== this[state].clientWidth;
