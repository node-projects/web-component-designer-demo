...
import { firstRender, keydown, raiseChangeEvents, render, state, toggleSelectedFlag } from "./internal.js";
/**
  ...
  return class MultiSelectToggle extends Base {
    constructor() {
      ...
      this.addEventListener("selectedchange", event => {
        this[raiseChangeEvents] = true; // Find which item was selected, and update its selected flag.
