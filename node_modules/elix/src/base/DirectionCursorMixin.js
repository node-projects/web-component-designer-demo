...
import { defaultState, goDown, goEnd, goFirst, goLast, goLeft, goNext, goPrevious, goRight, goStart, goUp, state, stateEffects } from "./internal.js";
/**
...
export default function DirectionCursorMixin(Base) {
  ...
  class DirectionCursor extends Base {
    ...
    [stateEffects](state, changed) {
      const effects = super[stateEffects] ? super[stateEffects](state, changed) : {}; // Update computed state members to track whether we can go
      // down/left/right/up.
