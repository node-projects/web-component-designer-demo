...
import { defaultState, firstRender, ids, render, rendered, setState, state, swipeLeft, swipeLeftTransitionEnd, swipeRight, swipeRightTransitionEnd, swipeStart, template } from "./internal.js";
/**
...
export default function SwipeCommandsMixin(Base) {
  ...
  return class SwipeCommands extends Base {
    ...
    changed) {
      ...
      if (this[firstRender]) {
        ...
        this[ids].leftCommandContainer.addEventListener("transitionend", () => {
          if (this[state].swipeRightCommitted && this[swipeRightTransitionEnd]) {
        ...
        this[ids].rightCommandContainer.addEventListener("transitionend", () => {
          if (this[state].swipeLeftCommitted && this[swipeLeftTransitionEnd]) {
      ...
      if (changed.enableEffects || changed.swipeItem || changed.swipeFraction) {
        ...
        if (swipeItem && swiping) {
          ...
          const translation = swipeFraction * 100; // Get client rect of item using getBoundingClientRect so that we
          // get more precise fractional dimensions.

          const itemRect = swipeItem.getBoundingClientRect(); // Subtract off the top of our offsetParent to effectively calculate
          ...
          const translation = followThroughLeft ? "-100%" : followThroughRight ? "100%" : "0";
          ...
          const height = swipeLeftCommitted && swipeLeftRemovesItem || swipeRightCommitted && swipeRightRemovesItem ? "0" : "";
          Object.assign(swipeItem.style, {
            height,
            transform: `translateX(${translation})`,
    ...
    changed) {
      ...
      if ((changed.swipeLeftWillCommit || changed.swipeRightWillCommit) && "vibrate" in navigator && this[state].swipeFraction !== null) {
        navigator.vibrate(5);
      }
