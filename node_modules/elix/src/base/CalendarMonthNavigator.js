...
import { defaultState, goDown, goLeft, goRight, goUp, keydown, raiseChangeEvents, setState, state, stateEffects, template } from "./internal.js";
import KeyboardDirectionMixin from "./KeyboardDirectionMixin.js";
import KeyboardMixin from "./KeyboardMixin.js";
import LanguageDirectionMixin from "./LanguageDirectionMixin.js";
const Base = ArrowDirectionMixin(CalendarElementMixin(FocusVisibleMixin(FormElementMixin(KeyboardDirectionMixin(KeyboardMixin(LanguageDirectionMixin(CalendarMonth)))))));
/**
...
class CalendarMonthNavigator extends Base {
  ...
  [stateEffects](state, changed) {
    const effects = super[stateEffects](state, changed); // Reflect any change in date to value as well so that FormElementMixin can
