...
import { closestAvailableItemIndex, keydown, raiseChangeEvents, scrollTarget, setState, state } from "./internal.js";
...
function getIndexOfItemAtY(element, y, downward) {
  ...
  const step = downward ? 1 : -1; // Find the item spanning the indicated y coordinate.
...
function scrollOnePage(element, downward) {
  const items = element[state].items;
  const currentIndex = element[state].currentIndex; // Determine the item visible just at the edge of direction we're heading.
