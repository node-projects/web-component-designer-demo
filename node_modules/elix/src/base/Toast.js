import { defaultState, effectEndTarget, ids, render, rendered, setState, state } from "./internal.js";
...
class Toast extends Base {
  ...
  changed) {
    ...
    if (changed.effect || changed.effectPhase || changed.fromEdge || changed.rightToLeft) {
      const {
        effect,
        effectPhase,
        fromEdge,
      ...
      const languageAdjustedEdge = rightToLeft ? oppositeEdge[fromEdge] || fromEdge : fromEdge;
      /** @type {IndexedObject<string>} */
      ...
      const transform = opened ? openEdgeTransforms[languageAdjustedEdge] : edgeTransforms[languageAdjustedEdge];
