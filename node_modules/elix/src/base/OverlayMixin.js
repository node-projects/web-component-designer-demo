...
import { defaultState, firstRender, render, rendered, setState, state, template } from "./internal.js";
/** @type {any} */
...
export default function OverlayMixin(Base) {
  ...
  class Overlay extends Base {
    ...
    get [template]() {
      const result = super[template] || templateFrom.html``; // We'd like to just use the `hidden` attribute, but a side-effect of
