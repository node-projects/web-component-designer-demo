import { rendering } from "./internal.js"; // Memoized maps of attribute to property names and vice versa.
...
function attributesForClass(classFn) {
  ...
  const attributes = setterNames.map(setterName => propertyNameToAttribute(setterName)); // Merge the attribute for this class and its base class.
