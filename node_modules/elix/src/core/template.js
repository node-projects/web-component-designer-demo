...
function registerCustomElement(classFn) {
  let baseTag; // HTML places more restrictions on the first character in a tag than
  ...
  /** @type {any} */
  classFn); // Bump number and remember it. If we see the same base tag again later, we'll
