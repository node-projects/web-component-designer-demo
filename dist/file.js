...
export async function saveData(data, fileName, fileType = null, caseSensitive = false) {
    ...
    const blob = typeof data === 'string' ? new Blob([data], { type: mimeType }) : data instanceof Uint8Array ? new Blob([data.buffer], { type: mimeType }) : data;
