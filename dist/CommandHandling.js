    ...
    init(serviceContainer) {
        ...
        undoButton.onmousedown = (e) => {
            ...
            mouseDownTimer = setTimeout(() => {
                ...
                let mnu = Array.from(entries).map((x, idx) => ({ title: 'undo: ' + x.title, action: () => { for (let i = 0; i <= idx; i++)
        ...
        redoButton.onmousedown = (e) => {
            ...
            mouseDownTimer = setTimeout(() => {
                ...
                let mnu = Array.from(entries).map((x, idx) => ({ title: 'redo: ' + x.title, action: () => { for (let i = 0; i <= idx; i++)
